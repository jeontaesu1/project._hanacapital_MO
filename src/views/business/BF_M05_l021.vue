    ...
    <ToastPopup>
      <template v-slot:head>
        <ToastPopupHead>
          ...
          <PopupSubTitle>
            견적서 받으실 분의 정보를 입력해주세요.
          </PopupSubTitle>
        </ToastPopupHead>
      </template>

      <FormList>
        <FormListItem titleText="성명" target="#BF_M05_l021_name">
          <FormInvalid :error="state.nameError">
            <InputBlock :error="state.nameError">
              <InputBlockCell :flexible="true">
                <BasicInput title="성명" id="BF_M05_l021_name" />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem titleText="휴대폰번호" target="#BF_M05_l021_phone">
