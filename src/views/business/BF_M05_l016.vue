...
<template>
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList>
        <FormListItem titleText="이름" target="#BF_M05_l016_name">
          <FormInvalid :error="state.nameError">
            <InputBlock :error="state.nameError">
              <InputBlockCell :flexible="true">
                <BasicInput title="이름" id="BF_M05_l016_name" />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem titleText="연락처" target="#BF_M05_l016_number">
...
@import '@/assets/scss/views/business/BF_M05_l016.scss';
</style>
