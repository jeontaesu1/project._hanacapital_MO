                      ...
                      <KeyValueItem :classNames="{ item: 'text-body-3' }">
                        ...
                        <KeyValueText>
                          <div class="row-margin-item-group">
                            <BoxCheckList spacing="small">
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemInstallmentSuppliesSupport"
                                  id="leaseRentEstimationSystemInstallmentSuppliesSupport_001"
                                  size="small"
                                  :defaultChecked="true"
                                >
                                  <BoxCheckLabel>N</BoxCheckLabel>
                              ...
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemInstallmentSuppliesSupport"
                                  id="leaseRentEstimationSystemInstallmentSuppliesSupport_002"
                                  size="small"
                                >
                                  <BoxCheckLabel>Y</BoxCheckLabel>
                                </BoxCheck>
                          ...
                          <FormList>
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemInstallmentSuppliesSupportPrice"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.suppliesSupportError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="용품지원 금액"
                                      id="leaseRentEstimationSystemInstallmentSuppliesSupportPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      defaultValue="0"
