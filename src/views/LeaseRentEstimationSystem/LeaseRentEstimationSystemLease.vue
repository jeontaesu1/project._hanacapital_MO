  ...
  <PageContents>
    ...
    <div>
              ...
              >
                <section :class="$style['estimate-list__contents']">
                  <UiTab>
                    ...
                    >
                      <RoundTabButton
                        link="leaseRentEstimationSystemLeaseBrand_001"
                      >
                        국산
                      </RoundTabButton>
                      <RoundTabButton
                        link="leaseRentEstimationSystemLeaseBrand_002"
                      >
                        수입
                      </RoundTabButton>
                    </RoundTab>
                      ...
                      <div class="flex-box align-items-start">
                        <div class="flex-box__cell">
                          <RadioButton
                            ...
                            :onlyObject="true"
                            name="leaseRentEstimationSystemLeaseExterior"
                            id="leaseRentEstimationSystemLeaseExterior_007"
                          >
                            <RadioButtonObject />
                            <RadioButtonLabelText
                        ...
                        >
                          ...
                          <FormList>
                            <FormListItem
                              titleText="외장 색상 명칭"
                              target="#leaseRentEstimationSystemLeaseExteriorETC"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.exteriorETCError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="외장 색상 명칭"
                                      id="leaseRentEstimationSystemLeaseExteriorETC"
                                      :disabled="true"
                                    />
                                  </InputBlockCell>
                                </InputBlock>
                            ...
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemLeaseExteriorETCPrice"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.exteriorETCPriceError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="금액"
                                      id="leaseRentEstimationSystemLeaseExteriorETCPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      :disabled="true"
                      ...
                      <div class="flex-box align-items-start">
                        <div class="flex-box__cell">
                          <RadioButton
                            ...
                            :onlyObject="true"
                            name="leaseRentEstimationSystemLeaseInterior"
                            id="leaseRentEstimationSystemLeaseInterior_007"
                          >
                            <RadioButtonObject />
                            <RadioButtonLabelText
                              >직접입력</RadioButtonLabelText
                        ...
                        >
                          ...
                          <FormList>
                            <FormListItem
                              titleText="내장 색상 명칭"
                              target="#leaseRentEstimationSystemLeaseInteriorETC"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.interiorETCError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="내장 색상 명칭"
                                      id="leaseRentEstimationSystemLeaseInteriorETC"
                                      :disabled="true"
                                    />
                                  </InputBlockCell>
                                </InputBlock>
                            ...
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemLeaseInteriorETCPrice"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.interiorETCPriceError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="금액"
                                      id="leaseRentEstimationSystemLeaseInteriorETCPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      :disabled="true"
            ...
            <ul class="reset-list">
              <li class="row-margin-item-group">
                <RadioButton
                  ...
                  :full="true"
                  align="center"
                  name="leaseRentEstimationSystemLeaseCarAmount"
                  id="leaseRentEstimationSystemLeaseCarAmount_001"
                  :defaultChecked="true"
                >
                  <RadioButtonObject />
                  <RadioButtonLabelText>
              ...
              <li class="row-margin-item-group">
                <RadioButton
                  ...
                  :full="true"
                  name="leaseRentEstimationSystemLeaseCarAmount"
                  id="leaseRentEstimationSystemLeaseCarAmount_002"
                >
                  <RadioButtonObject />
                ...
                <div :class="[$style['car-amount'], 'row-margin-item']">
                  ...
                  <FormList>
                    <FormListItem
                      titleText="차량금액"
                      target="#leaseRentEstimationSystemLeaseCarAmountPrice"
                      :forceFocus="true"
                      :disabled="true"
                    >
                      <FormInvalid :error="state.carAmountPriceError">
                        ...
                        >
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="차량금액"
                              id="leaseRentEstimationSystemLeaseCarAmountPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              :disabled="true"
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemLeaseOption001"
                          :defaultChecked="true"
                          :classNames="{
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemLeaseOption002"
                          :classNames="{
                            wrap: $style['option-select__check'],
                            input: $style['option-select__input'],
                            label: $style['option-select__label'],
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemLeaseOption003"
                          :classNames="{
                            wrap: $style['option-select__check'],
                            input: $style['option-select__input'],
                            label: $style['option-select__label'],
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemLeaseOption004"
                          :classNames="{
                            wrap: $style['option-select__check'],
                            input: $style['option-select__input'],
                            label: $style['option-select__label'],
                            ...
                            <FormInvalid :error="state.optionETCError">
                              <InputBlock :error="state.optionETCError">
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="옵션 명칭"
                                    id="leaseRentEstimationSystemLeaseOptionETC"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                            ...
                            <FormInvalid :error="state.optionETCPriceError">
                              <InputBlock :error="state.optionETCPriceError">
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="금액"
                                    id="leaseRentEstimationSystemLeaseOptionETCPrice"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
          ...
          <div :class="$style['estimate-list__foot']">
            <BoxCheckList spacing="small">
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="leaseRentEstimationSystemLeaseDelivery"
                  id="leaseRentEstimationSystemLeaseDelivery001"
                  size="small"
                  :defaultChecked="true"
                >
                  ...
                  <div class="flex-box align-items-start">
                    ...
                    >
                      ...
                      <FormList>
                        <FormListItem
                          titleText="할인액"
                          target="#leaseRentEstimationSystemLeaseDeliveryDiscountPrice"
                          :forceFocus="true"
                          :disabled="true"
                        >
                          <FormInvalid
                          ...
                          >
                            ...
                            >
                              <InputBlockCell :flexible="true">
                                <BasicInput
                                  title="할인액"
                                  id="leaseRentEstimationSystemLeaseDeliveryDiscountPrice"
                                  pattern="\d*"
                                  :useDelete="false"
                                  align="right"
                                  defaultValue="0"
                  ...
                  <div class="flex-box align-items-start">
                    ...
                    >
                      ...
                      <FormList>
                        <FormListItem
                          titleText="할인율"
                          target="#leaseRentEstimationSystemLeaseDeliveryDiscountRatio"
                          :forceFocus="true"
                          :disabled="true"
                        >
                          <FormInvalid
                            ...
                            >
                              <InputBlockCell>
                                <BasicInput
                                  type="number"
                                  title="할인율 비율(%)"
                                  id="leaseRentEstimationSystemLeaseFeeCMRatio"
                                  pattern="\d*"
                                  :useDelete="false"
                                  align="right"
                                  defaultValue="0"
                              ...
                              <InputBlockCell :flexible="true">
                                <BasicInput
                                  title="할인율 금액"
                                  id="leaseRentEstimationSystemLeaseFeeCMPrice"
                                  pattern="\d*"
                                  :useDelete="false"
                                  align="right"
                                  defaultValue="0"
                  ...
                  <FormInvalid :error="state.deliveryManufacturerPriceError">
                    ...
                    >
                      <InputBlockCell :flexible="true">
                        <BasicInput
                          title="금액"
                          id="leaseRentEstimationSystemLeaseDeliveryManufacturerPrice"
                          pattern="\d*"
                          :useDelete="false"
                          align="right"
                          defaultValue="0"
                        ...
                        <KeyValueText>
                          ...
                          <BoxCheckList spacing="small">
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseProduct"
                                id="leaseRentEstimationSystemLeaseProduct_001"
                                size="small"
                                :defaultChecked="true"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseProduct"
                                id="leaseRentEstimationSystemLeaseProduct_002"
                                size="small"
                              >
                        ...
                        <KeyValueText>
                          <BoxCheckList spacing="small">
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCustomerType"
                                id="leaseRentEstimationSystemLeaseCustomerType_001"
                                size="small"
                                :defaultChecked="true"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCustomerType"
                                id="leaseRentEstimationSystemLeaseCustomerType_002"
                                size="small"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCustomerType"
                                id="leaseRentEstimationSystemLeaseCustomerType_003"
                                size="small"
                              >
                          ...
                          <div>
                            <BoxCheckList spacing="small">
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseRegistName"
                                  id="leaseRentEstimationSystemLeaseRegistName_001"
                                  size="small"
                                  :defaultChecked="true"
                                >
                              ...
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseRegistName"
                                  id="leaseRentEstimationSystemLeaseRegistName_002"
                                  size="small"
                                >
                            ...
                            <div class="row-margin-item">
                              <CheckBox
                                id="leaseRentEstimationSystemLeaseCommercialLicensePlate"
                                theme="tertiary"
                              >
                                <CheckBoxObject />
                                <CheckBoxLabelText
                        ...
                        <KeyValueText>
                          ...
                          <BoxCheckList spacing="small">
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCarTax"
                                id="leaseRentEstimationSystemLeaseCarTax_001"
                                size="small"
                                :defaultChecked="true"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCarTax"
                                id="leaseRentEstimationSystemLeaseCarTax_002"
                                size="small"
                              >
                        ...
                        <KeyValueText>
                          ...
                          <BoxCheckList spacing="small">
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCarPayment"
                                id="leaseRentEstimationSystemLeaseCarPayment_001"
                                size="small"
                                :defaultChecked="true"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemLeaseCarPayment"
                                id="leaseRentEstimationSystemLeaseCarPayment_002"
                                size="small"
                              >
                ...
                <section :class="$style['estimate-list__contents']">
                  <BoxCheckList spacing="small" align="full">
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemLeaseCheck001"
                        id="leaseRentEstimationSystemLeaseCheck001_001"
                        size="small"
                        :defaultChecked="true"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemLeaseCheck001"
                        id="leaseRentEstimationSystemLeaseCheck001_002"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck001"
                        id="leaseRentEstimationSystemLeaseCheck001_003"
                        size="small"
                      >
                        <BoxCheckLabel>한성모터스주식회사</BoxCheckLabel>
                      </BoxCheck>
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck001"
                        id="leaseRentEstimationSystemLeaseCheck001_004"
                        size="small"
                      >
              ...
              >
                <section :class="$style['estimate-list__contents']">
                  ...
                  <FormList>
                    <FormListItem
                      titleText="CM"
                      target="#leaseRentEstimationSystemLeaseFeeCMRatio"
                    >
                    ...
                    <FormListItem
                      titleText="AG"
                      target="#leaseRentEstimationSystemLeaseFeeAGRatio"
                    >
                        ...
                        <InputBlock :error="state.feeAGError">
                          <InputBlockCell>
                            <BasicInput
                              type="number"
                              title="AG 비율(%)"
                              id="leaseRentEstimationSystemLeaseFeeAGRatio"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
              ...
              >
                <section :class="$style['estimate-list__contents']">
                  ...
                  <FormList>
                    <FormListItem
                      titleText="CM"
                      target="#leaseRentEstimationSystemLeaseETCCMRatio"
                    >
                        ...
                        <InputBlock :error="state.etcCMError">
                          <InputBlockCell>
                            <BasicInput
                              type="number"
                              title="CM 비율(%)"
                              id="leaseRentEstimationSystemLeaseETCCMRatio"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
                          ...
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="CM 금액"
                              id="leaseRentEstimationSystemLeaseETCCMPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
                    ...
                    <FormListItem
                      titleText="AG"
                      target="#leaseRentEstimationSystemLeaseETCAGRatio"
                    >
                        ...
                        <InputBlock :error="state.etcAGError">
                          <InputBlockCell>
                            <BasicInput
                              type="number"
                              title="AG 비율(%)"
                              id="leaseRentEstimationSystemLeaseETCAGRatio"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
                          ...
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="AG 금액"
                              id="leaseRentEstimationSystemLeaseETCAGPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
                ...
                <section :class="$style['estimate-list__contents']">
                  <BoxCheckList spacing="small">
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemLeaseCheck002"
                        id="leaseRentEstimationSystemLeaseCheck002_001"
                        size="small"
                        :defaultChecked="true"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemLeaseCheck002"
                        id="leaseRentEstimationSystemLeaseCheck002_002"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck002"
                        id="leaseRentEstimationSystemLeaseCheck002_003"
                        size="small"
                      >
                          ...
                          <div>
                            <BoxCheckList spacing="small">
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseAcquisitionTax"
                                  id="leaseRentEstimationSystemLeaseAcquisitionTax_001"
                                  size="small"
                                  :defaultChecked="true"
                                >
                                  <BoxCheckLabel>포함</BoxCheckLabel>
                              ...
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseAcquisitionTax"
                                  id="leaseRentEstimationSystemLeaseAcquisitionTax_002"
                                  size="small"
                                >
                                  <BoxCheckLabel>고객별도</BoxCheckLabel>
                                </BoxCheck>
                  ...
                  <BoxCheckList spacing="small" :wrap="true" :col="3">
                    <BoxCheckListItem>
                      <BoxCheck
                        ...
                        id="leaseRentEstimationSystemLeaseCheck003_001"
                        size="small"
                        :defaultChecked="true"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck003"
                        id="leaseRentEstimationSystemLeaseCheck003_003"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck003"
                        id="leaseRentEstimationSystemLeaseCheck003_004"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck003"
                        id="leaseRentEstimationSystemLeaseCheck003_005"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemLeaseCheck003"
                        id="leaseRentEstimationSystemLeaseCheck003_006"
                        size="small"
                      >
                      ...
                      <KeyValueItem :classNames="{ item: 'text-body-3' }">
                        ...
                        <KeyValueText>
                          <div class="row-margin-item-group">
                            ...
                            <BoxCheckList spacing="small">
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeasePublicBondDiscount"
                                  id="leaseRentEstimationSystemLeasePublicBondDiscount_001"
                                  size="small"
                                  :defaultChecked="true"
                                >
                                  <BoxCheckLabel>포함</BoxCheckLabel>
                              ...
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeasePublicBondDiscount"
                                  id="leaseRentEstimationSystemLeasePublicBondDiscount_002"
                                  size="small"
                                >
                                  <BoxCheckLabel>고객별도</BoxCheckLabel>
                                </BoxCheck>
                          ...
                          <FormList>
                            <FormListItem
                              titleText="할인율"
                              target="#leaseRentEstimationSystemLeasePublicBondDiscountRatio"
                            >
                              <FormInvalid
                                ...
                                >
                                  <InputBlockCell>
                                    <BasicInput
                                      type="number"
                                      title="공채할인율 비율(%)"
                                      id="leaseRentEstimationSystemLeasePublicBondDiscountRatio"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      defaultValue="0"
                                  ...
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="공채할인율 금액"
                                      id="leaseRentEstimationSystemLeasePublicBondDiscountPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      defaultValue="0"
                        ...
                        <KeyValueText>
                          ...
                          <div>
                            ...
                            <FormList>
                              <FormListItem
                                titleText="금액"
                                target="#leaseRentEstimationSystemLeaseEtcPrice"
                              >
                                <FormInvalid :error="state.etcPriceError">
                                  <InputBlock :error="state.etcPriceError">
                                    <InputBlockCell :flexible="true">
                                      <BasicInput
                                        title="기타비용 금액"
                                        id="leaseRentEstimationSystemLeaseEtcPrice"
                                        pattern="\d*"
                                        :useDelete="false"
                                        align="right"
                                        defaultValue="0"
                      ...
                      <KeyValueItem :classNames="{ item: 'text-body-3' }">
                        ...
                        <KeyValueText>
                          <div class="row-margin-item-group">
                            <BoxCheckList spacing="small">
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseInterestSubsidy"
                                  id="leaseRentEstimationSystemLeaseInterestSubsidy_001"
                                  size="small"
                                  :defaultChecked="true"
                                >
                              ...
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseInterestSubsidy"
                                  id="leaseRentEstimationSystemLeaseInterestSubsidy_002"
                                  size="small"
                                >
                          ...
                          <FormList>
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemLeaseInterestSubsidyPrice"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.interestSubsidyError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="이손금 금액"
                                      id="leaseRentEstimationSystemLeaseInterestSubsidyPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      defaultValue="0"
                      ...
                      <KeyValueItem :classNames="{ item: 'text-body-3' }">
                        ...
                        <KeyValueText>
                          <div class="row-margin-item-group">
                            <BoxCheckList spacing="small">
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseSuppliesSupport"
                                  id="leaseRentEstimationSystemLeaseSuppliesSupport_001"
                                  size="small"
                                  :defaultChecked="true"
                                >
                                  <BoxCheckLabel>N</BoxCheckLabel>
                              ...
                              <BoxCheckListItem>
                                <BoxCheck
                                  :minSide="true"
                                  name="leaseRentEstimationSystemLeaseSuppliesSupport"
                                  id="leaseRentEstimationSystemLeaseSuppliesSupport_002"
                                  size="small"
                                >
                                  <BoxCheckLabel>Y</BoxCheckLabel>
                                </BoxCheck>
                          ...
                          <FormList>
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemLeaseSuppliesSupportPrice"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.suppliesSupportError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="용품지원 금액"
                                      id="leaseRentEstimationSystemLeaseSuppliesSupportPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      defaultValue="0"
                ...
                <div :class="$style['estimate-list__top']">
                  <div class="flex-box">
                    ...
                    <div class="flex-box__cell">
                      <SwitchCheckBox
                        theme="secondary"
                        :id="`leaseRentEstimationSystemLeaseProducts${i}_On`"
                      ...
                      <section :class="$style['estimate-list__contents']">
                        <BoxCheckList spacing="small" :wrap="true" :col="3">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check001_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check001_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check001_003`"
                              size="small"
                              :defaultChecked="true"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check001_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check001_005`"
                              size="small"
                            >
                    ...
                    >
                      <section :class="$style['estimate-list__contents']">
                        <div class="row-margin-item-small">
                          <BoxCheck
                            :minSide="true"
                            :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                            :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_000`"
                            size="small"
                            :defaultChecked="true"
                          >
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="4">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_003`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_005`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_006`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_007`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_008`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_009`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_010`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_011`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_012`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_013`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_014`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_015`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_016`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_017`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_018`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_019`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check003_020`"
                              size="small"
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_prepaymentsRatio`"
                                    :buttonId="`leaseRentEstimationSystemLeaseProducts${i}_prepaymentsRatioButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_prepaymentsPrice`"
                                    :buttonId="`leaseRentEstimationSystemLeaseProducts${i}_prepaymentsPriceButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                            ...
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="선납금 수기입력"
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_prepaymentsPriceInput`"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
                    ...
                    >
                      <section :class="$style['estimate-list__contents']">
                        <div class="row-margin-item-small">
                          <BoxCheck
                            :minSide="true"
                            :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                            :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_000`"
                            size="small"
                            :defaultChecked="true"
                          >
                            <BoxCheckLabel>없음</BoxCheckLabel>
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="4">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_001`"
                              size="small"
                            >
                              <BoxCheckLabel>5%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_002`"
                              size="small"
                            >
                              <BoxCheckLabel>10%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_003`"
                              size="small"
                            >
                              <BoxCheckLabel>15%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_004`"
                              size="small"
                            >
                              <BoxCheckLabel>20%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_005`"
                              size="small"
                            >
                              <BoxCheckLabel>25%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_006`"
                              size="small"
                            >
                              <BoxCheckLabel>30%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_007`"
                              size="small"
                            >
                              <BoxCheckLabel>35%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_008`"
                              size="small"
                            >
                              <BoxCheckLabel>40%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_009`"
                              size="small"
                            >
                              <BoxCheckLabel>45%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_010`"
                              size="small"
                            >
                              <BoxCheckLabel>50%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_011`"
                              size="small"
                            >
                              <BoxCheckLabel>55%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_012`"
                              size="small"
                            >
                              <BoxCheckLabel>60%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_013`"
                              size="small"
                            >
                              <BoxCheckLabel>65%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_014`"
                              size="small"
                            >
                              <BoxCheckLabel>70%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_015`"
                              size="small"
                            >
                              <BoxCheckLabel>75%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_016`"
                              size="small"
                            >
                              <BoxCheckLabel>80%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_017`"
                              size="small"
                            >
                              <BoxCheckLabel>85%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_018`"
                              size="small"
                            >
                              <BoxCheckLabel>90%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check004_019`"
                              size="small"
                            >
                              <BoxCheckLabel>95%</BoxCheckLabel>
                            </BoxCheck>
                              ...
                              <InputBlock :error="state.depositRatioError[i]">
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_depositRatio`"
                                    :buttonId="`leaseRentEstimationSystemLeaseProducts${i}_depositRatioButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                              ...
                              <InputBlock :error="state.depositPriceError[i]">
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_depositPrice`"
                                    :buttonId="`leaseRentEstimationSystemLeaseProducts${i}_depositPriceButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                            ...
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="보증금 수기입력"
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_depositPriceInput`"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
                    ...
                    >
                      <section :class="$style['estimate-list__contents']">
                        <div class="row-margin-item-small">
                          <BoxCheck
                            :minSide="true"
                            :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                            :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_000`"
                            size="small"
                            :defaultChecked="true"
                          >
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="4">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_001`"
                              size="small"
                            >
                              <BoxCheckLabel>50%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_003`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_005`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_006`"
                              size="small"
                            >
                              <BoxCheckLabel>45%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_007`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_008`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_009`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_010`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_011`"
                              size="small"
                            >
                              <BoxCheckLabel>40%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_012`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_013`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_014`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_015`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_016`"
                              size="small"
                            >
                              <BoxCheckLabel>35%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_017`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_018`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_019`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemLeaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemLeaseProducts${i}_check006_020`"
                              size="small"
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_residualValueRatio`"
                                    :buttonId="`leaseRentEstimationSystemLeaseProducts${i}_residualValueRatioButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                            ...
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="잔존가치 수기입력"
                                    :id="`leaseRentEstimationSystemLeaseProducts${i}_residualValuePriceInput`"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
      ...
      <div v-if="state.viewDocument" class="row-margin-contents">
        <CheckBox
          id="leaseRentEstimationSystemLeaseCheck001"
          theme="tertiary"
          :classNames="{ wrap: 'row-margin-item-group' }"
        >
          <CheckBoxObject />
