...
<template>
  ...
  >
    <PageTextGroup :class="'page-text-group'">
      <div :class="($style['illustration-img'], 'logo-main')">
        <img
      ...
      <div :class="'img-top'">
        <div :class="$style['illustration-img']">
          <img
            src="@/assets/images/contents/img-lease-rental.png"
            alt="만기대상 프로세스"
          />
        </div>
        <PageMainText :class="'text-position'">
          하나 가족을 위한<br />
    ...
    <div :class="[$style['contents-list']]">
      <BasicBox :class="(['basicPadding20'], 'basic-box')">
        <!-- <ul
          :class="[
        ...
        >
          <li :class="$style['contents-list__item']">
            <div :class="$style['contents-list__head']">
              <div :class="[$style['illustration-img'], 'content-num']">1.</div>
              <div
                :class="[$style['contents-list__title'], 'content-list-con']"
              >
                중도 반환 수수료 면제!<br />
                (하나캐피탈 상품 재이용시)
              </div>
        ...
        <ul :class="'event-list'">
          <li :class="'event-item'">
            <div :class="['event-img']">
              <img src="@/assets/images/illustration/img-coin.png" />
            </div>
            <div :class="'event-con'">
              위약금 없이 차량 교체!<br />
              <span :class="'event-desc'">(중도반납수수료, 반환지연금 등)</span>
            </div>
          </li>
          <li :class="'event-item'">
            <div :class="['event-img']">
              <img src="@/assets/images/illustration/img-fast.png" />
            </div>
            <div :class="'event-con'">
              다이렉트로 저렴하게!<br />
              <span :class="'event-desc'">(재이용 손님 특별혜택가)</span>
            </div>
          </li>
          <li :class="'event-item'">
            <div :class="['event-img']">
              <img src="@/assets/images/illustration/img-arrow2.png" />
            </div>
            <div :class="'event-con'">
              다이렉트로 빠르게!<br />
              <span :class="'event-desc'">(즉시 반납, 즉시 출고)</span>
            </div>
          </li>
        </ul>
        <em class="event-info">※상담 결과에 따라 변동 가능</em>
      </BasicBox>
    </div>
    ...
    <FormList :class="[$style['agree-list'], 'marginTop28']">
        ...
        <FormInvalid :error="state.typeError">
          <BoxCheckList>
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="LeaseRentEstimationSystemType01"
                id="LeaseRentEstimationSystemType01_001"
              >
                <!-- :defaultChecked="true" -->
            ...
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="LeaseRentEstimationSystemType01"
                id="LeaseRentEstimationSystemType01_002"
              >
        ...
        <FormInvalid :error="state.typeError">
          <BoxCheckList>
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="LeaseRentEstimationSystemType02"
                id="LeaseRentEstimationSystemType02_001"
              >
            ...
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="LeaseRentEstimationSystemType02"
                id="LeaseRentEstimationSystemType02_002"
              >
            ...
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="LeaseRentEstimationSystemType02"
                id="LeaseRentEstimationSystemType02_003"
              >
      ...
      >
        <FormInvalid :error="state.testError001">
          <InputBlock :error="state.testError001">
            <InputBlockCell :flexible="true">
              <BasicInput title="기존 차량번호" id="testInput007" />
            </InputBlockCell>
          </InputBlock>
          <FormInvalidMessage>Error Message</FormInvalidMessage>
        </FormInvalid>
    ...
    <section class="service-wrap">
      ...
      <div :class="[$style['agree-list'], 'row-margin-container']">
            ...
            <BasicBox :class="['basicPadding12']">
              <div :class="$style['agree-list__head']">
                ...
                >
                  <CheckBoxObject />
                  <CheckBoxLabelText
                    >개인(신용)정보 수집 및 이용 동의서</CheckBoxLabelText
                  >
                </CheckBox>
        ...
        <ul :class="[$style['basic-list'], 'marginTop24']">
          <li :class="$style['basic-list__item']">
            <div :class="$style['basic-list__symbol']"></div>
            <div :class="$style['basic-list__content']">
              하나캐피탈㈜와 위탁계약을 체결하고 여신금융협회에 정식 등록된 리스
              및 할부 모집인을 통하여 전문 상담원의 상담이 진행됩니다.
            </div>
          </li>
        </ul>
      </div>
...
._form__title-optional_kn5a5_42 {
  position: relative;
