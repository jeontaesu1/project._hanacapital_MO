                      ...
                      <section :class="$style['estimate-list__contents']">
                        <BoxCheckList spacing="small" :wrap="true" :col="3">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_002`"
                              size="small"
                              :defaultChecked="true"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_003`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_005`"
                              size="small"
                            >
