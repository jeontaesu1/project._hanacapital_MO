  ...
  <PageContents>
    ...
    <div>
                  ...
                  <ul class="reset-list">
                    <li class="row-margin-item-group">
                      <RadioButton
                        theme="tertiary"
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseExterior"
                        id="leaseRentEstimationSystemPrePurchaseExterior_001"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps,
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseExterior"
                        id="leaseRentEstimationSystemPrePurchaseExterior_002"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps,
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseExterior"
                        id="leaseRentEstimationSystemPrePurchaseExterior_003"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps,
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseExterior"
                        id="leaseRentEstimationSystemPrePurchaseExterior_004"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps,
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseExterior"
                        id="leaseRentEstimationSystemPrePurchaseExterior_005"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps,
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseExterior"
                        id="leaseRentEstimationSystemPrePurchaseExterior_006"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps,
                      ...
                      <div class="flex-box align-items-start">
                        <div class="flex-box__cell">
                          <RadioButton
                            ...
                            :onlyObject="true"
                            name="leaseRentEstimationSystemPrePurchaseExterior"
                            id="leaseRentEstimationSystemPrePurchaseExterior_007"
                          >
                            <RadioButtonObject />
                            <RadioButtonLabelText
                        ...
                        >
                          ...
                          <FormList>
                            <FormListItem
                              titleText="외장 색상 명칭"
                              target="#leaseRentEstimationSystemPrePurchaseExteriorETC"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.exteriorETCError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="외장 색상 명칭"
                                      id="leaseRentEstimationSystemPrePurchaseExteriorETC"
                                      :disabled="true"
                                    />
                                  </InputBlockCell>
                                </InputBlock>
                            ...
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemPrePurchaseExteriorETCPrice"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.exteriorETCPriceError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="금액"
                                      id="leaseRentEstimationSystemPrePurchaseExteriorETCPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      :disabled="true"
                  ...
                  <ul class="reset-list">
                    <li class="row-margin-item-group">
                      <RadioButton
                        theme="tertiary"
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseInterior"
                        id="leaseRentEstimationSystemPrePurchaseInterior_001"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseInterior"
                        id="leaseRentEstimationSystemPrePurchaseInterior_002"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseInterior"
                        id="leaseRentEstimationSystemPrePurchaseInterior_003"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseInterior"
                        id="leaseRentEstimationSystemPrePurchaseInterior_004"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseInterior"
                        id="leaseRentEstimationSystemPrePurchaseInterior_005"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps
                    ...
                    <li class="row-margin-item-group">
                      <RadioButton
                        ...
                        :full="true"
                        name="leaseRentEstimationSystemPrePurchaseInterior"
                        id="leaseRentEstimationSystemPrePurchaseInterior_006"
                        @change="
                          testAaccordionClose(
                            accordionSlotProps,
                            accordionItemSlotProps
                      ...
                      <div class="flex-box align-items-start">
                        <div class="flex-box__cell">
                          <RadioButton
                            ...
                            :onlyObject="true"
                            name="leaseRentEstimationSystemPrePurchaseInterior"
                            id="leaseRentEstimationSystemPrePurchaseInterior_007"
                          >
                            <RadioButtonObject />
                            <RadioButtonLabelText
                              >직접입력</RadioButtonLabelText
                        ...
                        >
                          ...
                          <FormList>
                            <FormListItem
                              titleText="내장 색상 명칭"
                              target="#leaseRentEstimationSystemPrePurchaseInteriorETC"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.interiorETCError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="내장 색상 명칭"
                                      id="leaseRentEstimationSystemPrePurchaseInteriorETC"
                                      :disabled="true"
                                    />
                                  </InputBlockCell>
                                </InputBlock>
                            ...
                            <FormListItem
                              titleText="금액"
                              target="#leaseRentEstimationSystemPrePurchaseInteriorETCPrice"
                              :forceFocus="true"
                              :disabled="true"
                            >
                              <FormInvalid :error="state.interiorETCPriceError">
                                ...
                                >
                                  <InputBlockCell :flexible="true">
                                    <BasicInput
                                      title="금액"
                                      id="leaseRentEstimationSystemPrePurchaseInteriorETCPrice"
                                      pattern="\d*"
                                      :useDelete="false"
                                      align="right"
                                      :disabled="true"
            ...
            <ul class="reset-list">
              <li class="row-margin-item-group">
                <RadioButton
                  ...
                  :full="true"
                  align="center"
                  name="leaseRentEstimationSystemPrePurchaseCarAmount"
                  id="leaseRentEstimationSystemPrePurchaseCarAmount_001"
                  :defaultChecked="true"
                >
                  <RadioButtonObject />
                  <RadioButtonLabelText>
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemPrePurchaseOption001"
                          :defaultChecked="true"
                          :classNames="{
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemPrePurchaseOption002"
                          :classNames="{
                            wrap: $style['option-select__check'],
                            input: $style['option-select__input'],
                            label: $style['option-select__label'],
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemPrePurchaseOption003"
                          :classNames="{
                            wrap: $style['option-select__check'],
                            input: $style['option-select__input'],
                            label: $style['option-select__label'],
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <CheckBox
                          :full="true"
                          theme="secondary"
                          id="leaseRentEstimationSystemPrePurchaseOption004"
                          :classNames="{
                            wrap: $style['option-select__check'],
                            input: $style['option-select__input'],
                            label: $style['option-select__label'],
                    ...
                    <li :class="$style['option-select__item']">
                      <div :class="$style['option-select__block']">
                        <FormList>
                          <FormListItem
                            titleText="옵션 명칭"
                            target="#leaseRentEstimationSystemPrePurchaseOptionETC"
                            :forceFocus="true"
                          >
                            <FormInvalid :error="state.optionETCError">
                              <InputBlock :error="state.optionETCError">
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="옵션 명칭"
                                    id="leaseRentEstimationSystemPrePurchaseOptionETC"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                          ...
                          <FormListItem
                            titleText="금액"
                            target="#leaseRentEstimationSystemPrePurchaseOptionETCPrice"
                            :forceFocus="true"
                          >
                            <FormInvalid :error="state.optionETCPriceError">
                              <InputBlock :error="state.optionETCPriceError">
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="금액"
                                    id="leaseRentEstimationSystemPrePurchaseOptionETCPrice"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
          ...
          <div :class="$style['estimate-list__foot']">
            <BoxCheckList spacing="small">
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="leaseRentEstimationSystemPrePurchaseDelivery"
                  id="leaseRentEstimationSystemPrePurchaseDelivery001"
                  size="small"
                  :defaultChecked="true"
                >
              ...
              <BoxCheckListItem>
                <BoxCheck
                  :minSide="true"
                  name="leaseRentEstimationSystemPrePurchaseDelivery"
                  id="leaseRentEstimationSystemPrePurchaseDelivery002"
                  size="small"
                >
                  ...
                  <div class="flex-box align-items-start">
                    <div class="flex-box__cell">
                      <RadioButton
                        theme="tertiary"
                        :onlyObject="true"
                        name="leaseRentEstimationSystemPrePurchaseDeliveryDiscount"
                        id="leaseRentEstimationSystemPrePurchaseDeliveryDiscount001"
                    ...
                    >
                      ...
                      <FormList>
                        <FormListItem
                          titleText="할인액"
                          target="#leaseRentEstimationSystemPrePurchaseDeliveryDiscountPrice"
                          :forceFocus="true"
                          :disabled="true"
                        >
                          <FormInvalid
                          ...
                          >
                            ...
                            >
                              <InputBlockCell :flexible="true">
                                <BasicInput
                                  title="할인액"
                                  id="leaseRentEstimationSystemPrePurchaseDeliveryDiscountPrice"
                                  pattern="\d*"
                                  :useDelete="false"
                                  align="right"
                                  defaultValue="0"
                  ...
                  <div class="flex-box align-items-start">
                    <div class="flex-box__cell">
                      <RadioButton
                        ...
                        :onlyObject="true"
                        name="leaseRentEstimationSystemPrePurchaseDeliveryDiscount"
                        id="leaseRentEstimationSystemPrePurchaseDeliveryDiscount002"
                        @change="testRadioChange"
                        @click="testRadioClick"
                      >
                        <RadioButtonObject />
                    ...
                    >
                      ...
                      <FormList>
                        <FormListItem
                          titleText="할인율"
                          target="#leaseRentEstimationSystemPrePurchaseDeliveryDiscountRatio"
                          :forceFocus="true"
                          :disabled="true"
                        >
                          <FormInvalid
                        ...
                        <KeyValueText>
                          <BoxCheckList spacing="small">
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemPrePurchaseCustomerType"
                                id="leaseRentEstimationSystemPrePurchaseCustomerType_001"
                                size="small"
                                :defaultChecked="true"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemPrePurchaseCustomerType"
                                id="leaseRentEstimationSystemPrePurchaseCustomerType_002"
                                size="small"
                              >
                            ...
                            <BoxCheckListItem>
                              <BoxCheck
                                :minSide="true"
                                name="leaseRentEstimationSystemPrePurchaseCustomerType"
                                id="leaseRentEstimationSystemPrePurchaseCustomerType_003"
                                size="small"
                              >
                      ...
                      <BoxCheckList spacing="small">
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck002"
                            id="leaseRentEstimationSystemPrePurchaseCheck002_002"
                            size="small"
                          >
                    ...
                    <FormListItem titleText="자손" :forceFocus="true">
                      <BoxCheckList spacing="small">
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck003"
                            id="leaseRentEstimationSystemPrePurchaseCheck003_001"
                            size="small"
                          >
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck003"
                            id="leaseRentEstimationSystemPrePurchaseCheck003_002"
                            size="small"
                          >
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck003"
                            id="leaseRentEstimationSystemPrePurchaseCheck003_003"
                            size="small"
                            :defaultChecked="true"
                          >
                            <BoxCheckLabel>1억원</BoxCheckLabel>
                ...
                <section :class="$style['estimate-list__contents']">
                  <BoxCheckList spacing="small">
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck005"
                        id="leaseRentEstimationSystemPrePurchaseCheck005_001"
                        size="small"
                        :defaultChecked="true"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck005"
                        id="leaseRentEstimationSystemPrePurchaseCheck005_002"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        name="leaseRentEstimationSystemPrePurchaseCheck005"
                        id="leaseRentEstimationSystemPrePurchaseCheck005_003"
                        size="small"
                      >
                ...
                <section :class="$style['estimate-list__contents']">
                  <BoxCheckList spacing="small" :wrap="true" :col="4">
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_001"
                        size="small"
                        :defaultChecked="true"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_002"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_003"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_004"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_005"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_006"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_007"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_008"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_009"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_010"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_011"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_012"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_013"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_014"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_015"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_016"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_017"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_018"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck006"
                        id="leaseRentEstimationSystemPrePurchaseCheck006_019"
                        size="small"
                      >
              ...
              >
                <section :class="$style['estimate-list__contents']">
                  <FormList>
                    <FormListItem titleText="내비게이션" :forceFocus="true">
                      <BoxCheckList spacing="small">
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck007"
                            id="leaseRentEstimationSystemPrePurchaseCheck007_001"
                            size="small"
                            :defaultChecked="true"
                          >
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck007"
                            id="leaseRentEstimationSystemPrePurchaseCheck007_002"
                            size="small"
                          >
                    ...
                    <FormListItem titleText="블랙박스" :forceFocus="true">
                      <BoxCheckList spacing="small">
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck008"
                            id="leaseRentEstimationSystemPrePurchaseCheck008_001"
                            size="small"
                            :defaultChecked="true"
                          >
                            <BoxCheckLabel>해당없음</BoxCheckLabel>
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck008"
                            id="leaseRentEstimationSystemPrePurchaseCheck008_002"
                            size="small"
                          >
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck008"
                            id="leaseRentEstimationSystemPrePurchaseCheck008_003"
                            size="small"
                          >
                            <BoxCheckLabel
                    ...
                    <FormListItem titleText="측후면썬팅" :forceFocus="true">
                      <BoxCheckList spacing="small">
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck009"
                            id="leaseRentEstimationSystemPrePurchaseCheck009_001"
                            size="small"
                            :defaultChecked="true"
                          >
                            <BoxCheckLabel>해당없음</BoxCheckLabel>
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck009"
                            id="leaseRentEstimationSystemPrePurchaseCheck009_002"
                            size="small"
                          >
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck009"
                            id="leaseRentEstimationSystemPrePurchaseCheck009_003"
                            size="small"
                          >
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck009"
                            id="leaseRentEstimationSystemPrePurchaseCheck009_004"
                            size="small"
                          >
                    ...
                    <FormListItem titleText="전면썬팅" :forceFocus="true">
                      <BoxCheckList spacing="small">
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck010"
                            id="leaseRentEstimationSystemPrePurchaseCheck010_001"
                            size="small"
                            :defaultChecked="true"
                          >
                            <BoxCheckLabel>해당없음</BoxCheckLabel>
                        ...
                        <BoxCheckListItem>
                          <BoxCheck
                            :minSide="true"
                            name="leaseRentEstimationSystemPrePurchaseCheck010"
                            id="leaseRentEstimationSystemPrePurchaseCheck010_002"
                            size="small"
                          >
                            <BoxCheckLabel>포함</BoxCheckLabel>
                          </BoxCheck>
                    ...
                    <FormListItem
                      titleText="추가용품 품목"
                      target="#leaseRentEstimationSystemPrePurchaseAddOptionItem"
                    >
                      <FormInvalid :error="state.addOptionItemError">
                        <InputBlock :error="state.addOptionItemError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="추가용품 품목"
                              id="leaseRentEstimationSystemPrePurchaseAddOptionItem"
                            />
                          </InputBlockCell>
                        </InputBlock>
                        <FormInvalidMessage>Error Message</FormInvalidMessage>
                    ...
                    <FormListItem
                      titleText="추가용품 금액"
                      target="#leaseRentEstimationSystemPrePurchaseAddOptionItemPrice"
                    >
                      <FormInvalid :error="state.addOptionItemPriceError">
                        <InputBlock :error="state.addOptionItemPriceError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="추가용품 금액"
                              id="leaseRentEstimationSystemPrePurchaseAddOptionItemPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                            />
              ...
              >
                <section :class="$style['estimate-list__contents']">
                  <FormList>
                    <FormListItem
                      titleText="품목"
                      target="#leaseRentEstimationSystemPrePurchaseSpecialModification"
                    >
                      <FormInvalid :error="state.specialModificationError">
                        <InputBlock :error="state.specialModificationError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="품목"
                              id="leaseRentEstimationSystemPrePurchaseSpecialModification"
                            />
                          </InputBlockCell>
                        </InputBlock>
                        <FormInvalidMessage>Error Message</FormInvalidMessage>
                    ...
                    <FormListItem
                      titleText="금액"
                      target="#leaseRentEstimationSystemPrePurchaseSpecialModificationPrice"
                    >
                      <FormInvalid :error="state.specialModificationPriceError">
                        ...
                        >
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="금액"
                              id="leaseRentEstimationSystemPrePurchaseSpecialModificationPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                            />
              ...
              >
                <section :class="$style['estimate-list__contents']">
                  <FormList>
                    <FormListItem
                      titleText="CM"
                      target="#leaseRentEstimationSystemPrePurchaseETCCMRatio"
                    >
                      <FormInvalid :error="state.etcCMError">
                        <InputBlock :error="state.etcCMError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="CM 금액"
                              id="leaseRentEstimationSystemPrePurchaseETCCMPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="1,521,120"
                          ...
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              type="number"
                              title="CM 비율(%)"
                              id="leaseRentEstimationSystemPrePurchaseETCCMRatio"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="9.000"
                    ...
                    <FormListItem
                      titleText="AG"
                      target="#leaseRentEstimationSystemPrePurchaseETCAGRatio"
                    >
                      <FormInvalid :error="state.etcAGError">
                        <InputBlock :error="state.etcAGError">
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              title="AG 금액"
                              id="leaseRentEstimationSystemPrePurchaseETCAGPrice"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
                          ...
                          <InputBlockCell :flexible="true">
                            <BasicInput
                              type="number"
                              title="AG 비율(%)"
                              id="leaseRentEstimationSystemPrePurchaseETCAGRatio"
                              pattern="\d*"
                              :useDelete="false"
                              align="right"
                              defaultValue="0"
                ...
                <section :class="$style['estimate-list__contents']">
                  <BoxCheckList spacing="small">
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck011"
                        id="leaseRentEstimationSystemPrePurchaseCheck011_001"
                        size="small"
                        :defaultChecked="true"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck011"
                        id="leaseRentEstimationSystemPrePurchaseCheck011_002"
                        size="small"
                      >
                    ...
                    <BoxCheckListItem>
                      <BoxCheck
                        :minSide="true"
                        name="leaseRentEstimationSystemPrePurchaseCheck011"
                        id="leaseRentEstimationSystemPrePurchaseCheck011_003"
                        size="small"
                      >
                ...
                <div :class="$style['estimate-list__top']">
                  <div class="flex-box">
                    ...
                    <div class="flex-box__cell">
                      <SwitchCheckBox
                        theme="secondary"
                        :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_On`"
                      ...
                      <section :class="$style['estimate-list__contents']">
                        <BoxCheckList spacing="small">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check001_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check001_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check001_003`"
                              size="small"
                              :defaultChecked="true"
                            >
                      ...
                      <section :class="$style['estimate-list__contents']">
                        <BoxCheckList spacing="small" :wrap="true" :col="3">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002_003`"
                              size="small"
                              :defaultChecked="true"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check002_005`"
                              size="small"
                            >
                      ...
                      <section :class="$style['estimate-list__contents']">
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="3">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001_002`"
                              size="small"
                              :defaultChecked="true"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001_003`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type001_005`"
                              size="small"
                            >
                        ...
                        <BoxCheckList spacing="small">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type002_001`"
                              size="small"
                              :defaultChecked="true"
                            >
                              <BoxCheckLabel>20,000 km</BoxCheckLabel>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type002`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check003_type002_002`"
                              size="small"
                            >
                              <BoxCheckLabel>30,000 km</BoxCheckLabel>
                            </BoxCheck>
                    ...
                    >
                      <section :class="$style['estimate-list__contents']">
                        <div class="row-margin-item-small">
                          <BoxCheck
                            :minSide="true"
                            :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                            :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_000`"
                            size="small"
                            :defaultChecked="true"
                          >
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="4">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_003`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_005`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_006`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_007`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check004_008`"
                              size="small"
                            >
                        ...
                        >
                          <FormListItem
                            titleText="비율"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsRatioButton`"
                            :selectOnly="true"
                          >
                            <FormInvalid
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsRatio`"
                                    :buttonId="`leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsRatioButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                          ...
                          <FormListItem
                            titleText="금액"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsPriceButton`"
                            :selectOnly="true"
                          >
                            <FormInvalid
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsPrice`"
                                    :buttonId="`leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsPriceButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                          ...
                          <FormListItem
                            titleText="선납금 수기입력"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsPriceInput`"
                          >
                            <FormInvalid
                            ...
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="선납금 수기입력"
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_prepaymentsPriceInput`"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
                    ...
                    >
                      <section :class="$style['estimate-list__contents']">
                        <div class="row-margin-item-small">
                          <BoxCheck
                            :minSide="true"
                            :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                            :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_000`"
                            size="small"
                            :defaultChecked="true"
                          >
                            <BoxCheckLabel>없음</BoxCheckLabel>
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="4">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_001`"
                              size="small"
                            >
                              <BoxCheckLabel>5%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_002`"
                              size="small"
                            >
                              <BoxCheckLabel>10%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_003`"
                              size="small"
                            >
                              <BoxCheckLabel>15%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_004`"
                              size="small"
                            >
                              <BoxCheckLabel>20%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_005`"
                              size="small"
                            >
                              <BoxCheckLabel>25%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_006`"
                              size="small"
                            >
                              <BoxCheckLabel>30%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_007`"
                              size="small"
                            >
                              <BoxCheckLabel>35%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check005_008`"
                              size="small"
                            >
                              <BoxCheckLabel>40%</BoxCheckLabel>
                            </BoxCheck>
                        ...
                        >
                          <FormListItem
                            titleText="비율"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_depositRatioButton`"
                            :selectOnly="true"
                          >
                              ...
                              <InputBlock :error="state.depositRatioError[i]">
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_depositRatio`"
                                    :buttonId="`leaseRentEstimationSystemPrePurchaseProducts${i}_depositRatioButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                          ...
                          <FormListItem
                            titleText="금액"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_depositPriceButton`"
                            :selectOnly="true"
                          >
                              ...
                              <InputBlock :error="state.depositPriceError[i]">
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_depositPrice`"
                                    :buttonId="`leaseRentEstimationSystemPrePurchaseProducts${i}_depositPriceButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                          ...
                          <FormListItem
                            titleText="보증금 수기입력"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_depositPriceInput`"
                          >
                            <FormInvalid
                            ...
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="보증금 수기입력"
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_depositPriceInput`"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
                    ...
                    >
                      <section :class="$style['estimate-list__contents']">
                        <div class="row-margin-item-small">
                          <BoxCheck
                            :minSide="true"
                            :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                            :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_000`"
                            size="small"
                            :defaultChecked="true"
                          >
                        ...
                        <BoxCheckList spacing="small" :wrap="true" :col="4">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_001`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_002`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_003`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_004`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_005`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_006`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_007`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_008`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_009`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_010`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_011`"
                              size="small"
                            >
                              <BoxCheckLabel>40%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_012`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_013`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_014`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_015`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_016`"
                              size="small"
                            >
                              <BoxCheckLabel>35%</BoxCheckLabel>
                            </BoxCheck>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_017`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_018`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_019`"
                              size="small"
                            >
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check006_020`"
                              size="small"
                            >
                        ...
                        >
                          <FormListItem
                            titleText="비율"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_residualValueRatioButton`"
                            :selectOnly="true"
                          >
                            <FormInvalid
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicSelect
                                    ...
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_residualValueRatio`"
                                    :buttonId="`leaseRentEstimationSystemPrePurchaseProducts${i}_residualValueRatioButton`"
                                  />
                                </InputBlockCell>
                              </InputBlock>
                              <FormInvalidMessage
                          ...
                          <FormListItem
                            titleText="잔존가치 수기입력"
                            :target="`#leaseRentEstimationSystemPrePurchaseProducts${i}_residualValuePriceInput`"
                          >
                            <FormInvalid
                            ...
                            >
                              ...
                              >
                                <InputBlockCell :flexible="true">
                                  <BasicInput
                                    title="잔존가치 수기입력"
                                    :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_residualValuePriceInput`"
                                    pattern="\d*"
                                    :useDelete="false"
                                    align="right"
                                  />
                      ...
                      <section :class="$style['estimate-list__contents']">
                        <BoxCheckList spacing="small">
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check007`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check007_001`"
                              size="small"
                              :defaultChecked="true"
                            >
                              <BoxCheckLabel>
                          ...
                          <BoxCheckListItem>
                            <BoxCheck
                              :minSide="true"
                              :name="`leaseRentEstimationSystemPrePurchaseProducts${i}_check007`"
                              :id="`leaseRentEstimationSystemPrePurchaseProducts${i}_check007_002`"
                              size="small"
                            >
                              <BoxCheckLabel>
      ...
      <div v-if="state.viewDocument" class="row-margin-contents">
        <CheckBox
          id="leaseRentEstimationSystemPrePurchaseCheck001"
          theme="tertiary"
          :classNames="{ wrap: 'row-margin-item-group' }"
        >
          <CheckBoxObject />
