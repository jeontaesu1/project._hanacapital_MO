  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList>
        ...
        <FormListItem titleText="생년월일" target="#Comp_M00_l004_BirthDate">
        ...
        <FormListItem titleText="휴대폰번호" target="#Comp_M00_l004_phone">
          <FormInvalid :error="state.phoneError001">
            <InputBlock :error="state.phoneError001">
              <InputBlockCell :flexible="true">
                <BasicInput
                  title="휴대폰번호"
                  id="Comp_M00_l004_phone"
        ...
        <FormListItem titleText="사업자등록번호" target="#Comp_M00_l004_number">
          <FormInvalid :error="state.numberError001">
            <InputBlock :error="state.numberError001">
              <InputBlockCell :flexible="true">
                <BasicInput title="사업자등록번호" id="Comp_M00_l004_number" />
              </InputBlockCell>
            </InputBlock>
            <FormInvalidMessage>Error Message</FormInvalidMessage>
          </FormInvalid>
        ...
        <FormListItem titleText="사업자등록일" target="#Comp_M00_l004_date">
            ...
            <InputBlock :error="state.dateError001">
              <InputBlockCell :flexible="true">
                <BasicInput
                  ...
                  pattern="\d*"
                  title="사업자등록일"
                  id="Comp_M00_l004_date"
                />
              </InputBlockCell>
            </InputBlock>
            <FormInvalidMessage>Error Message</FormInvalidMessage>
            <FormHelpText>숫자만 입력해 주세요 (예:910412) </FormHelpText>
          </FormInvalid>
        </FormListItem>
        ...
        <FormListItem titleText="실제소유자여부" :forceFocus="true">
          <BoxCheckList>
            <BoxCheckListItem>
              <BoxCheck
                name="Comp_M00_l004_Check001"
                id="Comp_M00_l004_Check001_001"
              >
      ...
      <div>
        <h4 class="text-title-2">거래 목적 및 자금의원천 정보 입력</h4>
        <p
          class="text-body-3 color-gray-tertiary row-margin-small font-weight-light"
        >
          「특정금융정보법」에 따라 비대면 고객확인 시 필요한 추가정보를 확인
          요청드립니다.
        </p>
      </div>
      <FormList class="row-margin-contents">
        <FormListItem
          titleText="거래 목적"
          target="#Comp_M00_l004_dealPurposeButton"
          :selectOnly="true"
        >
          <FormInvalid :error="state.dealPurposeError001">
            <InputBlock :error="state.dealPurposeError001">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  :option="[
                    {
        ...
        <FormListItem
          titleText="자금의 원천"
          target="#Comp_M00_l004_moneyRootButton"
          :selectOnly="true"
        >
          <FormInvalid :error="state.moneyRootError001">
            <InputBlock :error="state.moneyRootError001">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  :option="[
                    {
