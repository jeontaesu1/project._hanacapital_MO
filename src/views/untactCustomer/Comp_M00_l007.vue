      ...
      <BasicBox>
        <KeyValue margin="regular">
          ...
          >
            ...
            <KeyValueText>88.08.20</KeyValueText>
          </KeyValueItem>
          ...
          >
            <KeyValueTitle>사업자등록번호</KeyValueTitle>
          ...
          >
            <KeyValueTitle>사업자등록일</KeyValueTitle>
            <KeyValueText>23.08.20</KeyValueText>
          </KeyValueItem>
          <KeyValueItem
            :classNames="{
              item: 'text-body-3',
          ...
          >
            <KeyValueTitle>실제소유자여부</KeyValueTitle>
            <KeyValueText>예</KeyValueText>
          </KeyValueItem>
          <KeyValueItem
            :classNames="{
              item: 'text-body-3',
          ...
          >
            <KeyValueTitle>거래 목적</KeyValueTitle>
            <KeyValueText>차량 구매(할부)</KeyValueText>
          </KeyValueItem>
          <KeyValueItem
            :classNames="{
              item: 'text-body-3',
          ...
          >
            <KeyValueTitle>자금의 원천</KeyValueTitle>
            <KeyValueText>사업소득</KeyValueText>
          </KeyValueItem>
        </KeyValue>
      </BasicBox>
