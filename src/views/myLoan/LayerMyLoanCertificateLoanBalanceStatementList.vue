  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>대출거래 및 잔액내역서</PopupTitle>
      ...
      <div class="inline-wrap align-right">
        <CheckBox
          id="LayerMyLoanCertificateLoanBalanceStatementListAll"
          theme="tertiary"
        >
          <CheckBoxObject />
      ...
      >
        <BoxCheckListItem>
          <BoxCheck
            ...
            align="top"
            type="checkbox"
            id="LayerMyLoanCertificateLoanBalanceStatementList_001"
          >
            <BasicBoxHead>
              <BasicBoxHeadLeft>
        ...
        <BoxCheckListItem>
          <BoxCheck
            ...
            align="top"
            type="checkbox"
            id="LayerMyLoanCertificateLoanBalanceStatementList_002"
          >
            <BasicBoxHead>
              <BasicBoxHeadLeft>
                <div class="flex-box align-items-start">
...
@import '@/assets/scss/views/myLoan/LayerMyLoanCertificateLoanBalanceStatementList.scss';
</style>
