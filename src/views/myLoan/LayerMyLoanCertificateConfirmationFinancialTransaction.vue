        ...
        <section class="row-margin-container-medium">
          ...
          <BasicBox>
            <KeyValue>
              ...
              >
                <KeyValueTitle>연체여부</KeyValueTitle>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanCertificateConfirmationFinancialTransaction.scss';
</style>
