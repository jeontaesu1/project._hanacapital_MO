  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>중도금대출 설명서(가계용)</PopupTitle>
                  ...
                  <tr>
                    ...
                    <td class="align-left">
                      <div class="color-green">
                        ...
                        연장계약 이 불가능할 수도 있습니다. 일반적으로
                        만기일시상환-원리금균등상환-원금균 등상환 순으로 고객의
                        원리금 상환부담 이 발생합니다.
                      </div>
                    </td>
                  </tr>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription003_009.scss';
</style>
