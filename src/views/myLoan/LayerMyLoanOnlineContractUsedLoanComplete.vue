  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <PageTextGroup>
        ...
        <PageSubText>
          대출금 송금을 위한 출금동의 및 대출계약 사항 안내를 위해
          <span class="color-green">ARS 계약안내</span>를 요청합니다
        </PageSubText>
      </PageTextGroup>
      ...
      <template v-slot:foot>
        ...
        >
          <ButtonListItem>
            <BasicButton>ARS 계약안내</BasicButton>
          </ButtonListItem>
        </ButtonList>
      </template>
    </FullPopup>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractUsedLoanComplete.scss';
</style>
