          ...
          <BasicBox>
            ...
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>11.5 %</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>근저당설정비용 / 금액</KeyValueTitle>
                <KeyValueText>50.0 % / 1,500,000 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>2%(기간에 따라 차등)</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>1회차 할부금</KeyValueTitle>
                <KeyValueText>102,300 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>98,216 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>3,535,784 원</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
