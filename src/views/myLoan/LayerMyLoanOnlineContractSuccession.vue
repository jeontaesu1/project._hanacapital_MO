  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <section>
        ...
        <BasicBox>
          <KeyValue margin="regular">
            ...
            >
              <KeyValueTitle>승계자</KeyValueTitle>
            ...
            >
              <KeyValueTitle>할부잔여기간</KeyValueTitle>
              <KeyValueText>33개월</KeyValueText>
            </KeyValueItem>
      ...
      >
        <FormListItem
          titleText="비밀번호"
          target="#layerMyLoanOnlineContractSuccessionPassword"
        >
            ...
            <InputBlock :error="state.passwordError">
              <InputBlockCell :flexible="true">
                <BasicInput
                  type="password"
                  title="비밀번호"
                  id="layerMyLoanOnlineContractSuccessionPassword"
                />
              </InputBlockCell>
            </InputBlock>
      ...
      <div :class="[$style['icon-list'], 'row-margin-item']">
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractSuccession.scss';
</style>
