...
import BrandLogo001 from '@/assets/images/bank-logo/kb.svg?component';
import BrandLogo002 from '@/assets/images/bank-logo/nh.svg?component';
import BrandLogo003 from '@/assets/images/bank-logo/woori.svg?component';
import BrandLogo004 from '@/assets/images/bank-logo/hana.svg?component';
import BrandLogo005 from '@/assets/images/bank-logo/shinhan.svg?component';
  ...
  <PageContents>
    <div class="row-margin-contents-small">
      ...
      <BasicBox class="row-margin-contents">
        <UiAccordion
          tagName="div"
          :classNames="{ wrap: $style['detail-accordion'] }"
        >
          <KeyValueList>
                ...
                >
                  <div :class="$style['detail-accordion__text']">
                    ...
                    <button
                      ...
                      :class="[
                        $style['account__copy'],
                        $style['account__copy--small-margin'],
                      ]"
                    >
