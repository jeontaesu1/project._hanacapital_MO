  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>일반대출 상품설명서(기업용)</PopupTitle>
      ...
      <div>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  일반대출은 영업활동을 위한 운영자금이 필요한 기업을 대상으로
                  금융회사가 정한 범위 내에서 기업의 신용도 및 담보 등을 토대로
                  실행되는 대출상품입니다.
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  일반대출은 자금용도의 목적범위 내로 활용이 엄격히 제한되며,
                  대출자금의 유용 시 해당금액을 즉시 상환하여야 할 뿐만 아니라
                  향후 신규대출이 제한될 수 있습니다.
                </div>
              </li>
            </ul>
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        (운전자금대출) 사업자의 생산과 판매활동 등에 소요되는
                        자금을 지원하는 대출<br />
                        (시설자금대출) 사업자 설비의 취득·신설·증설·복구 등
                        일체의 시설에 필요한 자금 등으로 자본적 지출에 소요되는
                        자금을 지원하는 대출
                      </div>
                    </div>
                  </div>
                      ...
                      <div :class="$style['manual-qna__text']">
                        <div>
                          ...
                          <span class="color-red"
                            >최대 (2)%의 해약금(중도상환수수료)이 발생*</span
                          >합니다. 아울러
                          <span class="color-green"
                            >동일 금융회사와 기존 대출계약을 해지하고 사실상
                            동일 계약을 체결한 경우 양 계약기간을 합산하여 3년
                            경과 후에는 면제됩니다.</span
                          >
                          중도상환수수료는 대출의 잔여일수 및 상환금액에 따라
                          달라지며, 중도상환 시 향후 원리금 상환 부담금액이
                          감소하게 됩니다. (☞
                          <span class="color-red"
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            <div :class="$style['basic-list__symbol']">*</div>
                            <div :class="$style['basic-list__content']">
                              예) 1억원을 중도상환(적용요율을 2%로 가정)할 경우,
                              고객은 최대 200만원의 중도상환수수료를 금융회사에
                              납부해야 함
                            </div>
                          </li>
                        </ul>
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        ...
                        추가적인 비용을 부담하실 수 있습니다. (☞
                        <span class="color-red">‘4. 수수료 등 비용부담’</span>
                        확인)
                      </div>
                    </div>
                  </div>
                ...
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <div>
                          대출금 연체시에는 법에서 정하는 범위 내에서 약정에
                          따라 정한 지연 배상금율에 의한 ‘지연배상금’을
                          지불하셔야 하며, 신용점수 하락 및 금융거래 제한 등이
                          발생할 수 있으니 유의하여 주시기 바랍니다. (☞ ‘6.
                          연체이자율(지연배상금율)’, ‘11. 연체정보 등의 등록’
                          확인)
                        </div>
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          <li :class="$style['basic-list__item']">
                            <div :class="$style['basic-list__symbol']"></div>
                            <div :class="$style['basic-list__content']">
                              예) 대출원금이 1억원인 경우, 연체이자율 6% 적용시,
                              최대 월 연체이자 50만원이 발생하므로 연체가
                              발생하지 않도록 유의
                            </div>
                          </li>
                        </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          <div :class="$style['basic-table']">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <th>대상</th>
                  <td class="align-left">법인 또는 개인사업자</td>
                </tr>
                <tr>
                  <th>적용금리</th>
                  <td class="align-left">%</td>
          ...
          >
            본 대출상품은 ‘원금분할상환’ 및 ‘만기일시상환, 원리금균등분할상환
            방식 중 선택이 가능한 상품입니다. 상환방식에 따른 자세한 설명은 ‘5.
            대출금의 상환방법’을 확인하여 주시기 바랍니다.
          </div>
        </section>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    고객에게 실제 적용되는
                    <strong class="underline">약정금리</strong>는
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-contents']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        <strong class="underline">원가요소</strong>(①)는
                        신용원가, 업무원가, 조달원가 및 자본원가 등으로
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        <strong class="underline">기준금리</strong>(①+②)는
                        이러한 원가요소(①)에 목표이익율(②)을 더하여 산정됩니다.
                      </div>
                    </li>
                    <li
                      :class="[
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        <strong class="underline">조정금리</strong>(③)는
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    <strong class="font-weight-medium"
                      >결정된 대출금리(약정금리)</strong
                    >는 개별약정에 의해 별도로 정한 항목(변동금리대출의 기준금리
                    등) 이외에는 대출만기일까지 동일하게 적용됩니다.
                  </div>

                  <ul
                    :class="[$style['basic-list'], 'row-margin-item-regular']"
                  >
                    <li
                      :class="[
                        $style['basic-list__item'],
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">※</div>
                      <div :class="$style['basic-list__content']">
                        기한연장, 채무자변경 등 ‘대출조건이 변경되는 경우’에는
                        변경 당시의 원가요소와 마진을 기준으로 대출금리가 변경될
                        수 있습니다.
                      </div>
                    </li>
                  </ul>
            ...
            >
                  ...
                  <div>
                    ...
                    <span class="underline"
                      ><strong
                        >본인의
                        <span
                          class="color-gray italic font-weight-medium underline"
                          >[신용상태가 개선]</span
                        >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  금융회사는
                  <strong class="font-weight-medium"
                    >금리인하 요구를 받은 날부터 </strong
                  ><span class="color-green">‘10영업일 이내’</span>(고객에게
                  자료의 보완을 요구하는 날부터 자료가 제출되는 날까지의 기간은
                  포함되지 않습니다)에
                  <strong class="font-weight-medium"
                    >금리인하 요구 수용 여부 및 그 사유</strong
                  >를 전화, 서면, 문자메시지, 전자우편, 팩스 또는 그 밖에 이와
                  유사한 방법으로 고객에게 통지합니다.
                </div>
              </li>
            </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          <section>
            ...
            <p class="text-body-2">
              일부 상품(햇살론, 보증부대출 등)의 경우, 고객이 보증기관과 체결한
              보증계약에 따라 보증료 지급 의무가 발생할 수 있으며, 대부분
              1회성으로 부담하시게 됩니다.(자세한 내용은 보증기관에 문의 필요)
            </p>
          </section>
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  수수료율 : 2.0%와 {(이자상한금리-약정금리)×30÷365}+1% 중 낮은
                  값
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  수수료 계산식 :
                  {(상환금액X1%)+(상환금액)×(수수료율-1%)]X잔여일수÷(대출기간-30)]
                </div>
              </li>
            </ul>
              ...
              <ul :class="[$style['basic-list'], 'row-margin-item']">
                <li :class="$style['basic-list__item']">
                  ...
                  <div :class="$style['basic-list__content']">
                    ...
                    부담하는 금액으로, 대출취급일로부터 ( 3 )년까지 적용합니다.
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동차, 주택 등에 근저당 설정할 때 들어가는 부대비용으로,
                  <span class="color-green"
                    >설정 시에는 금융회사가 부담하며, 해지 시에는
                    고객(채무자)</span
                  >이 부담합니다.
                </div>
              </li>
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div class="row-margin-mini">
                    등록면허세, 지방교육세, 등기신청수수료 및 법무사수수료<br />
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div class="row-margin-mini">
                    근저당물건의 조사 또는 감정평가 수수료<br />
                    : (<span :class="$style['blank-box']"></span>) 원
                  </div>
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    고객의 채무불이행으로 인하여 근저당권을 행사하는 경우 고객이
                    부담합니다.
                  </p>
                </div>
              </li>
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div class="row-margin-mini">
                    기타 비용으로서 부담주체가 분명하지 아니한 비용<br />
                    : (<span :class="$style['blank-box']"></span>) 원
                  </div>
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    고객과 금융회사가 균분하여 부담합니다.
                  </p>
                </div>
              </li>
            </ul>
          ...
          <section class="row-margin-contents">
            <h4 class="text-body-2 row-margin-item-medium">담보신탁수수료</h4>
            <p class="text-body-2">
              담보신탁을 이용하여 부동산 담보대출을 받을 경우 신탁보수료 및
              법무사 비용은 금융회사가 부담합니다. 다만, 신탁계약에서 달리
              명시하는 경우에는 비용부담주체 변경이 가능합니다.
            </p>
          </section>
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  고객님께서는 이자납입일을 정하여, 일정주기(매월 등)마다
                  원리금을 납입하셔야 합니다. 약정 시 자동이체를 선택하고 관련
                  정보 제공 시, 원리금은 은행 등 금융기관 및 본인명의 계좌에서
                  자동이체됩니다.
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  자동이체 계좌는 고객센터(<strong class="font-weight-medium"
                    >1800-1110</strong
                  >) 등을 통해 변경이 가능하지만, 자동이체일 4영업일 전까지
                  변경(금융기관별 상이)하실 경우에는 당월적용이 가능하며, 그
            ...
            >
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          <th>원리금균등<br />분할상환</th>
                          <td>
                            <p class="underline">11,074,560 원</p>
                          </td>
                          <td>
                            <p class="underline">
                              1회 ~ 24회<br />
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    (예시) 대출금액 1천만원, 금리 10%, 대출기간 24개월(거치
                    12개월 포함)
                  </p>
                    ...
                    <table>
                      ...
                      <thead>
                        <tr>
                          <th>상환방식</th>
                          <th>총 원리금<br />부담 예상액</th>
                          <th>거치기간 종료 후 월 원리금 상환 예상액</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <th rowspan="2">거치식<br />분할상환</th>
                          <td rowspan="2">
                            <p class="underline">11,549,796원</p>
                          </td>
                          <td>
                            <p class="underline">
                              1회 ~ 12회<br />
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <div :class="[$style['basic-table'], 'row-margin-item']">
                    <table>
                      ...
                      <tbody>
                        <tr>
                          <th rowspan="2">만기일시<br />상환</th>
                          <td rowspan="2">
                            <p class="underline">11,999,992원</p>
                          </td>
                          <td>
                            <p class="underline">
                              1회 ~ 23회<br />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-left">
                      <div :class="$style['manual-image']">
                        <img
                          src="@/assets/images/contents/manual/manual-003.png"
                          alt=""
                        />
                      </div>
                      ...
                      <p class="row-margin-item-regular">
                        <strong class="font-weight-medium"
                          >매월 대출원금을 동일한 금액으로 갚아 가는
                          방식</strong
                        ><br />
                        남은 대출원금에 대해 이자가 계산되어, 매월 납입하시는
                        상환금액이 낮아지게 됩니다.
                      </p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="align-left">
                      <div :class="$style['manual-image']">
                        <img
                          src="@/assets/images/contents/manual/manual-002.png"
                          alt=""
                        />
                      </div>
                  ...
                  <tr>
                    ...
                    <td class="align-left">
                      <div>
                        <strong class="font-weight-medium"
                          >&#60;'거치식 대출'을 선택하시는 경우&#62;</strong
                        ><br />
                        거치기간(예 : 1/2/3년) 동안에는 이자만 납입을 하고,
                        거치기간이 종료되면 이자와 원금을 함께 납입을 하셔야
                        합니다. 대출이 실행된 후에는 거치기간의 추가연장은
                        어렵습니다. 상품 종류에 따라 거치식은 선택이 불가할 수
                        있음을 유의하여 주시기 바랍니다.
                      </div>
                      <div class="row-margin-item-regular">
                        ...
                        <p class="text-body-5 row-margin-item">
                          거치기간이 종료되면 거치 기간 연장이 어려울 수 있으며,
                          분할상환이 시작되어 이자와 함께 원금도 갚아나가야
                  ...
                  <tr>
                    ...
                    <td class="align-left">
                      <div class="color-green">
                        만기일시상환의 경우 만기 도래 시 한꺼번에 원리금을
                        상환하여 부담이 클 수 있으며, 신용도 등을 고려하여
                        연장계약이 불가능 할 수도 있습니다. 일반적으로
                        만기일시상환-원리금균등상환-원금균등상환 순으로 고객의
                        원리금 상환부담이 발생합니다.
                      </div>
                    </td>
                  </tr>
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2 font-weight-medium">
            ...
            <span class="underline"
              >법정최고금리 20% 이내로 적용됩니다. (연체가산이율은 연 3%)</span
            >
          ...
          <section class="row-margin-contents">
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        이자를 납입하여야 할 날의 다음날부터 14일까지는 내셔야
                        할 약정이자에 대해 연체이자가 적용되고,
                        <strong class="font-weight-medium"
                          >14일이 경과하면</strong
                        >
                        기한의 이익을 상실하게 되므로
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        분할상환금을 상환하여야할 날의 다음날부터는 해당
                        분할상환금에 대한 연체이자를,
                        <strong class="font-weight-medium"
                          >2회 이상 연속하여 지체</strong
                        >한 때에는
                        <strong class="font-weight-medium"
                          >기한의 이익상실</strong
                        >로 인하여
                        <strong class="font-weight-medium"
                          >대출원금잔액에 대한 연체이자</strong
                        >를 내셔야 합니다.
                      </div>
                    </li>
                  </ul>
            ...
            <div class="row-margin-contents">
              <p class="text-body-4 font-weight-light color-gray-tertiary">
                (예시) 원금 1억2천만원(월 1백만원 분할상환), 약정이자율 연 5%,
                연체가산이자율 연 3%인 대출의 분할상환금(1백만원) 및
                이자(50만원)를 미납하여 연체가 발생하고, 연체발생후 2개월 시점에
                납부할 경우 연체이자
              </p>
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']"></div>
              <div :class="$style['basic-list__content']">
                신용공여(대출 등) 사실만으로 개인 신용평점 또는 법인 신용등급이
                하락할 수 있으며, 평균적으로 연체율이 높은 금융권역(또는 형태)의
                신용공여는 여타 금융권역 또는 일반적인 형태의 신용공여보다 개인
                신용평점 또는 법인 신용등급이 더 큰 폭으로 하락할 수 있습니다.
              </div>
            </li>
            <li
              :class="[
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                경우에도 일정기간 개인 신용평점 및 법인 신용등급의 산정에 영향을
                줄 수 있습니다.
              </div>
            </li>
          </ul>
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                <span class="color-green underline">3년 이내 기간에만 부여</span
                >되며,
                <span class="color-green"
        ...
        <section class="row-margin-container-medium">
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  신용정보주체가 불이익을 받을 수 있으며, 신용등급이 하락하고
                ...
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  ...
                  >
                    ...
                    <div :class="$style['basic-list__content']">
                      ...
                      <ul class="reset-list font-weight-light">
          ...
          <ul :class="[$style['basic-list'], 'row-margin-item']">
            ...
            >
              <div :class="$style['basic-list__symbol']">※</div>
              <div :class="$style['basic-list__content']">
                정보 등록 후 연체금을 상환하여도 신용등급이 일정기간 회복되지
                아니할 수 있으며, 일정기간 동안 해당 기록이보 관될 수 있습니다.
              </div>
            </li>
          </ul>
        </section>
              ...
              <div :class="$style['basic-list__content']">
                ...
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  ...
                  >
                    <div :class="$style['basic-list__symbol']">-</div>
                    <div :class="$style['basic-list__content']">
                      금융소비자보호법 제20조제1항을 위반하여 불공정영업행위를
                      한 경우
                    </div>
                  </li>
                  <li
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                <span class="color-red underline"
                  >5인 미만의 법인 또는 일반금융소비자로 분류되길 요청한
                  법인)</span
                >는 계약체결일 또는 계약서류를 제공받은 날(다만 금전·재화·용역의
                지급이 늦게 이루어진 경우에는 그 지급일로 대체함)로부터
                <span class="color-green"
                  >14일 이내 계약에 대한 청약을 철회</span
                >할 수 있습니다.
              </div>
            </li>
            <li
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
            ...
            <p class="text-body-2">
              최초 심사에 비해 신용등급이 하락하거나 연체가 발생하는 등의 사실이
              발생했을 경우, 대출계약의 연장이 거절될 수 있습니다.
            </p>
          </section>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  사용하지 아니하고, 용도와 무관하게 사용하는 경우 (운전자금으로
                  대출 계약 후 시설자금으로 활용하는 경우 등)를 말합니다.
                </div>
              </li>
              <li
                :class="[
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    (예시) 원금 1억2천만원(월 1백만원 분할상환), 약정이자율 연
                    5%, 연체가산이자율 연 3%인 대출의 분할상환금(1백만원) 및
                ...
                <p class="text-body-2 font-weight-medium row-margin-item">
                  이 내용을 확인하셨습니까?
                </p>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  본 상품을 3년 이내에 중도 상환하시는 경우, 최대 2%의
                  해약금(중도상환수수료)가 발생합니다. 예를 들어 1억원을
                  중도상환하시는 경우(중도상환수수료율 2%로 가정), 최대
                  200만원의
                  <strong class="font-weight-medium"
                    >중도상환수수료를 납부하셔야 대출상품 해지가 가능함을 알고
                    계십니까?</strong
                  >
                </div>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  대출의 변제기가 도래하거나 기한의 이익이 상실되었음에도
                  불구하고 채무가 상환되지 않는 경우, 금융회사는 담보물을
                  처분하여 대출금을 상환하는 데에 이용할 수 있습니다. 이 경우
                  고객님의 담보물에 대한 소유권이 상실됩니다.
                  <span class="color-red underline"
                    >이러한 위험에도 불구하고 본 상품을 계약하시겠습니까?</span
                  >
                </div>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription009_013.scss';
</style>
