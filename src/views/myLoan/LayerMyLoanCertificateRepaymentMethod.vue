  ...
  <UiLayer ref="layer" type="toast" :backgroundClose="true">
    <ToastPopup>
      <template v-slot:head>
        <ToastPopupHead>
          <PopupTitle>발급방법을 선택해 주세요</PopupTitle>
        </ToastPopupHead>
      </template>
          ...
          <li :class="$style['icon-buttons__item']">
            <button type="button" :class="$style['icon-buttons__block']">
              <span :class="$style['icon-buttons__content']">
                <span :class="$style['icon-buttons__title']">미리보기</span>
              </span>
            </button>
          </li>
          <li :class="$style['icon-buttons__item']">
            <button type="button" :class="$style['icon-buttons__block']">
              <span :class="$style['icon-buttons__content']">
                <span :class="$style['icon-buttons__title']">E-Mail</span>
              </span>
            </button>
          </li>
        </ul>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanCertificateRepaymentMethod.scss';
</style>
