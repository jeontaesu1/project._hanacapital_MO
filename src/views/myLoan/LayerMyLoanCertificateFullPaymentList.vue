  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <div class="inline-wrap align-right">
        <CheckBox
          id="LayerMyLoanCertificateFullPaymentListAll"
          theme="tertiary"
        >
          <CheckBoxObject />
      ...
      >
        <BoxCheckListItem>
          <BoxCheck
            ...
            align="top"
            type="checkbox"
            id="LayerMyLoanCertificateFullPaymentList_001"
          >
            <BasicBoxHead>
              <BasicBoxHeadLeft>
        ...
        <BoxCheckListItem>
          <BoxCheck
            ...
            align="top"
            type="checkbox"
            id="LayerMyLoanCertificateFullPaymentList_002"
          >
            <BasicBoxHead>
              <BasicBoxHeadLeft>
                <div class="flex-box align-items-start">
...
@import '@/assets/scss/views/myLoan/LayerMyLoanCertificateFullPaymentList.scss';
</style>
