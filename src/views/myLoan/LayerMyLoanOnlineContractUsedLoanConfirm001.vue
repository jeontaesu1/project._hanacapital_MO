    ...
    <FullPopup>
      ...
      <div>
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">고객 정보</h3>
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>one1111@naver.com</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
        ...
        <section class="row-margin-container-medium">
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                <KeyValueTitle>결제 정보</KeyValueTitle>
              ...
              >
                <KeyValueTitle>초회일자</KeyValueTitle>
                <KeyValueText>2023.05.21</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">인수자</h3>
        ...
        <section class="row-margin-container-medium row-margin-bottom-none">
          ...
          <BasicBox className="row-margin-item-group">
            ...
            <KeyValue margin="regular">
              ...
              >
                <KeyValueTitle>차량 매매가격</KeyValueTitle>
              ...
              >
                <KeyValueTitle>인수일자</KeyValueTitle>
                <KeyValueText>2023.02.06</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
        ...
        <CheckBox
          id="layerMyLoanOnlineContractUsedLoanConfirm001"
          theme="tertiary"
          :classNames="{
