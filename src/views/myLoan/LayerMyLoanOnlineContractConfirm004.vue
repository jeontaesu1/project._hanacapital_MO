  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <div>
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>1998.08.24</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>12-12-123456-12</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>****12312312</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">자동차 정보</h3>
          ...
          <BasicBox>
            ...
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>WAFDKSL123123</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>28개월</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>정비상품</KeyValueTitle>
                <KeyValueText>Self</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>8,662,500 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>추정잔존가치</KeyValueTitle>
                <KeyValueText>37,284,750 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>1,649,120 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">보험 정보</h3>
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                <KeyValueTitle>부보/계약주체</KeyValueTitle>
              ...
              >
                <KeyValueTitle>운전자 연령</KeyValueTitle>
              ...
              >
                <KeyValueTitle>의무가입사항</KeyValueTitle>
                <KeyValueText>대인배상Ⅰ(책임)/대인배상 Ⅱ(무한)</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
