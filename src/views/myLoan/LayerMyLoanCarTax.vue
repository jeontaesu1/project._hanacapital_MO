...
<template>
    ...
    <FullPopup>
      ...
      <div>
        <FormList>
          <FormListItem
            titleText="조회기간 선택"
            target="#layerMyLoanCarTaxDateStartButton"
          >
            <FormInvalid :error="state.dateError">
              <InputBlock :error="state.dateError">
                <InputBlockCell :flexible="true">
                  <BasicDatepicker
                    title="조회기간 시작 날짜"
                    id="layerMyLoanCarTaxDateStart"
                    buttonId="layerMyLoanCarTaxDateStartButton"
                    :max="state.maxDate"
                ...
                <InputBlockCell :flexible="true" margin="regular">
                  <BasicDatepicker
                    title="조회기간 종료 날짜"
                    id="layerMyLoanCarTaxDateEnd"
                    buttonId="layerMyLoanCarTaxDateEndButton"
                    :min="state.minDate"
  ...
  <LayerMyLoanCarTaxDetail ref="layer001" />
</template>

<style lang="scss" module>
@import '@/assets/scss/views/myLoan/LayerMyLoanCarTax.scss';
</style>
