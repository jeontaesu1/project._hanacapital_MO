  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>자동차금융리스 설명서</PopupTitle>
      ...
      <div>
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  차량의 원시적 하자 및 결함에 대하여 금융사가 책임을 부담하지
                  않습니다.
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  본 상품(신용상태가 금리에 영향을 미치지 않는 상품)은
                  금리인하요구 대상상품에 해당하지 않습니다.
                </div>
              </li>
              <li
                :class="[
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  「금융소비자 보호에 관한 법률」 시행령
                  제37조제1항제3호제가목에 의거하여, 리스(시설대여)는 같은
                  법에서 규정하는 청약철회권 대상 상품이 아닙니다. (다만, 재화를
                  제공받은 경우만 해당합니다)
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  중도해지수수료 또는 규정손해배상금이 부과되니 유의하여 주시기
                  바랍니다.
                </div>
              </li>
            </ul>
                      ...
                      <div :class="$style['manual-qna__text']">
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            ...
                            <div :class="$style['basic-list__content']">
                              지연배상금 산식 : 월분할상환
                              원리금(리스료)×지연배상금율(약정이자율+최대3%,
                              법청최고금리 이내)×연체일수/365<br />
        ...
        <section class="row-margin-container-medium">
          ...
          <div :class="$style['basic-table']">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <th rowspan="2">중도상환수수료* 부과 여부 및 요율</th>
                  <td class="align-left">
          ...
          >
            본 금융리스상품은 개인, 개인사업자, 법인을 대상으로 하는 자동차리스
            상품입니다. 리스료는 원금에 대한 분할 상환금액 및 이자로서
            지급하셔야 하는 금액을 의미합니다. 고객께서 부담하셔야 하는 정확한
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <span class="color-green"
                    >중도해지를 이유로 물건을 매입하고자 할 경우</span
                  >
                  법령이 허용하는 한도 내에서 금융회사에 납부하는 비용으로
                  산식은 아래와 같습니다.
                </div>
              </li>
              <li
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동차리스 계약상의 권리와 의무를 제3자에게 승계할 수
                  있습니다. 금융회사는 심사기준에 따라 승인하며, 승계수수료를
                  고객에게 부과할 수 있습니다.
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <p class="row-margin-mini">
                    승계수수료 = 미회수원금 X 최고요율( 1%) X(잔여기간
                    월수/리스기간 전체월수)<br />
                    (승계수수료 최소금액 : 500,000원, 최대금액 : 900,000원)
                  </p>
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    (예시) 미회수원금 1억원, 잔여기간월수 30개월, 리스기간
                    전체월수 36개월인 경우<br />
                    미회수원금 100,000,000원 X 최고요율 1% X (잔여기간 월수 30 /
                    리스기간 전체월수 36) = 833,333원
                  </p>
                </div>
              </li>
            </ul>
          ...
          <section class="row-margin-contents">
            ...
            <p class="text-body-2">
              ...
              인지세는 10,000원으로,
              <span class="color-green"
                >리스사와 고객이 균분하여 납부합니다.(리스사 5,000원 / 고객
                5,000원)</span
              >
            </p>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  납입하셔야 하며, 약정 시 자동이체를 선택하고 관련 정보를 제공
                  시, 리스료는 은행 및 금융기관의 본인명의 계좌에서
                  자동이체됩니다.
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동이체 계좌는 콜센터(1800-1110) 등을 통해 변경이 가능하지만,
                  자동이체일 4영업일 전까지 변경(금융기관 별 상이)하실 경우에는
                  당월적용이 가능하며, 그 이후에는 익월부터 변경사항이 적용됨을
                  유의해주시기 바랍니다.
                </div>
              </li>
            </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2 row-margin-mini">
            지연배상금율은 [약정이자율(단, 무이자 상품의 경우
            상사법정이율(6%)적용) + 3%, (법정최고금리 20%이내)]로 적용되며,
            분할상환 원리금을 기준으로 연체일수로 계산합니다.
          </p>
          <p class="text-body-4 font-weight-light color-gray-tertiary">
            지연배상금 산식 : 월분할상환 원리금 × 지연배상금율 × 연체일수/365<br />
            예) 리스료 100만원, 10일 연체(기존 약정금리 7% 가정)시 : 100만원 ×
            10% × 10/365 = 2,739원
          </p>
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2">
            금융리스 계약의 해지 시
            <span class="color-green-secondary">규정손해배상금</span>이 부과될
            수 있습니다. 다만
            <span class="color-green underline"
              >리스상품은 계약이 성립한 날부터 3년 초과하여 상환하여도
              <span class="color-green-secondary underline">규정손해배상금</span
              >이 <span class="color-green">부과되니 유의</span>*</span
            >하여 주시기 바랍니다.
          </p>
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">13. 위법계약해지권</h3>
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    대출만기 시 고객의 명의로 이전하는 데에 필요한 취득세 등의
                    제세공과금 및 만기시점의 물건가치(잔존가치)만큼의
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div class="color-red">
                    리스자동차에 대한 소유권은 리스종류 및 등록명의에 상관없이
                    리스회사에 있습니다.
                  </div>
                </div>
              </li>
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div class="color-red">
                    고객은 자동차 검사를 포함한 사용·관리를 성실히 준수하여야
                    하며, 자기차량 손해에 대한 보험금 청구권에 대해서는
                    금융회사를 질권자로 하여 자동차종합보험 계약을 체결해야
                    합니다.(자세한 내용은 약관을 확인하여 주시기 바랍니다.)
                  </div>
                </div>
              </li>
            </ul>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  ...
                  경과 후에도 중도상환수수료가 부과(중도해지 후 물건 반납 시
                  중도해지손해배상금, 물건 매입 시 규정손해배상금
                  부과)됩니다.<br />
                  <strong class="font-weight-medium"
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription007_012.scss';
</style>
