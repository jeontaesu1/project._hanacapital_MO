            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="color-green">
                  본 금융리스상품은 개인, 개인사업자, 법인을 대상으로 하는
                  자동차리스 상품입니다. 리스료는 원금에 대한 분할 상환금액 및
                  이자로서 지급하셔야 하는 금액을 의미합니다. 고객께서
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                금융리스 계약의 해지 시
                <span class="color-green-secondary">규정손해배상금</span>이
                부과될 수 있습니다. 다만
                <span class="color-green underline"
                  >리스상품은 계약이 성립한 날부터 3년 초과하여 상환하여도
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    ...
                    제세공과금 및 만기시점의 물건가치(잔존가치)만큼의 비용이
                    발생할 수 있으며, 이는 고객이 부담합니다.
                  </div>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    지연배상금 산식 : 월분할상환
                    원리금(리스료)×지연배상금율(약정이자율+최대3%, 법청최고금리
                    이내)×연체일수/365
                  </p>
                </div>
