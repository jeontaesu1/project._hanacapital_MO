...
<template>
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <ContentsButton
        :classNames="{ wrap: 'row-margin-item-group row-margin-bottom-none' }"
      >
        <BasicBoxHead>
          <BasicBoxHeadLeft>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanCertificateOnlineBillList.scss';
</style>
