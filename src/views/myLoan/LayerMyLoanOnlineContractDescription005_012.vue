  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>중고차 오토론(대출) 설명서</PopupTitle>
      ...
      <div>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  오토론은 자동차 구매를 위한 대출금을 금융회사가 입금하고
                  채무자로부터 그 원리금을 나누어 상환 받는 방식의 금융입니다.
                  이를 위해 금융회사는 채무자와 약정을 체결하고 채무자가
                  신청·지정한 대출금 지급계좌(별도 지정이 없을 경우 자동이체
                  계좌로 합니다)에 대출금을 입금합니다.
                </div>
              </li>
              <li
                :class="[
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  판매사와 금융사간의 할부 약정 체결로 이루어지는 할부(3자
                  거래)와 달리
                  <span class="color-green"
                    >오토론은 금융회사와 소비자의 대출 약정 체결(2자 거래)</span
                  >로 이루어지며
                  <span class="color-red underline"
                    >대출금은 고객계좌 송금을 원칙</span
                  >으로 합니다.
                </div>
              </li>
            </ul>
              ...
              <ul :class="$style['manual-qna__list']">
                ...
                <li :class="$style['manual-qna__item']">
                  <div :class="$style['manual-qna__head']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <h5 :class="$style['manual-qna__title']">
                        오토론을 이용하기 위해서는 어떤 비용을 부담해야 하나요?
                      </h5>
                    </div>
                  </div>
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        오토론을 이용하실 경우, 기본적으로 대출금과 이자에 대한
                ...
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <span class="color-green"
                          >담보의 제공은 재산상 손실을 가져올 수 있는 중대한
                          법률행위</span
                        >로서,
                        <span class="color-red"
                          >고객이 대출금을 상환하지 않으면 금융회사가 해당
                          담보물을 처분할 수 있음</span
                        >을 유의하여 주시기 바랍니다. 아울러
                        <span class="color-red"
                          >근저당 설정비용은 금융회사가, 말소비용은 고객이
                          부담</span
                        >하니 참고하여 주시기 바랍니다. (☞<span
                          class="color-red"
                          >‘4. 수수료 등 비용부담’, ‘8. 담보권 설정 및
                          권리변동’</span
                        >
                        확인)
                      </div>
              ...
              <ul :class="$style['manual-qna__list']">
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <span class="color-green">당사 인터넷 홈페이지</span
                        ><br />
                        <span class="color-green"
        ...
        <section class="row-margin-container-medium">
          ...
          <div :class="$style['basic-table']">
            <table>
              ...
              <tbody>
                <tr>
                  <th>상품명</th>
                  <td class="align-left">오토론 중고차론</td>
                </tr>
                <tr>
                  <th>적용금리</th>
                ...
                <tr>
                  ...
                  <td class="align-left">
                    ...
                    <p class="row-margin-item-regular">최대 2 %</p>
                  </td>
                </tr>
                <tr>
                  <th>상환방식</th>
                  <td class="align-left">원리금균등분할상환</td>
                </tr>
              </tbody>
            </table>
          </div>

          <div class="color-black text-body-2 row-margin-contents">
            본 중고차오토론 상품은 개인 또는 개인사업자 또는 법인고객을 대상으로
            하는 중고차 구매를 위한 자동차 대출상품으로, 매월 동일한 원리금을
            납부하시는 ‘원리금균등분할상환’ 방식만 가능합니다. 상환방식에 따른
            자세한 설명은 ‘5. 대출금의 상환방법’을 확인하여 주시기 바랍니다.
          </div>
          ...
          <section class="row-margin-contents">
            ...
            <div class="row-margin-contents">
              ...
              <p class="text-body-2 align-center">대출/론 상품 거래절차</p>
            </div>
          </section>
        </section>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    고객에게 실제 적용되는
                    <span class="underline">약정금리</span>는
                    <span class="underline">①기준금리와 ②조정금리</span>가
                    반영되어 결정됩니다.
                  </div>
        ...
        <section class="row-margin-container-medium">
          ...
          <NoticeText :classNames="{ wrap: 'color-red row-margin-contents' }">
            ...
            후에 확인 가능하므로, 심사 후 담당자가 안내드리겠습니다.
          </NoticeText>
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    30일 미만 상환시 대출 사용기간을 30일로 간주합니다.
                  </p>
                </div>
              </li>
            </ul>
          ...
          <section class="row-margin-contents">
            ...
            <p class="text-body-2">
              인지세법에 의해 약정 체결 시 납부하는 세금으로 대출금액에 따라
              세액이 차등 적용되며,
              <span class="color-green"
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  고객님께서는 납입일을 정하여, 일정주기(매월 등)마다 납입금을
                  납입하셔야 합니다. 약정 시 자동이체를 선택하고 관련 정보 제공
                  시, 등록한 자동이체 계좌에서 자동이체됩니다.
                </div>
              </li>
              <li
                :class="[
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동이체로 납입금 납입 시, 납입일에 잔고부족 등의 이체불가
                  사유로 납입하실 금액 전부를 이체할 수 없는 경우에는 납입지정일
                  이후 회사가 정하는 출금일에 미납금액(지연배상금 포함)을
                  출금하여 납입금에 충당할 수 있습니다.
                  <span class="color-red"
                    >(고객이 지정한 납입일 오전 10시 이전에 청구되며, 금융기간
                    영업시간 내에 출금되므로 그 시간 내에 납입금 잔액이 있어야
                    함)</span
                  >
                </div>
              </li>
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동이체 계좌는 고객센터(1800-1110)를 통해 변경 가능하나,
                  자동이체일 4영업일 전까지 변경(금융기관별 상이)하실 경우 당월
                  적용 가능하며, 그 이후에는 익월부터 변경사항 적용될 수 있음을
                  유의해주시기 바랍니다.
                </div>
              </li>
              <li
          ...
          <section class="row-margin-contents">
            ...
            <p class="row-margin-mini">원리금균등분할상환 방식의 경우</p>
            <p class="text-body-4 font-weight-light color-gray-tertiary">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <th>원리금균등<br />분할상환</th>
                    <td>
                      <div class="underline">11,074,560원</div>
                    </td>
                    <td>
                      <div class="underline">
                        1회 ~ 24회<br />
          ...
          <section class="row-margin-contents">
            ...
            <ul :class="[$style['basic-list'], $style['basic-list--regular']]">
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  대출원금과 이자의 합계를 매월 동일한 금액으로 갚아가는 방식<br />
                  매월 납입하시는 상환 금액이 동일하며 이중 대출원금에 대한
                  상환금액이 높아지게 됩니다.
                </div>
              </li>
              <li
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            <p class="row-margin-item-regular align-left">
                              대출원금과 이자의 합계를 매월 동일한 금액으로
                              갚아가는 방식<br />
                              매월 납입하시는 상환 금액이 동일하며 이중
                              대출원금에 대한 상환금액이 높아지게 됩니다.
                            </p>
                          </td>
                        </tr>
                      </tbody>
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        이자를 납입하여야 할 날의 다음날부터 기업인 경우에는
                        14일(기업이 아닌 경우에는 30일)까지는 내셔야 할
                        약정이자에 대해 연체이자가 적용되고, 기업인 경우에는
                        14일(기업이 아닌 경우에는 30일)이 경과하면
            ...
            <div class="row-margin-contents">
              ...
              >
                (예시) 원금 2천만원 (원리금균등, 대출기간 24개월), 약정이자율 연
                10%, 연체가산이자율 연 3%인 신용대출의 1회차 원금(75.6만원) 및
                이자(16.6만원)를 미납하여 연체가 발생하고, 연체발생후 2개월
                시점에 납부할 경우 연체이자
              </p>
                      ...
                      <div class="row-margin-item">
                        ...
                        >
                          ...
                          >
                            <div :class="$style['basic-list__symbol']"></div>
                            <div :class="$style['basic-list__content']">
                              이자등을 지급하기로 한 때부터 계속하여
                              <span class="color-red font-weight-medium"
                                >기업인 경우에는 14일(기업이 아닌 경우에는
                                30일)</span
                              >간 지체한 경우
                            </div>
                          </li>
          ...
          <ul :class="[$style['basic-list'], 'row-margin-item']">
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                통하여 영업시간 내 진행 가능합니다. 금융회사는 고객에게
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                <strong>이미 공급받은 금전·재화와 그에 대한 이자</strong>(금전을
                지급받은 날부터 금전을 돌려준 날까지의 기간에 대해 약정된
                이자율과 공급받은 금전을 곱한 금액)를 반환하여야 합니다. 아울러
                <strong
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="underline">
                  ...
                  철회하는 경우, 신규대출·만기연장 거절, 대출한도 축소, 금리우대
                  제한 등 불이익이 발생할 수 있습니다.
                </div>
              </div>
            </li>
          </ul>
          ...
          <section class="row-margin-container-medium">
            ...
            <section>
              ...
              >
                <table>
                  ...
                  <tbody>
                    <tr>
                      <th class="th-title" rowspan="2">비용*</th>
                      <th>중도상환수수료</th>
                      <td>-</td>
                    </tr>
                    <tr>
            ...
            <section class="row-margin-contents">
              <p class="text-body-3">대출 중도 상환</p>
              <div
                :class="[
                  $style['basic-table'],
                  'row-margin-item',
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-small">15. 개인신용평가대응권</h3>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  평가의 평가에 이용된
                  <strong>기초정보 등에 대해 설명하여 줄 것을 </strong>
                  <strong class="color-green">금융회사</strong>에 요구*할 수
                  있습니다.
                </div>
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">
            17. 중고차 대출 관련 사기 유의사항 안내
          </h3>

          <p class="text-body-2">
            다음과 같이 <strong class="color-red">고수익</strong> 또는
            <strong class="color-red">취업</strong>을 약속하면서
            <strong class="color-red">자동차</strong>를
            <strong class="color-red">편취</strong>하거나, 현금을 융통해 준다고
            하면서 <strong class="color-red">자동차를 비싸게 판매</strong>하는
            <strong class="color-red">자동차 금융사기</strong>가
            <strong class="color-red">빈번히 발생</strong>하고 있습니다.
          </p>
          ...
          <ul class="reset-list row-margin-item">
            ...
            >
              ...
              <div>
                렌터카 사업에 쓸 자동차를 구입해 주면 대출 원리금을 대신 납부해
                주고 추가 수익도 지급하겠다고 하였으나, 렌터카 사업자가 자동차만
                받고 잠적
              </div>
            </li>
            <li
            ...
            >
              ...
              <div>
                중고차 수출업자가 대출을 받아 중고차를 구매해 해당 차량을 비싸게
                수출하여 수익을 지급하겠다고 하였으나, 중고차 수출업자가
                자동차만 받고 잠적
              </div>
            </li>
            <li
            ...
            >
              ...
              <div>
                지인인 중고차 딜러가 실적이 부족하다며 중고차 대출을 받아
                구매해주면 3개월 안에 재판매하겠다고 하였으나, 지인은 자동차를
                편취하고 잠적
              </div>
            </li>
            <li
            ...
            >
              ...
              <div>
                중고차 딜러가 중고차 가격을 부풀려 계약하여 대출을 받으면 해당
                금액만큼 융통이 가능하다고 하였으나, 자동차만 비싸게 구매하고
                현금은 못 받음
              </div>
            </li>
          </ul>
          ...
          <p class="text-body-2">
            <strong
              ...
              자동차 대출을 신청하시는 경우 자동차는 받지 못하고, 대출원리금만
              떠안는 등 <span class="color-red">예상하지 못한 피해</span>를 입게
              되실 수 있습니다.</strong
            >
          </p>
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  고수익을 보장하거나 현금을 융통해 준다고 약속을 받고 자동차
                  할부금융을 신청하시는 경우 자동차는 받지 못하고, 할부금융
                  원리금만 떠안는 등 예상하지 못한 피해가 발생할 수 있음을
                  이해하고 확인하셨습니까?
                </div>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription005_012.scss';
</style>
