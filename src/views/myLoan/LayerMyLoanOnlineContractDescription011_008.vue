  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <PageTextGroup>
        <PageMainText>
          위법계약을<br />
          <span class="font-weight-bold">해지할 수 있어요</span>
        </PageMainText>
      </PageTextGroup>

      <IllustObject type="cancel" :classNames="{ wrap: 'row-margin-none' }" />
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription011_008.scss';
</style>
