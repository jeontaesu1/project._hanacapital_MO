    ...
    <PageContents>
      ...
      <BasicBox>
        <BasicBoxHead>
          ...
          <BasicBoxHeadRight>
            <TextButton theme="secondary" :block="true">
              만기후처리 변경
        ...
        <KeyValue margin="regular">
          ...
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
            ...
            <KeyValueText>9,999,999 원</KeyValueText>
          </KeyValueItem>
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
          ...
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
            ...
            <KeyValueText>직전이전</KeyValueText>
          </KeyValueItem>
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
          ...
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
            ...
            <KeyValueText>2022.02.22</KeyValueText>
          </KeyValueItem>
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
            <KeyValueTitle>반환장소</KeyValueTitle>
            <KeyValueText>
              인천 서구 에코로 181<br />
              하나금융그룹 로비
            </KeyValueText>
        ...
        <div class="row-margin-contents-small">
          <BasicButton size="small">연장 심사접수 하러가기</BasicButton>
        </div>
        <!-- // Case : 연장 -->
      </BasicBox>
      ...
      <StickyBar>
        <NavTab :useUiTab="true" :scroll="true" :auto="true">
          <NavTabButton link="myLoanPostMaturityLeaseAfterTab001"
            >연장</NavTabButton
          >
          <NavTabButton link="myLoanPostMaturityLeaseAfterTab002"
            >반환</NavTabButton
          >
          <NavTabButton link="myLoanPostMaturityLeaseAfterTab003"
            >구매</NavTabButton
          >
        </NavTab>
      </StickyBar>

      <UiTabPanel name="myLoanPostMaturityLeaseAfterTab001">
              ...
              <div :class="$style['step__inner']">
                <div :class="$style['step__contents']">
                  ...
                  <div :class="$style['step__text']">
                    홈페이지/모바일(웹)을 통하여
                    <strong>재리스 신청 및 견적을 요청</strong>합니다.<br />
                    (신용조회동의)
                  </div>
                </div>
        ...
        <div class="row-margin-container-medium">
          <section class="row-margin-container-medium">
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-body-2 font-weight-regular">금융리스 : 연 4~10%</p>
            </section>
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-body-2 font-weight-regular">12개월 ~ 60개월</p>
              <p
                class="text-body-4 font-weight-light color-gray-tertiary row-margin-mini"
              >
                (내용연수기간 이내)
              ...
              <ul :class="[$style['basic-list'], 'row-margin-item']">
                <li :class="$style['basic-list__item']">
                  <div :class="$style['basic-list__symbol']">※</div>
                  <div :class="$style['basic-list__content']">
                    내용연수: 운용리스 60개월, 금융리스 84개월 (이전 계약기간
                    포함)
                  </div>
                </li>
              </ul>
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-body-2 font-weight-regular">원리금균등상환</p>
              <p
                class="text-body-4 font-weight-light color-gray-tertiary row-margin-mini"
              >
                (월 리스료 자동이체(통장))
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-body-2 font-weight-regular">매월 후취</p>
            </section>
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-body-2 font-weight-regular">하나캐피탈</p>
              <p
                class="text-body-4 font-weight-light color-gray-tertiary row-margin-mini"
              >
                (단, 이용자명의 시 저당설정 추가)
            ...
            <section class="row-margin-contents">
              ...
              <div>
                ...
                <p class="text-body-2 row-margin-item">
                  운용리스의 경우, 만기 차량 반납 시 사고이력 또는 약정주행거리
                  초과에 따라 별도의 감가비용이 추가로 발생할 수 있습니다.
                </p>
                <p class="text-body-2 row-margin-item">
          ...
          <section class="row-margin-container-medium">
            ...
            <ul :class="[$style['basic-list'], 'row-margin-contents']">
              ...
              <li :class="$style['basic-list__item']">
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  여신금융협회 심의필 제xxxx-xxx-xxxxx호<br />
                  (2022.01.01~2022.12.31)
                </div>
              </li>
            </ul>
      ...
      <UiTabPanel name="myLoanPostMaturityLeaseAfterTab002">
      ...
      <UiTabPanel name="myLoanPostMaturityLeaseAfterTab003">
