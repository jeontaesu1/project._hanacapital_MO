  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>사업자담보대출 설명서</PopupTitle>
      ...
      <div>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  당사의 사업자담보대출은 아파트(주상복합포함)를 담보로 대출이
                  실행되는 상품으로, 사업용도 자금목적으로만 사용이 엄격히
                  제한되며, 대출금액 1억 초과 건 실행 후 3개월 이내 자금용도
                  사후점검을 합니다.(계약서, 영수증, 계산서, 통장거래내역 등
                  증빙자료 첨부)
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  사업자담보대출은 대출자금의 자금용도 외 유용 시 해당금액을
                  즉시 상환하여야 할 뿐만 아니라 향후 신규대출이 제한될 수
                  있습니다.
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  사업자담보대출은 대출의 목적, 아파트의 위치/시세 등에 따라
                  대출의 가능여부 및 범위가 달라질 수 있으며 통상적으로
                  신용대출보다 금리가 낮습니다. (☞
                  <span class="color-red">‘1. 상품 개요 및 특성’</span> 확인)
                </div>
              </li>
            </ul>
          </section>
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        실제로 사업을 영위하는 업력 3개월 이상의 개인사업자로
                        담보 주택 소유권 이전등기일로부터 3개월 경과 확인된 자
                        (단, 주택임대사업자와 주택매매사업자는 취급불가)
                      </div>
                    </div>
                  </div>
                </li>
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <div>
                          ...
                          감소하게 됩니다. <br />(☞<span class="color-red"
                          ...
                          >
                            ...
                            >
                              <div :class="$style['basic-list__symbol']">*</div>
                              <div :class="$style['basic-list__content']">
                                예) 2천만을 중도상환(적용요율을 2%로 가정)할
                                경우, 고객은 최대 40만원의 중도상환수수료를
                                금융회사에 납부해야 함
                              </div>
                            </li>
                          </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          <div :class="$style['basic-table']">
            <table>
              ...
              <tbody>
                <tr>
                  <th>상품명</th>
                  <td class="align-left">사업자담보대출</td>
                </tr>
                <tr>
                  <th>대상</th>
                  <td class="align-left">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__content']">
                본 대출상품은 개인사업자를 대상으로 아파트 (주상복합 포함)를
                담보로 하는 상품으로 사업용도 자금목적만 대출 가능한 상품입니다.
                대상자의 신용점수와 담보로 하는 아파트의 위치, 시세에 따라
                한도와 금리가 결정됩니다.
              </div>
            </li>
          </ul>
          ...
          <section class="row-margin-contents">
            ...
            <ul :class="[$style['basic-list'], 'row-margin-item']">
              ...
              >
                <div :class="$style['basic-list__symbol']">※</div>
                <div :class="$style['basic-list__content']">
                  잔존기간 : 30일미만 상환시 ‘대출사용기간’을 30일로 간주
                </div>
              </li>
              <li
                :class="[
              ...
              >
                <div :class="$style['basic-list__symbol']">※</div>
                <div :class="$style['basic-list__content']">
                  (예시) 2년 만기 대출을 받고나서 6개월 후 대출금 1억원을
                  상환활경우 적용되는 중도상환수수료는?
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  100,000,000×1%+100,000,000×(2%-1%)×540/(720-30) = 1,782,600
                  중도상환수수료 178만2천6백원
                </div>
              </li>
              <li
            ...
            <div class="prepayWrap marginTop24">
              <p class="font-weight-medium color-green">중도상환수수료란?</p>
              <ul :class="[$style['basic-list'], 'row-margin-item']">
                <li
                  :class="[
                    $style['basic-list__item'],
                ...
                >
                  ...
                  <div :class="$style['basic-list__content']">
                    ...
                    <span class="color-green font-weight-medium underline"
          ...
          <section class="row-margin-contents">
            ...
            <ul :class="[$style['basic-list'], 'row-margin-item']">
              ...
              >
                <div :class="$style['basic-list__symbol']">-</div>
                <div :class="$style['basic-list__content']">
                  근저당권 설정 비용 : 금융회사 부담 단, 설정등기시
                  국민주택채권매입비는 고객(채무자) 부담
                </div>
              </li>
              <li
                :class="[
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  이자를 납입하셔야 합니다. 약정 시 자동이체를 선택하고 관련
                  정보 제공 시, 이자는 은행의 본인명의 계좌에서 자동이체 됩니다.
                </div>
              </li>
              <li
                :class="[
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동이체 계좌는 고객센터(1800-1110)를 통해 변경이 가능하지만,
                  자동이체일 4영업일 전 변경하실 경우에는 당월 적용이 가능하며,
                  그 이후에는 익월 부터 변경사항이 적용됨을 유의해주시기
                  바랍니다.
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    (예시) 대출금액 2천만원, 금리 10%, 대출기간 24개월 (소수점
                    이하 절사)
                  </p>
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td rowspan="2">
                            <p class="underline">23,999,984 원</p>
                          </td>
                          <td>
                            <p class="underline">
                              1회 ~ 23회<br />
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <th>유의사항</th>
                    <td class="align-left">
                      만기일시상환의 경우 만기 도래 시 한꺼 번에 원리금을
                      상환하여 부담이 클 수 있으며, 신용도 등을 고려하여
                      연장계약 불가능할 수도 있습니다. 일반적으로
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2 font-weight-medium">
            연체이자율은 [대출이자율 + 연체가산이자율]로<br />
            적용되며,
            <span class="underline">연체가산이자율은 연 3%로 적용</span>합니다.
          </p>
          ...
          <section class="row-margin-contents">
            ...
            <div class="row-margin-contents">
              ...
              >
                (예시) 원금 1억2천만원, 약정이자율 5%, 연체가산이자율 연 3%인
                대출의 이자(50만원)를 미납하여 연체가 발생하고, 연체발생 후 35일
                시점에 납부할 경우 연체이자
              </p>
              ...
              <div :class="$style['basic-table']">
                <table>
                  ...
                  <tbody>
                    <tr>
                      <th>연체발생<br />~14일분</th>
                      <td>지체된 약정이자 (50만원)×연8% (5%+3%)× 14/365</td>
                      <td>1,534 원</td>
                    </tr>
                    <tr>
                      <th>연체15일<br />~35일분</th>
                      <td>원금(1억2천만원) × 연8%(5%+3%) × 21/365</td>
                      <td>552,329 원</td>
                    </tr>
                  </tbody>
                  <tfoot>
              ...
              >
                ...
                >
                  <div :class="$style['basic-list__symbol']">※</div>
                  <div :class="$style['basic-list__content']">
                    위 내용은 이해를 돕기위해 연체이자만을 단순하게 계산한
                    예시입니다. 연체이자는 대출조건, 대출종류 등에 따라 달라질
                    수 있으며, 실제 납부금액은 연체이자에 약정이자를 포함하여
                    계산됩니다.
                  </div>
                </li>
              </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__content']">
                  <div :class="['text-body-4', 'color-gray666']">
                    기한의 이익이란?
                  </div>
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    <li
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']"></div>
              <div :class="$style['basic-list__content']">
                <div class="underline font-weight500">
              ...
              <div :class="$style['basic-list__content']">
                ...
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  ...
                  >
                    ...
                    <div :class="$style['basic-list__content']">
                      <div>
                        여신거래와 관련하여 허위, 위ㆍ변조 또는 고의로
                        부실자료를 제출한 사실이 확인되어 회사의 채권보전에
                        현저한 위험이 예상될 경우
                      </div>
                    </div>
                  </li>
                  ...
                  >
                    ...
                    <div :class="$style['basic-list__content']">
                      <div>
                        이자 등을 지급하기로 한 때부터 계속하여 30일간 지체한
                        경우
                      </div>
                    </div>
                  </li>
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                경우에도 일정기간 개인신용평점 (개인사업자일 경우
                기업신용등급)의 산정에 영향을 줄 수 있습니다.
              </div>
            </li>
          </ul>
        </section>
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                <ul :class="[$style['basic-list'], 'marginTop8']">
                  <li
                    :class="[
                      $style['basic-list__item'],
                      'color-black',
          ...
          <ul :class="[$style['basic-list'], 'row-margin-item', 'marginTop24']">
            <li
              :class="[
                $style['basic-list__item'],
                'color-gray-tertiary',
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  일정한 자격을 갖춘 고객을 대상으로 한 대출(공무원대출 등 기타
                  협약대출 등)의 경우 같은 자격이 유지되는 경우 에만 기한이
                  연장될 수 있습니다.
                </div>
              </li>
            </ul>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    (예시) 원금 1억2천만원, 약정이자율 5%, 연체가산이자율 연
                    3%인 대출의 이자(50만원)를 미납하여 연체가 발생하고,
                    연체발생 후 35일 시점에 납부할 경우 연체이자(단, 해당 대출은
                    기업대출)
                  </p>
                </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="align-left">
                    ...
                    포함하여 대출거래의 주요내용 및 고객 부담비용에 대하여
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription011_011.scss';
</style>
