  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>중도금대출 설명서(기업용)</PopupTitle>
      ...
      <div>
        <section>
          ...
          <section class="row-margin-contents">
            ...
            <div class="color-black text-body-2">
              중도금대출 분양대금 납부에만 사용되며, 하나캐피탈, 시행사, 신탁사,
              ...
              <ul :class="$style['manual-qna__list']">
                ...
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        만기전 상환가능(중도상환 수수료 면제)<br />
                        대출실행 이후 대출상환을 원할 경우 즉시 상환이 가능하며,
                        수수료는 발생하지 않습니다.
                      </div>
                    </div>
                  </div>
                ...
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        인지세<br />
                        인지세법에 따라 납부하는 세금으로 금융사와 고객이 각각
                        50% 부담합니다.
                      </div>
                    </div>
                  </div>
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            ...
                            <div :class="$style['basic-list__content']">
                              예) 대출원금이 1억원인 경우, 최대 월 연체이자
                              100만원(연체이자율 12% 적용)이 발생하므로 연체가
                              발생하지 않도록 유의
                            </div>
                          </li>
                        </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="color-green">
                  본 대출상품은 하나캐피탈과 약정된 사업장의 수분양자를 대상으로
                  하는 ‘중도금대출’ 상품으로, 시행사, 시공사, 신탁사 등의
                  업무협약에 따라 대출금액과 금리가 결정됩니다.
                </div>
              </div>
            </li>
            <li
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="color-green">
                  본 대출상품은 ‘만기일시상환’ 방식으로 운영되는 상품입니다.
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td rowspan="2">
                            <p class="underline">11,999,992 원</p>
                          </td>
                          <td>
                            <p class="underline">
                              1회 ~ 23회<br />
          ...
          <section class="row-margin-contents">
            ...
            <div class="row-margin-contents">
              ...
              >
                ...
                연체가산이자율 연 3%인 신용대출의 분할상환금(1백만원) 및
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']"></div>
              <div :class="$style['basic-list__content']">
                신용공여(대출 등) 사실만으로 신용등급이 하락할 수 있으며,
                평균적으로 연체율이 높은 금융권역(또는 형태)의 신용공여는 여타
                금융권역 또는 일반적인 형태의 신용공여보다 신용등급이 더 큰
                폭으로 하락할 수 있습니다.
              </div>
            </li>
            <li
        ...
        <section class="row-margin-container-medium">
          ...
          <ul :class="[$style['basic-list'], 'row-margin-item']">
            ...
            >
              <div :class="$style['basic-list__symbol']">-</div>
              <div :class="$style['basic-list__content']">
                다만, 대출신청 이후 고객에 의한 대출취소 또는 대출심사 거절 시
                발생한 비용(등기설정/말소비용, 감정수수료, 인지세 등)을 고객이
                부담해야합니다.
              </div>
            </li>
            <li
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
            ...
            <p class="text-body-2">
              중도금대출의 이자를 시행사 또는 신탁사가 대신 납부하더라도 최종
              납입의무는 계약자에게 있습니다.
            </p>
          </section>
        </section>
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    ...
                    5%, 연체가산이자율 연 3%인 신용대출의 분할상환금(1백만원) 및
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  ...
                  있습니다.
                  <strong class="font-weight-medium"
                    >다만, 동일한 금융회사를 대상으로 최근 1개월 내에 2회 이상
                    대출계약을 철회하는 경우, 신규대출·만기연장 거절, 대출한도
                    축소, 금리우대 제한 등 불이익이 발생할 수 있습니다. 이
                    내용을 확인하셨습니까?</strong
                  >
                </div>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription003_010.scss';
</style>
