      ...
      <div>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  스탁론은 회사와 업무제휴를 맺은 증권사의 손님을 대상으로 그
                  증권계좌의 주식, 예수금을 담보로 평가하여 회사 상품기준에 따라
                  대출금을 지급하는 상품입니다.
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  스탁론 상품은 다른 가계대출 상품과는 달리 심사 (개인신용점수
                  등)에 따라 금리가 차등적용되지 않으며, 상품의 특성에 따라
                  금리가 적용됩니다. (☞
              ...
              <ul :class="$style['manual-qna__list']">
                ...
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <div>
                          스탁론의 경우 다른대출 상품과는 달리 만기 전 담보비율
                          120%~130% 충족시 언제든지 중도에 상환 하실 수
                          있습니다. (중도상환수수료 면제)
                        </div>
                      </div>
                    </div>
                ...
                <li :class="$style['manual-qna__item']">
                  <div :class="$style['manual-qna__head']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <h5 :class="$style['manual-qna__title']">
                        스탁론을 이용하기 위해서는 어떤 비용을 부담해야 하나요?
                      </h5>
                    </div>
                  </div>
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        ...
                        상환의무를 부담하시게 되며, 인지세의 경우 고객과
                        금융회사가 각 50%씩 추가적인 비용을 부담하실 수
                        있습니다. (☞<span class="color-red"
                          >‘4. 수수료 등 비용부담’</span
                        >
                        확인)
                      </div>
        ...
        <section class="row-margin-container-medium">
          ...
          <div :class="$style['basic-table']">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <th>적용금리</th>
                  <td class="align-left">6.1%</td>
                </tr>
                <tr>
                  <th>대출신청금액</th>
                  <td class="align-left">50,000,000 원</td>
                </tr>
                <tr>
                  <th>금리적용방식</th>
                  <td class="align-left">
                ...
                <tr>
                  <th>대출기간</th>
                  <td class="align-left">취급 후 12개월</td>
                </tr>
                <tr>
                  <th>중도상환수수료율</th>
                  <td class="align-left">없음</td>
                </tr>
                <tr>
                  <th>대출실행/만기일</th>
                  <td class="align-left">2024.05.27 ~ 2027.06.01</td>
                </tr>
                <tr>
                  <th>담보물건<br />(저당설정시)</th>
                  <td class="align-left">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__content']">
                본 상품은 본인 명의 증권위탁계좌를 질권설정하고 주식매입자금을
                위한 자금을 지원 하는 상품입니다. 스탁론 상품은 다른 가계대출
                상품과는 달리 심사 (개인신용점수 등)에 따라 금리가 차등 되지
                않아 금리인하요구권이 적용되지 않습니다.
              </div>
            </li>
          </ul>
        </section>
          ...
          <div class="row-margin-item">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  <strong :class="['color-red', 'underline']">
                    스탁론 상품은 심사(신용점수 등)에 따라 금리가 차등적용 되지
                    않으므로 금리인하요구권 대상 상품이 아닙니다
                  </strong>
                </div>
              </li>
            </ul>
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  스탁론 상품은 인지세 외 별도 발생되는 비용은 없으며
                  실질유효금리는 상품 개요의 적용예정금리(고정)와 같습니다.
                </div>
              </li>
              <li
                :class="[
          ...
          <section class="row-margin-contents">
            ...
            <div class="row-margin-contents">
              ...
              >
                ...
                연체가산이자율 연 3%인 신용대출의 분할상환금 (1백만 원) 및
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    ...
                    5%, 연체가산이자율 연 3%인 신용대출의 분할상환금 (1백만원)
                    및 이자(50만원)를 미납하여 연체가 발생하고, 연체발생후 2개월
                    시점에 납부할 경우 연체이자
                  </p>
                </div>
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription010_011.scss';
</style>
