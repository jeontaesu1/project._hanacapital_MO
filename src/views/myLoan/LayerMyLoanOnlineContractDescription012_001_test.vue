      ...
      <div>
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    <span class="color-green">혼합금리</span> : 대출성상품 실행 시부터 고정금리 약정기간 동안에는 고정금리를 적용하고, 약정기간 경과 후 대출 잔여기간에는 변동금리를 적용하는 등 고정금리와 변동금리가 혼합되어 적용되는 금리입니다.
                  </div>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    고객에게 실제 적용되는
                    <strong class="font-weight-medium">약정금리</strong>
                    자금조달금리에 각종
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    ...
                    <strong class="font-weight-medium">기준금리</strong>와
                    <strong class="font-weight-medium">가산금리</strong>의
                    합으로 표시됩니다.
                  </div>
                  <!--오후 작업 -->
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        <strong class="font-weight-medium">기준금리</strong>는
                      ...
                      <div :class="$style['basic-list__content']">
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            <div :class="$style['basic-list__symbol']">*</div>
                            <div :class="$style['basic-list__content']">
                              금융채연동금리: 금융투자협회에서 공시하는
                              금융채AA- 6개월물 또는 금융채AA-
                              5년물(KIS채권평가기준) 금리로 매 6개월마다 변경
                            </div>
                          </li>
                        </ul>
                      </div>
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        <strong class="font-weight-medium">가산금리</strong>는 당사가 대출취급에
                        따른 원가비용 등을 감안하여
                        대출 기준금리에 자율적으로 가산하는
                        금리를 말하며, 아래 등과 같이 구성됩니다.
                      </div>
                    </li>
                    <!-- font-weight 300-->
                    ...
                    <li :class="$style['basic-list__item']">
                      ...
                      <div :class="$style['basic-list__content']">
                        <span class="font-weight-regular"
                          ...
                          가산되는 금리로, 기준금리에 더해져 실제 약정금리를 결정합니다.</span
                        >
                      </div>
                    </li>
                    <li
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        결정된 <strong class="font-weight-medium">대출금리(약정금리)</strong>는
                        개별약정에 의해 별도로 정한 항목(변동금리대출의 기준금리 등)
                        이외에는 대출만기일까지
                        동일하게 적용됩니다.
                      </div>
                    </li>
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      ...
                      <div :class="$style['basic-list__content']">
                        <!-- style="color:#000"-->
                        기한연장, 채무자변경 등 ‘<strong
                        class="font-weight-medium color-black"
                        >
                          대출조건이 변경되는 경우</strong>’
                          에는 변경 당시의 원가요소와 마진을 기준으로
                        <strong class="font-weight-mediumc color-black">
                          대출금리가 변경될 수 있습니다.
                        </strong>
                      </div>
                    </li>
          ...
          <div class="row-margin-item">
            ...
            >
                  ...
                  <div>
                    ...
                    <span class="underline"
                      ><strong class="font-weight-medium"
                        ...
                        재산증가, 신용평가등급(평점) 등 신용도 상승, 기타 신용상태
                        개선)</strong
                      >
                      *금융회사에
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  금리인하요구권은 영업점 방문 및 비대면채널(예 :
                  홈페이지,모바일)을 통해 신청 가능하며 금융회사는 금리인하를
                  요구하는 고객에게 신용상태 개선을 확인하는 데 필요한 자료의
                  제출을 요구할 수 있습니다.
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  >-->
                  금리인하 요구를 받은 날부터
                  <span class="color-green">‘10영업일 이내’</span>
        ...
        <section class="row-margin-container-medium">
          ...
          <section>
            ...
            <p class="text-body-2">
              대출의 상환기일이 도래하기전에 대출금을 상환할 경우 고객이 부담하는 금액으로, 대출취급일로부터 (3년)까지 적용합니다.
              <span class="color-green"
            ...
            <div :class="[$style['basic-table'], 'row-margin-item']">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <th>기존 근저당권 <br />설정 등기의 <br />주소 변경</th>
                    <td class="align-left">
                      1건 : 30,000원 <br />
                  ...
                  <tr>
                    ...
                    <td class="align-left">
                      근저당 채권최고액의 1% X 일별 채권할인율(근저당권 설정일 기준) <br />
                      <span :class="[$style['color-666']]">
                        예시) ‘21.7.30일 기준 <br />1억원 설정시 43,750원 부담<br />
                        ※ 상세 금액은 국민주택기금<br />
                        홈페이지 등에서 확인 가능합니다.
                      </span>
                    </td>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-left">
                      담보로 제공하는 부동산의 종류, 주소지, 감정가격 등에 따라 상이<br /> 
                      <span :class="[$style['color-666']]">
                        예시) 정식감정(현장 조사 진행): 서울 오피스텔 감정가 3.4억 기준, 약 55만원
                      </span>
                    </td>
                  </tr>
                </tbody>
        ...
        <section class="row-margin-container-medium">
          ...
          <section class="row-margin-contents">
            <h4 class="text-body-2 row-margin-item-medium">대출금(원리금)의 납입</h4>
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    (예시) 대출금액 <span :class="$style['fb-500']">
                      1억원, 금리 5%, 대출기간 60개월
                    </span>(소수점 이하 절사)
                  </p>
        ...
        <section class="row-margin-container-medium">
          ...
          <section :class="[$style['mtmb24']]">
            <p :class="[$style['font13'], $style['fb-300'], $style['margin0']]">
              기한의 이익이란?
            </p>
            ...
            <p :class="[$style['font13'], $style['fb-300'], $style['mt-24']]">
              기한의 이익이 상실되면?
            </p>
            <ul :class="[$style['basic-list'], 'row-margin-item']">
              <li
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  <p class="text-body-4 font-weight-light color-gray-tertiary">
                    ...
                    시점에 납부할 경우 연체이자
                    <!--
                    (예시) 원금 2천만원 (원리금균등, 대출기간 24개월),
                    약정이자율 연 10%, 연체가산이자율 연 3%인 신용대출의 1회차
                    원금(75.6만원) 및 이자(16.6만원)를 미납하여 연체가 발생하고,
                    연체발생 후 2개월 시점에 납부할 경우 연체이자
                    -->
                  </p>
                </div>
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr>
                        <th>연체발생<br />~30일분</th>
                        <td style="padding-left: 0; padding-right: 0">
                          지체된 <br />분할상환금 및 약정이자 <br />(150만원)x연8%<br />
                          (5%+3%)x30/365
                        </td>
                        <td>9,863 원</td>
                        <!--9,861-->
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  ...
                  <strong :class="$style['fb-700']"><!--font-weight-medium-->
