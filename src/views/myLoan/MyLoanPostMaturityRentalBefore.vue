      ...
      <template v-slot:foot>
        ...
        >
          <ButtonListItem>
            <BasicButton
              v-if="
                tabSlotProps.activeName === 'myLoanPostMaturityRentalBefore001'
              "
              >연장신청</BasicButton
            >
            <BasicButton
              v-if="
                tabSlotProps.activeName === 'myLoanPostMaturityRentalBefore002'
              "
              >반환신청</BasicButton
            >
            <BasicButton
              v-if="
                tabSlotProps.activeName === 'myLoanPostMaturityRentalBefore003'
              "
              >구매신청</BasicButton
            >
          </ButtonListItem>
