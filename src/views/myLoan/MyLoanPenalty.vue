  ...
  <PageContents>
    <div>
      <FormList>
        <FormListItem
          titleText="조회기간 선택"
          target="#myLoanPenaltyDateStartButton"
        >
          <FormInvalid :error="state.dateError">
            <InputBlock :error="state.dateError">
              <InputBlockCell :flexible="true">
                <BasicDatepicker
                  title="조회기간 시작 날짜"
                  id="myLoanPenaltyDateStart"
                  buttonId="myLoanPenaltyDateStartButton"
                  :max="state.maxDate"
              ...
              <InputBlockCell :flexible="true" margin="regular">
                <BasicDatepicker
                  title="조회기간 종료 날짜"
                  id="myLoanPenaltyDateEnd"
                  buttonId="myLoanPenaltyDateEndButton"
                  :min="state.minDate"
    ...
    <LayerMyLoanPenaltyDetail ref="layer" />
  </PageContents>
</template>
