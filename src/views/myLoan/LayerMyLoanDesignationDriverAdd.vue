  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <BasicBox>
        ...
        <KeyValueList margin="regular">
          ...
          >
            ...
            <KeyValueText>하나손해보험주식회사</KeyValueText>
          </KeyValueItem>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        ...
        <FormListItem
          titleText="휴대폰번호"
          target="#layerMyLoanDesignationDriverAddPhone"
        >
            ...
            <InputBlock :error="state.phoneError">
              <InputBlockCell :flexible="true">
                <BasicInput
                  ...
                  pattern="\d*"
                  title="휴대폰번호"
                  id="layerMyLoanDesignationDriverAddPhone"
                />
              </InputBlockCell>
            </InputBlock>
            <FormInvalidMessage>Error Message</FormInvalidMessage>
      ...
      <template v-slot:foot>
        ...
        >
          ...
          <ButtonListItem>
            <BasicButton :minSide="true">지정운전자 등록요청</BasicButton>
          </ButtonListItem>
        </ButtonList>
      </template>
    </FullPopup>
