  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>자동차할부금융 설명서</PopupTitle>
      ...
      <div>
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <span class="color-green"
                    >금융회사와 소비자의 대출 약정 체결(2자 거래)로 이루어지는
                    오토론과는 달리</span
                  >, 소비자-금융사-물품판매자 간의
                  <span class="color-green underline"
                    >3자계약에 따라 금융회사는 소비자를 대신하여 물품판매자에게
                    대출금을 지급하고, 소비자는 할부상품의 소유권을 취득</span
                  >하게 되는 상품입니다. (☞
                  <span class="color-red underline">‘1. 상품 개요 및 특성’</span
                  >확인)
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div class="row-margin-mini">
                    일반적인 대출(신용대출, 오토론 등)과 달리 할부금융은 대출
                    실행 후 3년이 경과해도 중도상환수수료가 부과되며,
                    금융소비자보호법 상 청약철회권의 행사가 제약*되오니 확인하여
                    주시기 바랍니다. (☞
                    <span class="color-red underline"
                      >‘4. 수수료 등 비용부담’, ‘10. 해지에 관한 사항‘, ‘13.
                      청약의 철회(청약철회권) 및 항변권’</span
                    >확인)
                  </div>
              ...
              <ul :class="$style['manual-qna__list']">
                      ...
                      <div :class="$style['manual-qna__text']">
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            <div :class="$style['basic-list__symbol']">*</div>
                            <div :class="$style['basic-list__content']">
                              예) 1천만원을 중도상환(적용요율 2%)할 경우, 고객은
                              최대 20만원의 중도상환수수료를 금융회사에 납부해야
                              함
                            </div>
                          </li>
                        </ul>
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        할부계약을 체결하는 경우
                        <span class="color-green underline"
                          >고객이 부담하여야 하는 총 금액에는 원리금, 수수료
                          등이 포함</span
                        >됩니다.
                        <span class="color-red underline"
                          >상세한 금액의 합계는 대출심사 후에 확인 가능</span
                        >하므로, 심사 후 담당자가 안내드리도록 하겠습니다. (☞
                ...
                <li :class="$style['manual-qna__item']">
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        고객은 약정한 대출 상환기한까지는 대출금을 상환하지
                        않아도 되므로, 그 기간 동안 고객이 가지는 이익을
                        <span class="color-red underline">‘기한의 이익’</span
                        >이라고 합니다. 이러한
                        <span class="color-green"
                          >기한의 이익이 상실되면, 고객은 </span
                        ><span class="color-red underline"
                          >모든 할부금을 즉시 상환</span
                        >하셔야 되고,
                        <span class="color-red underline"
                          >연체이자 부담 및 일정기간 경과 후 신용도판단정보 등록
                          등</span
                        >
                        불이익이 발생할 수 있습니다. (☞
                        <span class="color-red"
                          >‘7. 대출기한 전 채무 상환이 필요한 경우’</span
                        >확인)
                      </div>
                    </div>
                  </div>
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <div>
                          <span class="color-red underline"
                            >할부금 연체 시에는 법에서 정하는 범위 내에서 약정에
                            따라 정한 지연배상금율에 의한 지연배상금*을
                            지불</span
                          >하셔야 하며,
                          <span class="color-green underline"
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            <div :class="$style['basic-list__symbol']">*</div>
                            <div :class="$style['basic-list__content']">
                              예) 지연배상금율= 약정이자율(무이자 상품의 경우
                              상사법정이율(6%) 적용) + 연체가산이자율 3%
                            </div>
                          </li>
                        </ul>
                      </div>
        ...
        <section class="row-margin-container-medium">
          ...
          <div :class="$style['basic-table']">
            <table>
              ...
              <tbody>
                <tr>
                  <th>상품명</th>
                  <td class="align-left">자동차 할부금융</td>
                </tr>
                <tr>
                  <th>적용금리</th>
          ...
          >
            본 할부금융상품은 자동차를 구매하고자 하는 개인, 개인사업자,
            법인고객을 대상으로 하는 상품입니다. 할부금과 금리 등은 내부 심사를
            거쳐 결정되므로, 정확한 수치는 심사 후 안내드리도록 하겠습니다. 매월
            동일한 원리금을 납부하시는 ‘원리금균등분할상환’ 방식만 가능합니다.
            상환방식에 따른 자세한 설명은 ‘5. 할부금 납입방법’을 확인하여 주시기
            바랍니다.
          </div>
          ...
          <section class="row-margin-contents">
            ...
            <div>
              <div :class="[$style['manual-image'], 'row-margin-item-group']">
                <img
            ...
            <div class="row-margin-contents">
              ...
              <p class="text-body-2 align-center">오토론 상품 거래절차</p>
            </div>
          </section>
        </section>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  실행될 때 금리가 한 번 결정되면,
                  <span class="color-green underline"
                    >‘약정기간 동안에 동일하게 적용되는 금리’
                  </span>
                  <span class="underline">입니다.</span>
                </div>
              </li>
              <li
                :class="[
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">※</div>
                      <div :class="$style['basic-list__content']">
                        개별 약정 내용에 따라 달라질 수 있으니 자세한 사항은
                        금융회사 담당자에게 문의하여 주시기 바랍니다.
                      </div>
                    </li>
                  </ul>
                </div>
        ...
        <section class="row-margin-container-medium">
          ...
          <NoticeText :classNames="{ wrap: 'color-red row-margin-contents' }">
            할부계약을 체결하는 경우 고객이 부담하여야 하는 총 금액에는 할부금융
            대출금액 및 이자액, 수수료 등이 포함됩니다. 상세한 금액의 합계는
            심사 후에 확인 가능하므로, 심사 후 담당자가 안내드리겠습니다.
          </NoticeText>
          ...
          <section>
            ...
            <p class="text-body-2">
              ...
              부담하는 금액으로,
              <span class="color-green"
                >할부금융상품은 3년을 초과하여 상환 시에도 부과</span
              >되며, 자세한 사항은 약정서 등을 참고하여 주시기 바랍니다.
            </p>
            ...
            <div :class="[$style['basic-table'], 'row-margin-item']">
              <table>
                ...
                <tbody>
                  <tr>
                    <th class="color-red">만기<br />1년 이상</th>
                    <td class="align-left color-red">
                      <div>
                        중도상환원금×1% + 중도상환원금<br />×(중도상환수수료율-1%)<br />
                        × 잔존기간* / (대출기간-30일)
                      </div>
                  ...
                  <tr>
                    <th class="color-red">만기<br />1년 미만</th>
                    <td class="align-left color-red">
                      <div>
                        중도상환원금 × (중도상환수수료율)<br />
                        × 잔존기간*/ (대출기간-30일)
            ...
            <ul :class="$style['basic-list']">
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  400일 경우 중도상환 수수료는?<br />
                  1천만원×1% + 1천만원×(2%-1%) × 400/(1,095-30일) = 137,558
                </div>
              </li>
            </ul>
          </section>
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">5. 할부금 납입방법</h3>

          <section class="row-margin-contents">
            <h4 class="text-body-2 row-margin-item-medium">할부금의 납입</h4>
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  고객님께서는 납입일을 정하여, 일정주기(매월 등)마다 할부금을
                  납입하셔야 합니다. 약정 시 자동이체를 선택하고 관련 정보 제공
                  시, 할부금은 은행 및 금융기관의 본인명의 계좌에서
                  자동이체됩니다.
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동이체로 할부금 납입 시, 납입일에 잔고부족 등의 이체불가
                  사유로 납입하실 금액 전부를 이체할 수 없는 경우에는 납입지정일
                  이후 회사가 정하는 출금일에 미납금액(지연배상금 포함)을
                  출금하여 할부금에 충당할 수 있습니다.
                  <span class="color-red"
                    >(고객이 지정한 납입일의 오전 10시 이전 청구되며, 금융기관
                    영업시간 내에 할부금 잔액이 있어야 함)</span
                  >
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  자동이체 계좌는 고객센터(1800-1110) 등을 통해 변경이
                  가능하지만, 자동이체일 4영업일 전까지 변경(금융기관 별
                  상이)하실 경우에는 당월적용이 가능하며, 그 이후에는 익월부터
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <th>원리금균등<br />분할상환</th>
                    <td>
                      <div class="underline">10,708,560원</div>
                    </td>
                    <td>
                      <div class="underline">
                        1회 ~ 36회<br />
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p class="row-margin-item-regular align-left">
                        대출원금과 이자의 합계를 매월 동일한 금액으로 갚아가는
                        방식<br />
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2">
            연체이자율은 [대출이자율(단, 무이자 상품의 경우 상사법정이율(6%)
            적용) + 연체가산이자율]로 적용되며,
            <span class="underline"
              >법정최고금리인 20% 이내로 적용됩니다.(연체가산이율은 연 3%)</span
            >
          ...
          <section class="row-margin-contents">
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <ul :class="[$style['basic-list'], 'row-margin-item']">
                    ...
                    >
                      <div :class="$style['basic-list__symbol']">-</div>
                      <div :class="$style['basic-list__content']">
                        이자를 납입하여야 할 날의 다음날부터 30일(기업인 경우
                        14일)까지는 내셔야 할 약정이자에 대해 연체이자가
                        적용되고, 30일(기업인 경우 14일)이 경과하면
                        기한이익상실로 인하여 대출원금에 연체이자율을 곱한 연체
                        이자를 내셔야 합니다.
                      </div>
                    </li>
                  </ul>
            ...
            <div class="row-margin-contents">
              ...
              >
                ...
                연체가산이자율 연 3%인 할부금융의 분할상환금(1백만원) 및
              ...
              <ul :class="$style['basic-list']">
                ...
                >
                  ...
                  <div :class="$style['basic-list__content']">
                    ...
                    단순하게 계산한 예시입니다. 연체이자는 대출조건, 이자일수
                    계산, 대출종류 등에 따라 달라질 수 있으며, 실제 납부금액은
                    연체이자에 약정이자 및 분할상환금을 포함하여 계산됩니다.
                  </div>
                </li>
              </ul>
              ...
              >
                ...
                >
                  <div :class="$style['basic-list__symbol']"></div>
                  <div :class="$style['basic-list__content']">
                    이자납입 연체로 인하여 대출잔액에 연체이자율이 적용되었을
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2">
            할부계약의 해지 시 중도상환수수료가 부과 될 수 있습니다. 다만
            <span class="color-green underline"
          ...
          <ul :class="[$style['basic-list'], 'row-margin-item']">
            ...
            >
              <div :class="$style['basic-list__symbol']">-</div>
              <div :class="$style['basic-list__content']">
                고객이 중도상환 등 해지를 요청할 경우, 고객센터<br />(1800-1110)를
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  일반금융소비자는 해당 계약을 위약금 수수료 부과 없이 해지할 수
                  있습니다.(다만 계약종료 시 행사 불가)
                </div>
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  <li
                    :class="[
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  사용에 의하여 그 가치가 현저히 감소될 우려가 있는 경우(자동차,
                  건설기계, 선박, 항공기 등)
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  시간이 지남으로써 다시 판매하기 어려울 정도로 재화 등의 가치가
                  현저히 낮아진 경우
                </div>
              </li>
              <li
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  복제할 수 있는 재화 등의 포장을 훼손한 경우(음반·비디오물 및
                  소프트웨어)
                </div>
              </li>
            </ul>
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">
            17. 자동차 대출 관련 사기 유의사항
          </h3>

          <p class="text-body-2">
            다음과 같이 <strong class="color-red">고수익</strong> 또는
            <strong class="color-red">취업</strong>
            을 약속하면서
          ...
          <ul class="reset-list row-margin-item">
            ...
            >
              ...
              <div>
                중고차 수출업자가 중고차를 구입해주면 해당 차량을 비싸게
                수출하여 수익을 배분하겠다고 하였으나, 중고차 수출업자가
                자동차만 받고 잠적
              </div>
            </li>
            <li
            ...
            >
              ...
              <div>
                운전기사로 채용할 예정인데 사업상 기사 명의로 자동차를 구매해야
                한다고 하여 자동차를 할부로 구매해 주었으나, 일자리와 차량 모두
                받지 못함
              </div>
            </li>
            <li
            ...
            >
              ...
              <div>
                중고차 제휴점 직원이 중고차를 할부로 구매하면 필요한 만큼 현금을
                융통해 주겠다고 하여 중고차를 할부로 구매했으나 현금 융통을
                해주지 않음
              </div>
            </li>
          </ul>
          ...
          <p class="text-body-2">
            <strong
              ...
              자동차 할부금융을 신청하시는 경우 자동차는 받지 못하고, 할부금융
              원리금만 떠안는 등
          ...
          >
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  <span class="underline"
                    >본 상품은 일반적인 대출상품과 달리 계약이 성립한 날로부터
                    3년 경과 후에도 해약금(중도상환수수료)가 발생</span
                  >합니다. 예를 들어 1천만원을 중도상환하시는
                  경우(중도상환수수료율 2%로 가정), 최대 20만원의
                  <strong class="font-weight-medium"
                    >중도상환수수료를 납부하셔야 할부상품 해지가 가능함을 알고
                    계십니까?</strong
                  >
                </div>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td></td>
                  <td class="align-left">
                    본인은 하나캐피탈과 할부계약을 체결함에 있어 금융회사 직원과
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription006_012.scss';
</style>
