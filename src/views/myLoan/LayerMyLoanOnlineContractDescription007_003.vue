      ...
      <div>
        <div class="text-body-2">
          ...
          <span class="color-red">
            ...
            중도상환수수료가 부과(물건 매입 시 규정손해배상금)</span
          >되니 확인해야 해요!
        </div>
        ...
        <section>
          <div class="color-gray-secondary text-body-4">규정손해배상금률</div>
          <ul :class="[$style['basic-list'], 'row-margin-mini']">
            <li
              :class="[
                $style['basic-list__item'],
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription007_003.scss';
</style>
