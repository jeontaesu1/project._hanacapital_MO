          ...
          <BasicBox theme="septenary" className="row-margin-item-group">
            <div :class="$style['agree-list']">
              <div :class="$style['agree-list__head']">
                ...
                >
                  <CheckBoxObject />
                  <CheckBoxLabelText>주문서</CheckBoxLabelText>
                </CheckBox>
          ...
          <BasicBox theme="septenary" className="row-margin-item-group">
            <div :class="$style['agree-list']">
              <div :class="$style['agree-list__head']">
                ...
                >
                  <CheckBoxObject />
                  <CheckBoxLabelText>리스계약확인서</CheckBoxLabelText>
                </CheckBox>
                <div :class="$style['agree-list__right']">
                  <button type="button" :class="$style['agree-list__link']">
                    <span :class="$style['agree-list__link-text']">
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractURLSelectDocument.scss';
</style>
