    ...
    <FullPopup>
      ...
      <div class="row-margin-container-medium">
        ...
        <BasicBox class="row-margin-item-group">
          <KeyValue>
            <KeyValueItem>
              <KeyValueTitle class="font-weight-regular">보증금</KeyValueTitle>
      ...
      <div>
        ...
        <p class="text-body-3">
          오토리스 차량의 승계 시 승계 수수료(인지세포함)가 부과되며 입금확인 시
          승계절차를 진행합니다.
        </p>
        <BasicBox class="row-margin-item-group">
          <KeyValue>
        ...
        <NoticeText
          >입금계좌 : 하나은행 “000-000000-00000”<br />예금주 :
          하나캐피탈㈜</NoticeText
        >
      </div>
      <div class="row-margin-container-medium">
        ...
        <NoticeText
          ...
          (증빙서류 : 이체확인증, 신분증, 통장사본)</NoticeText
        >
      </div>
