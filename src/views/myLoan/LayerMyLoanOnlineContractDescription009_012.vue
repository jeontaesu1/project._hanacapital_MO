      ...
      <div>
        <section>
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  리스는 시설을 대여해주는 회사(리스사)가 고객이 선택한
                  물건(자동차, 기계설비 등)을 구매하고, 고객에게 그 물건을
                  사용할 수 있도록 하는 거래입니다. 리스의 종류는 크게
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    금융리스는 물건의 소유에 따른 위험과 보상의 대부분이
                    고객에게 이전되는 리스입니다. 본질적 기능은 고객에게 물건
                    취득자금에 대한 금융 편의를 제공하는 데에 있기 때문에,
                    <span class="color-green underline"
                      >원칙적으로 반납이 불가합니다.(운용리스의 경우 반납이
                      원칙)</span
                    >
                  </div>
                      ...
                      <div :class="$style['basic-list__content']">
                        <span class="color-green"
                          ...
                          <span class="underline"
                            >운용리스는 리스료 비용처리</span
                          ></span
                        >가 가능하지만(법인세법에서 정한 범위 내),
                        <span class="color-green"
                          ><span class="underline"
                            >금융리스는 이자, 감가상각비의 비용처리</span
                          >가 가능합니다.</span
                        >
                      </div>
                    </li>
          ...
          <section class="row-margin-contents">
            ...
            <div :class="[$style['manual-qna'], 'row-margin-contents']">
                  ...
                  <div :class="$style['manual-qna__head']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <h5 :class="$style['manual-qna__title']">
                        리스를 이용할 때 발생하는 비용에는 어떤 것들이 있나요?
                      </h5>
                    </div>
                  </div>
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        리스 이용 시, 고객이 부담해야 하는 금액에는 리스료와
                        수수료 등이 포함됩니다.(심사 후 정확한 금액 파악 가능)
                        또한 시설물의 구입, 인도, 유지, 사용, 등록말소, 폐기
                        등과 관련하여 고객이 부담하여야 할 비용 중
                        <span class="color-green underline"
                          >리스료에 포함되지 않은 비용과 제세공과금(과태료,
                          벌과금 포함)은 고객이 부담</span
                        >합니다. (☞
                        <span class="color-red underline"
                          >‘4. 수수료 등 비용부담’</span
                        >
                  ...
                  <div :class="$style['manual-qna__contents']">
                    ...
                    <div :class="$style['manual-qna__cell']">
                      <div :class="$style['manual-qna__text']">
                        <div>
                          <span class="color-red underline"
                            >연체 시에는 법에서 정하는 범위 내에서
                            지연배상금율에 의한 지연배상금*을 납부하셔야</span
                          >
                          하며,
                          <span class="color-green underline"
                        ...
                        <ul :class="[$style['basic-list'], 'row-margin-item']">
                          ...
                          >
                            <div :class="$style['basic-list__symbol']">*</div>
                            <div :class="$style['basic-list__content']">
                              지연배상금 산식 : 월분할상환 원리금(리스료) ×
                              지연배상금율 × 연체일수/365<br />
                              예) 리스료 100만원을 10일 연체(기존 약정금리 7%
                              가정) 시, 최대 2,739원의 지연배상금 납부
                            </div>
                          </li>
                        </ul>
                      </div>
        ...
        <section class="row-margin-container-medium">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-left">
                    <div>1회 ~ 24회</div>
                    <div class="row-margin-item-regular">1,225,000 원</div>
                  </td>
                </tr>
                <tr>
                  <th>연체이자율</th>
                ...
                <tr>
                  <td :class="[$style['basic-table__left-line'], 'align-left']">
                    110%
                  </td>
                </tr>
                <tr>
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']"></div>
              <div :class="$style['basic-list__content']">
                리스료는 리스물건의 취득비용, 잔존가치 및 리스기간 등을 고려하여
                산정됩니다. 리스료는 리스이용금액에서 리스 보증금을 차감하지
                않고 산정되나, 리스보증금을 납부할 경우 약정에 따라 리스료가
                인하 가능합니다.
              </div>
            </li>
            <li
              ...
              <div :class="$style['basic-list__content']">
                ...
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  ...
                  >
                    <div :class="$style['basic-list__symbol']">-</div>
                    <div :class="$style['basic-list__content']">
                      취득원가 : 리스자산 취득 후 리스실행에 필요한 총금액을
                      말하며 리스실행 시 총원금에 해당합니다.
                      (시설대여(리스)계약서 제3조[취득원가] 참조)
                    </div>
                  </li>
                  <li
                    :class="[
            ...
            >
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  <strong class="font-weight-medium"
                    >이외에는 대출만기일까지 동일하게 적용됩니다.</strong
                  >
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  ...
                  당시의 원가요소와 마진을 기준으로 대출금리가 변경될 수
                  있습니다.
                </div>
              </li>
            </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          <section>
            <h4 class="text-body-2 row-margin-item-medium">규정손해배상금</h4>
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  중도해지를 <span class="color-green">이유로</span> 물건을
                  매입하고자 할 경우, 법령이 허용하는 한도 내에서 금융회사에
          ...
          <section class="row-margin-contents">
            <h4 class="text-body-2 row-margin-item-medium">승계수수료</h4>
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  시설리스 계약상의 권리와 의무를 제3자에게 승계할 수 있습니다.
                  금융회사는 심사기준에 따라 승인하며, 승계 수수료를 고객에게
                  부과할 수 있습니다.
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  <div>
                    상품에 따라 수수료는 상이할 수 있어 진행 전 상품담당자에게
                    확인바랍니다.
                  </div>
                    ...
                    >
                      ...
                      <div :class="$style['basic-list__content']">
                        <p class="row-margin-item">
                          승계수수료 = 미회수원금 X 최고요율(<span
                            :class="[
                              $style['blank-box'],
                              $style['blank-box--small'],
                            ]"
                          ></span>
                          %) X (잔여기간 월수/리스기간 전체 월수)
                        </p>
                        <p
                          class="text-body-4 font-weight-light color-gray-tertiary"
                        >
                          (예시) 미회수원금 2천만원, 잔여기간월수 30개월인 경우
                          미회수원금 20,000,000원 X 최고요율 2% X (잔여기간월수
                          30 / 리스기간 전체월수 36) = 333,333원
                        </p>
                      </div>
                    </li>
                  </ul>
          ...
          <section class="row-margin-contents">
            ...
            <p class="text-body-2">
              인지세법에 의해 대출약정 체결 시 납부하는 세금으로 리스의 경우
              인지세는 10,000원으로, 리스사가 전액 부담합니다.
            </p>
          </section>
          ...
          <section>
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  물건의 근저당권 설정비용은 금융회사가 부담하고 해지비용은 리스
                  이용고객이 부담합니다.
                </div>
              </li>
            </ul>
            ...
            <ul :class="[$style['basic-list'], 'row-margin-item']">
              ...
              >
                <div :class="$style['basic-list__symbol']">※</div>
                <div :class="$style['basic-list__content']">
                  물건의 구입, 인도, 유지, 사용, 등록말소, 폐기 등과 관련하여
                  고객이 부담하여야 할 비용 중 리스료에 포함되지 않는 비용과
                  제세공과금(과태료, 벌과금 포함)은 고객이 부담합니다.
                </div>
              </li>
            </ul>
          </section>
        ...
        <section class="row-margin-container-medium">
          <h3 class="text-title-2 row-margin-contents">5. 리스료 납입방법</h3>

          <section class="row-margin-contents">
            <h4 class="text-body-2 row-margin-item-medium">리스료 납입</h4>
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  고객님께서는 납입일을 정하여, 일정주기(매월 등) 마다 리스료를
                  납입하셔야 하며, 약정 시 자동이체를 선택하고 관련 정보를
                  제공하시면 리스료는 은행 및 금융기관의 본인명의 계좌에서
                  자동이체 됩니다.
                </div>
              </li>
              <li
              ...
              >
                ...
                <div :class="$style['basic-list__content']">
                  자동이체 계좌는
                  <strong class="font-weight-medium"
                    >하나캐피탈콜센터(1800-1110)</strong
                  >등을 통해 변경이 가능하지만, 자동이체일 4일 전
        ...
        <section class="row-margin-container-medium">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']"></div>
              <div :class="$style['basic-list__content']">
                지연배상금률은 무이자[상거래기본이자율(6%)+연체가산이자율] ,
                유이자[대출이자율+연체가산이자율]로 적용되며, 법정최고금리인 20%
                이내로 적용됩니다.<span class="color-red"
                  >(연체가산이자율 : 연 3%)</span
                >
              </div>
            </li>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                >
                  지연배상금 산식 : 월분할상환 원리금 x 지연배상금률 x
                  연체일수/365(윤년은 366)<br />
                  예) 리스료 100만원, 10일 연체(기존 약정금리 7% 가정)시 :
                  100만원 x 10%(연체이자율*) x 10/365 = 2,739원
                </p>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="underline">
                  ...
                  상환하지 아니한 때 등 (여신거래기본약관 제8조 제2항, 제3항,
                  제4항에서 정한 사유)
                </div>
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  <li
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2">
            리스계약의 해지 시
            <span class="color-green-secondary">규정손실금</span>이 부과 될 수
            있습니다. 다만
            <span class="color-green"
              >리스상품은 계약이 성립한 날부터 3년 초과하여 상환하여도 </span
            ><span class="color-green-secondary">규정손실금</span>이
            <span class="color-green">부과되니 유의</span>하여 주시기 바랍니다.
          </p>
          ...
          <ul :class="[$style['basic-list'], 'row-margin-item']">
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                통하여 진행가능 합니다.(금융사 영업시간내에 처리 가능).
                금융회사는 고객에게 규정손실금 등 해지 시 납부해야 하는 금액을
                안내하고 입금계좌를 발송합니다. (납부 시 해지 처리 진행)
              </div>
            </li>
            <li
              :class="[
            ...
            >
              <div :class="$style['basic-list__symbol']">-</div>
              <div :class="$style['basic-list__content']">
                기한이익의 상실로 인한 리스계약의 해지 발생 시 고객님께서
                납인하신 리스 보증금은 연체된 리스료에 상계 충당 될 수 있습니다.
              </div>
            </li>
            <li
              :class="[
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div>
                  ...
                  신용정보집중기관이 제3자에게 정보를 제공함으로써 신용정보
                  주체가 불이익을 받을 수 있으며, 개인신용평점이 하락하고 금리가
                  상승하는 등의 영향이 발생할 수 있습니다.
                </div>
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  <li
                    :class="[
        ...
        <section class="row-margin-container-medium">
          ...
          <p class="text-body-2 color-green">
            「금융소비자 보호에 관한 법률」 시행령 제37조제1항제3호제가목에
            의거하여, 리스(시설대여)는 같은 법에서 규정하는 청약철회권 대상
          ...
          >
                ...
                <ul :class="[$style['basic-list'], 'row-margin-item']">
                  ...
                  >
                    ...
                    <div :class="$style['basic-list__content']">
                      ...
                      내부 통제기준의 제정 및 운영 등에 관한 자료, 업무 위탁에
                      관한 자료
                    </div>
                  </li>
                </ul>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                ...
                열람의 범위가 기재된 열람요구서로 열람을 요구 받은 날로부터
          ...
          <section class="row-margin-contents">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  대출만기 시, 리스물건은 고객님께 무상 또는 유상 양도
                  됩니다.(단, 별도의 약정이 있는 경우 이에 따르기로 합니다)
                </div>
              </li>
              <li
                :class="[
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  리스물건의 등록명의가 이용자 명의일 경우, 리스물건을 반납할 때
                  명의이전서류를 반드시 제출하셔야 합니다.
                </div>
              </li>
              <li
                :class="[
              ...
              >
                <div :class="$style['basic-list__symbol']"></div>
                <div :class="$style['basic-list__content']">
                  위 사항과 관련하여 자세한 내용은 금융회사 담당자에게 문의하여
                  주시기 바랍니다.
                </div>
              </li>
            </ul>
        ...
        <section class="row-margin-container-medium">
          ...
          >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  <p class="row-margin-mini">
                    본 상품을 연체하셨을 때에는 법에서 정하는 범위 내에서
                    지연배상금*을 납부하셔야 합니다. 예를 들어 리스료 100만원을
                    10일 연체하셨을 경우(기존 약정금리 7%로 가정 시), 최대
                    2,739원의 지연배상금이 발생합니다.
                    <strong class="font-weight-medium"
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  본 상품은 일반적인 대출상품과 달리 계약이 성립한 날로부터 3년
                  경과 후에도 중도해지 수수료가 부과됩니다.
                  <strong class="font-weight-medium"
                    >이를 납부하셔야만 중도에 리스계약을 해지하실 수 있다는 점을
                    확인하셨습니까?</strong
                  >
                </div>
            ...
            >
              ...
              <div :class="$style['basic-list__content']">
                <div class="row-margin-item">
                  <p class="row-margin-mini">
                    본 상품은 일반적인 대출상품(신용대출, 오토론 등)과 달리
                    금융소비자보호법 상 청약철회권 대상*이 아닙니다. 재화를
                    제공받은 후에는 청약 철회가 불가능하기에 계약 체결에 신중을
                    기해주시기 바랍니다.<br />
                    <strong class="font-weight-medium"
                      >이 내용을 확인하셨습니까?</strong
                    >
...
@import '@/assets/scss/views/myLoan/LayerMyLoanOnlineContractDescription009_012.scss';
</style>
