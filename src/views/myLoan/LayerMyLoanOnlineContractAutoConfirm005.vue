  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        ...
        <StepProgress :total="8" :current="4" />
      </template>
      ...
      <div>
          ...
          <BasicBox>
            <KeyValue margin="regular">
              ...
              >
                ...
                <KeyValueText>2023.02.05</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
        ...
        <section class="row-margin-container-medium">
          ...
          <BasicBox>
            ...
            <KeyValue>
              ...
              >
                <KeyValueTitle>판매사(매도인)</KeyValueTitle>
                <KeyValueText>현대자동차㈜송파지점</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>등록명의</KeyValueTitle>
                <KeyValueText>금융회사</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
        ...
        <section class="row-margin-container-medium">
          ...
          <BasicBox>
            <BasicBoxHead>
              <BasicBoxHeadLeft>
                <div class="text-body-4 row-margin-small font-weight-light">
                  2023.01.10
                </div>
                <h3 class="font-weight-medium text-body-1">금융리스</h3>
              </BasicBoxHeadLeft>
            </BasicBoxHead>
            <KeyValue margin="regular">
              <KeyValueItem
              ...
              >
                ...
                <KeyValueText>36 개월</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>17,800,000 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                ...
                <KeyValueText>8,722,000 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>선납금 / 선납리스료</KeyValueTitle>
              ...
              >
                <KeyValueTitle>리스료(A+B+C+D+E)</KeyValueTitle>
                <KeyValueText>365,700 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>리스료/차량분(A)</KeyValueTitle>
                <KeyValueText>365,700 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
              ...
              >
                <KeyValueTitle>선납리스료(B)</KeyValueTitle>
                <KeyValueText>0 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
              ...
              >
                <KeyValueTitle>자동차세(C)</KeyValueTitle>
                <KeyValueText>0 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
              ...
              >
                <KeyValueTitle>보험료(D)</KeyValueTitle>
                <KeyValueText>0 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
              ...
              >
                <KeyValueTitle>기타비용(E)</KeyValueTitle>
                <KeyValueText>0 원</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
              ...
              >
                ...
                <KeyValueText>20,000 km</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>Km당 초과운행료</KeyValueTitle>
                <KeyValueText>
                  국산차 : 100원<br />
                  수입차 : 300원
                </KeyValueText>
              ...
              >
                <KeyValueTitle>자동자체 포함여부</KeyValueTitle>
                <KeyValueText>불포함</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
                  item: 'text-body-3',
              ...
              >
                <KeyValueTitle>보험료 포함여부</KeyValueTitle>
                <KeyValueText>불포함</KeyValueText>
              </KeyValueItem>
              <KeyValueItem
                :classNames="{
              ...
              >
                <KeyValueTitle>교통범칙금</KeyValueTitle>
                <KeyValueText>대납</KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
        </section>
        ...
        <section class="row-margin-container-medium">
          ...
          <div>
            ...
            <p class="text-body-2 row-margin-mini">미회수원금X최고요율(4%)</p>
          ...
          <div>
            ...
            <p class="text-body-2 row-margin-mini">연 6.9%</p>
            <p class="text-body-4 font-weight-light color-gray-tertiary">
              약정이자율+최대3%, 법정최고금리 이내
            </p>
          </div>
