  ...
  <UiLayer ref="layer" type="toast" :backgroundClose="true">
    <ToastPopup>
      <template v-slot:head>
        <ToastPopupHead>
          <PopupTitle>신용카드 인증 이용약관 동의</PopupTitle>
        </ToastPopupHead>
      </template>
        ...
        <UiAccordion :classNames="{ wrap: $style['agree-list__container'] }">
          ...
          >
            <div :class="$style['agree-list__all-head']">
              <CheckBox
                id="layerIdentificationCardAgreeAll"
                ...
                <ul :class="$style['agree-list__list']">
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationCardAgree_001"
                        :classNames="{
                      ...
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >카드사 서비스 이용약관</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationCardAgree_002"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >본인확인 서비스 이용약관</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationCardAgree_003"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationCardAgree_004"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
...
@import '@/assets/scss/views/identification/LayerIdentificationCardAgree.scss';
</style>
