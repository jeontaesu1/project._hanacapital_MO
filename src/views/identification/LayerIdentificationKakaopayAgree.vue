  ...
  <UiLayer ref="layer" type="toast" :backgroundClose="true">
    <ToastPopup>
      <template v-slot:head>
        <ToastPopupHead>
          <PopupTitle>간편인증 이용약관 동의</PopupTitle>
        </ToastPopupHead>
      </template>
        ...
        <UiAccordion :classNames="{ wrap: $style['agree-list__container'] }">
          ...
          >
            <div :class="$style['agree-list__all-head']">
              <CheckBox
                id="layerIdentificationKakaopayAgreeAll"
                ...
                <ul :class="$style['agree-list__list']">
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationKakaopayAgree_001"
                        :classNames="{
                      ...
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >간편인증통합중계 서비스 이용약관</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationKakaopayAgree_002"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >개인정보 수집 및 이용∙제공동의</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationKakaopayAgree_003"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >개인정보 제3자 정보제공 동의</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationKakaopayAgree_004"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >개인정보 취급 위탁 동의</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
...
@import '@/assets/scss/views/identification/LayerIdentificationKakaopayAgree.scss';
</style>
