...
<template>
  <UiLayer ref="layer" type="toast" :backgroundClose="true">
    <ToastPopup>
      ...
      <div :class="$style['ars']">
        <div :class="$style['ars__object']">
          <ImgArs />
        </div>
        <div :class="$style['ars__time']">남은 시간&nbsp;&nbsp;03:00</div>
      </div>
...
@import '@/assets/scss/views/identification/LayerIdentificationCardARS.scss';
</style>
