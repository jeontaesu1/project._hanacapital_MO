  ...
  <UiLayer ref="layer" type="toast">
    <ToastPopup>
      <template v-slot:head>
        <ToastPopupHead>
          <PopupTitle>휴대폰 인증 이용약관 동의</PopupTitle>
        </ToastPopupHead>
      </template>
        ...
        <UiAccordion :classNames="{ wrap: $style['agree-list__container'] }">
          ...
          >
            <div :class="$style['agree-list__all-head']">
              <CheckBox
                id="layerIdentificationPhoneAgreeAll"
                ...
                <ul :class="$style['agree-list__list']">
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationPhoneAgree_001"
                        :classNames="{
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationPhoneAgree_002"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                      >
                        <CheckBoxObject />
                        <CheckBoxLabelText
                          >고유식별번호 처리 동의</CheckBoxLabelText
                        >
                      </CheckBox>
                      <div :class="$style['agree-list__right']">
                        <button
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationPhoneAgree_003"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
                  ...
                  <li :class="$style['agree-list__item']">
                    <div :class="$style['agree-list__head']">
                      <CheckBox
                        id="layerIdentificationPhoneAgree_004"
                        :classNames="{
                          wrap: $style['agree-list__checkbox'],
                        }"
                        theme="tertiary"
...
@import '@/assets/scss/views/identification/LayerIdentificationPhoneAgree.scss';
</style>
