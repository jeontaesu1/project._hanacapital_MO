    ...
    <ToastPopup>
      ...
      <PageTextGroup>
        ...
        <PageSubText>
          ...
          합니다)를 이용하기 위해, 다음과 같이 “위탁자”가 본인의 개인정보 취급을
          위탁하는 것에 동의합니다.
        </PageSubText>
      </PageTextGroup>
        ...
        <section class="row-margin-contents-group">
          ...
          >
            ...
            >
              <div :class="$style['basic-list__symbol']"></div>
              <div :class="$style['basic-list__content']">
                카카오인증서 간편인증서비스의 중계 운영, 제공 대행을 위한
                조회·이용, 민원·분쟁 처리
              </div>
            </li>
            <li
...
@import '@/assets/scss/views/identification/Common_M00_l053.scss';
</style>
