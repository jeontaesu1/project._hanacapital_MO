    ...
    <FullPopup>
      ...
      <div :class="$style['agree-list']">
        <BoxCheck
          :contents="true"
          type="checkbox"
          id="LayerSettingResetFingerprintAgree001"
        >
          <template v-slot:left>
            <BoxCheckObject />
          </template>
          <BoxCheckLabel>바이오 인증 서비스 약관 동의</BoxCheckLabel>
        </BoxCheck>
      </div>
      ...
      <div :class="$style['agree-list__all-contents']">
        <div :class="$style['agree-list__head']">
          <CheckBox
            id="LayerSettingResetFingerprintAgree002"
            :classNames="{
      ...
      <template v-slot:foot>
        ...
        >
          <!-- Case : 재등록 동의 전 -->
          <ButtonListItem>
            <BasicButton disabled>지문인증 (재)등록</BasicButton>
          </ButtonListItem>
          <!-- //Case : 재등록 동의 전 -->

          <!-- Case : 재등록 동의 후 -->
          <ButtonListItem>
            <BasicButton>지문인증 (재)등록</BasicButton>
          </ButtonListItem>
          <!-- //Case : 재등록 동의 후 -->
        </ButtonList>
      </template>
...
@import '@/assets/scss/views/setting/LayerSettingResetFingerprintAgree.scss';
</style>
