  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        <FormListItem
          titleText="대출신청금액"
          target="#PF_M02_l007_inputAmount"
        >
        ...
        <FormListItem
          titleText="대출기간"
          target="#PF_M02_l007_inputPeriodButton"
          :selectOnly="true"
        >
            ...
            <InputBlock :error="state.periodError">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  ...
                  id="PF_M02_l007_inputPeriod"
                  buttonId="PF_M02_l007_inputPeriodButton"
                  defaultValue="3"
                />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem titleText="상환방법" :forceFocus="true">
          <BoxCheckList>
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="PF_M02_l007_input_check"
                id="PF_M02_l007_input_check001"
              >
...
@import '@/assets/scss/views/oneQ/PF_M02_l007.scss';
</style>
