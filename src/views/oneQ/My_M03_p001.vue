    ...
    <ul class="reset-list">
        ...
        <BasicBox>
          <BasicBoxHead>
            <BasicBoxHeadLeft>
              ...
              <h3
                class="text-body-1 font-weight-medium row-margin-small ellipsis"
              >
                e하나신용대출
              </h3>
            </BasicBoxHeadLeft>
          ...
          <ButtonList :classNames="{ wrap: 'row-margin-contents-small' }">
            <ButtonListItem>
              <BasicButton size="small">대출 신청하기</BasicButton>
            </ButtonListItem>
          </ButtonList>
        </BasicBox>
      </li>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          <ButtonList :classNames="{ wrap: 'row-margin-contents-small' }">
            <ButtonListItem>
              <BasicButton size="small">약정하기</BasicButton>
            </ButtonListItem>
          </ButtonList>
        </BasicBox>
      </li>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">계약이 접수되었습니다.</p>
          </div>
        </BasicBox>
      </li>
      <!-- // Case : 오토금융 - 접수 -->
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">
              심사가 완료되었습니다.<br />심사 결과는 전화로 안내드릴
              예정입니다.
            </p>
          </div>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">
              계약 체결을 위해 준비 중에 있습니다.<br />준비가 완료되는대로 계약
              진행 예정입니다.
            </p>
          </div>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">계약이 취소되었습니다.</p>
          </div>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">
              차량이 출고 중에 있습니다.<br />
              차량 출고 및 등록이 완료되는대로 고객님께 차량을 인도드릴
              예정입니다.
            </p>
          </div>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">계약이 완료되었습니다.</p>
          </div>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          >
            <p :class="$style['inline-alert__text']">처리중입니다.</p>
          </div>
      ...
      <li class="row-margin-item-group">
        <BasicBox>
          ...
          <ButtonList :classNames="{ wrap: 'row-margin-contents-small' }">
            <ButtonListItem>
              <BasicButton size="small" :minSide="true"
                >견적서 보기</BasicButton
              >
            </ButtonListItem>
            <ButtonListItem>
...
@import '@/assets/scss/views/oneQ/My_M03_p001.scss';
</style>
