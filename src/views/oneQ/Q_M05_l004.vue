  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
        ...
        <FormListItem titleText="소득구분" :forceFocus="true">
          <BoxCheckList>
            <BoxCheckListItem>
              <BoxCheck
                :minSide="true"
                name="Q_M05_l004_type"
                id="Q_M05_l004_type001"
                :defaultChecked="true"
              >
      ...
      <div class="row-margin-container-medium row-margin-bottom-none">
        <section>
          ...
          <FormList>
            <FormListItem
              titleText="직장명"
              target="#Q_M05_l004_workNameSearch"
            >
            ...
            <FormListItem
              titleText="입사일"
              target="#Q_M05_l004_joiningDateButton"
            >
              <FormInvalid :error="state.joiningDateError">
                <InputBlock :error="state.joiningDateError">
                  <InputBlockCell :flexible="true">
                    <BasicDatepicker
                      title="입사일"
                      id="Q_M05_l004_joiningDate"
                      buttonId="Q_M05_l004_joiningDateButton"
                    />
                  </InputBlockCell>
                </InputBlock>
                <FormInvalidMessage>Error Message</FormInvalidMessage>
            ...
            <FormListItem titleText="연소득" target="#Q_M05_l004_workIncome">
              <FormInvalid :error="state.workIncomeError">
                <InputBlock :error="state.workIncomeError">
                  <InputBlockCell :flexible="true">
                    <BasicInput
                      title="연소득"
                      id="Q_M05_l004_workIncome"
                      pattern="\d*"
                      :useDelete="false"
                      align="right"
                    />
      ...
      <div class="row-margin-contents row-margin-bottom-none">
        <FormList>
          <FormListItem titleText="상호명" target="#Q_M05_l004_buisnessName">
            <FormInvalid :error="state.buisnessNameError">
              <InputBlock :error="state.buisnessNameError">
                <InputBlockCell :flexible="true">
                  <BasicInput title="상호명" id="Q_M05_l004_buisnessName" />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
            </FormInvalid>
          ...
          <FormListItem
            titleText="사업자번호"
            target="#Q_M05_l004_buisnessLicense"
          >
          ...
          <FormListItem
            titleText="사업개시일"
            target="#Q_M05_l004_buisnessDateButton"
          >
            <FormInvalid :error="state.buisnessDateError">
              <InputBlock :error="state.buisnessDateError">
                <InputBlockCell :flexible="true">
                  <BasicDatepicker
                    title="사업개시일"
                    id="Q_M05_l004_buisnessDate"
                    buttonId="Q_M05_l004_buisnessDateButton"
                  />
                </InputBlockCell>
              </InputBlock>
              <FormInvalidMessage>Error Message</FormInvalidMessage>
          ...
          <FormListItem
            titleText="사업자주소"
            :forceFocus="true"
            target="#Q_M05_l004_buisnessAddressSearch"
          >
              ...
              <InputBlock :error="state.buisnessAddressError">
                ...
                <template v-slot:right>
                  <BasicButton
                    size="mini"
                    theme="tertiary"
                    id="Q_M05_l004_buisnessAddressSearch"
                    >검색</BasicButton
                  >
                </template>
              </InputBlock>
...
@import '@/assets/scss/views/oneQ/Q_M05_l004.scss';
</style>
