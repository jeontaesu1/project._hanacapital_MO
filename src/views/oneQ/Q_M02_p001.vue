    ...
    <UiTab>
      <StickyBar>
        <NavTab :useUiTab="true" :auto="true">
          <NavTabButton link="Q_M02_p001Tab001">상품안내</NavTabButton>
          <NavTabButton link="Q_M02_p001Tab002">진행절차</NavTabButton>
          <NavTabButton link="Q_M02_p001Tab003">유의사항</NavTabButton>
        </NavTab>
      </StickyBar>

      <!-- 상품안내 -->
      <UiTabPanel name="Q_M02_p001Tab001">
      ...
      <!-- 진행절차 -->
      <UiTabPanel name="Q_M02_p001Tab002">
      ...
      <!-- 유의사항 -->
      <UiTabPanel name="Q_M02_p001Tab003">
        <ul
          :class="[
            $style['basic-list'],
            $style['basic-list--regular'],
...
@import '@/assets/scss/views/oneQ/Q_M02_p001.scss';
</style>
