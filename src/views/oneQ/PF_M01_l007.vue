  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        <FormListItem
          titleText="대출신청금액"
          target="#PF_M01_l007_inputAmount"
        >
        ...
        <FormListItem
          titleText="대출기간"
          target="#PF_M01_l007_inputPeriodButton"
          :selectOnly="true"
        >
            ...
            <InputBlock :error="state.periodError">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  ...
                  id="PF_M01_l007_inputPeriod"
                  buttonId="PF_M01_l007_inputPeriodButton"
                  defaultValue="3"
                />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem
          titleText="상환방법"
          target="#PF_M01_l007_inputMethod"
          :disabled="true"
        >
...
@import '@/assets/scss/views/oneQ/PF_M01_l007.scss';
</style>
