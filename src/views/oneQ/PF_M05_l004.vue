  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        <FormListItem
          titleText="대출신청금액"
          target="#PF_M05_l004_inputAmount"
        >
        ...
        <FormListItem
          titleText="대출기간"
          target="#PF_M05_l004_inputPeriodButton"
          :selectOnly="true"
        >
            ...
            <InputBlock :error="state.periodError">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  ...
                  id="PF_M05_l004_inputPeriod"
                  buttonId="PF_M05_l004_inputPeriodButton"
                  defaultValue="3"
                />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem
          titleText="상환방법"
          target="#PF_M05_l004_inputMethod"
          :disabled="true"
        >
...
@import '@/assets/scss/views/oneQ/PF_M05_l004.scss';
</style>
