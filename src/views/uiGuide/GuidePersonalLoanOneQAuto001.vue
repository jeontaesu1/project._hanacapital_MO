...
import LayerPersonalLoanOneQAutoInfo from '@/views/personalLoan/LayerPersonalLoanOneQAutoInfo.vue';
import LayerPersonalLoanOneQAutoInput from '@/views/personalLoan/LayerPersonalLoanOneQAutoInput.vue';
...
export default {
  components: {
    ...
    LayerPersonalLoanOneQAutoInfo,
    LayerPersonalLoanOneQAutoInput,
  },
  setup() {
...
<template>
  <PageContents>
    ...
    >
      <ButtonListItem>
        <BasicButton @click="layer001Open">
          인증수단선택<br />PF_M04_b001
        </BasicButton>
      </ButtonListItem>
      <ButtonListItem>
        <BasicButton @click="layer002Open">
          한도조회 동의<br />PF_M04_l001
        </BasicButton>
      </ButtonListItem>
      <ButtonListItem>
        <BasicButton @click="layer003Open">
          대출가능 차량<br />PF_M04_b002
        </BasicButton>
      </ButtonListItem>
      <ButtonListItem>
        <BasicButton @click="layer004Open">
          한도조회 결과<br />PF_M04_l003
        </BasicButton>
      </ButtonListItem>
      <ButtonListItem>
        <BasicButton @click="layer005Open">
          대환상품 유의사항<br />PF_M04_b003
        </BasicButton>
      </ButtonListItem>
      <ButtonListItem>
        <BasicButton @click="layer006Open">
          신청 정보 입력<br />PF_M04_l004
        </BasicButton>
      </ButtonListItem>
    </ButtonList>
    ...
    <LayerPersonalLoanOneQAutoInfo ref="layer005" />
    <LayerPersonalLoanOneQAutoInput ref="layer006" />
  </PageContents>
</template>
