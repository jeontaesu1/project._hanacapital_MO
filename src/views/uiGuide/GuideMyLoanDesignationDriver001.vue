...
import LayerMyLoanDesignationDriverLMS from '@/views/myLoan/LayerMyLoanDesignationDriverLMS.vue';
...
export default {
  components: {
    ...
    LayerMyLoanDesignationDriverLMS,
...
<template>
  <PageContents>
    ...
    <LayerMyLoanDesignationDriverLMS ref="layer004" />
