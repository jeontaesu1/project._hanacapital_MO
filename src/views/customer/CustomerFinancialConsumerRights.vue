...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      store.ui.header.setTitle(() => '금융소비자권리');
    ...
    <ul :class="[$style['logs'], $style['logs--margin-regular']]">
        ...
        >
          <div :class="$style['logs__row']">
            <div :class="$style['logs__contents']">
              <h3 class="text-body-1 font-weight-medium">금리인하요구권</h3>
            </div>
      ...
      <li :class="$style['logs__item']">
        ...
        >
          <div :class="$style['logs__row']">
            <div :class="$style['logs__contents']">
              <h3 class="text-body-1 font-weight-medium">청약철회권</h3>
            </div>
            <div :class="$style['logs__right']">
              <RouterLink
      ...
      <li :class="$style['logs__item']">
        ...
        >
          <div :class="$style['logs__row']">
            <div :class="$style['logs__contents']">
              <h3 class="text-body-1 font-weight-medium">자료열람요구권</h3>
            </div>
            <div :class="$style['logs__right']">
              <RouterLink
                to="/customer/financial-consumer-protection-request-data"
                :class="$style['logs__link']"
              >
                <span :class="$style['logs__link-text']">상세보기</span>
              </RouterLink>
      ...
      <li :class="$style['logs__item']">
        ...
        >
          <div :class="$style['logs__row']">
            <div :class="$style['logs__contents']">
              <h3 class="text-body-1 font-weight-medium">위법계약해지권</h3>
            </div>
            <div :class="$style['logs__right']">
              <RouterLink
                to="/customer/financial-consumer-protection-terminate-illegal-contract"
                :class="$style['logs__link']"
              >
                <span :class="$style['logs__link-text']">상세보기</span>
              </RouterLink>
