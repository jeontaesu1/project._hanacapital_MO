...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      store.ui.header.setTitle(() => '금융소비자보호공시');
  ...
  <PageContents>
    <div :class="$style['board-detail']">
      <div :class="$style['board-detail__head']">
        <h2 :class="$style['board-detail__title']">건강한금융 금융생활정보</h2>
    ...
    <ButtonList align="full">
      ...
      <!-- Case : 버튼 텍스트 컬러 타입 #00A69E  -->
      <ButtonListItem>
        <BasicButton :line="true" theme="quaternary-green">버튼</BasicButton>
      </ButtonListItem>
      <!-- Case : 버튼 텍스트 컬러 타입 #00A69E  -->

      <!-- Case : 버튼 텍스트 컬러 타입 #3A81E0  -->
      <ButtonListItem>
        <BasicButton :line="true" theme="quaternary-blue">버튼</BasicButton>
      </ButtonListItem>
      <!-- // Case : 버튼 텍스트 컬러 타입 #3A81E0  -->
      ...
      <!-- Case : 버튼 텍스트 컬러 타입 #143B75  -->
      <ButtonListItem>
        <BasicButton :line="true" theme="quaternary-navy">버튼</BasicButton>
      </ButtonListItem>
      <!-- // Case : 버튼 텍스트 컬러 타입 #143B75  -->
    </ButtonList>
...
@import '@/assets/scss/views/customer/CustomerFinancialConsumerProtectionNoticeView.scss';
</style>
