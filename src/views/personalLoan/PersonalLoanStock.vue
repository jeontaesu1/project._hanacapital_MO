...
<template>
  <PageContents>
          ...
          <ul :class="$style['product-detail__list']">
            ...
            <li :class="$style['product-detail__item']">
              ...
              <div :class="$style['product-detail__block']">
                ...
                <div :class="$style['product-detail__desc']">12개월</div>
              </div>
            </li>
            <li :class="$style['product-detail__item']">
              <div :class="$style['product-detail__icon']">
    ...
    <UiTab>
      <div :class="$style['tab__inner']">
        <StickyBar>
          <NavTab :useUiTab="true" :auto="true">
            <NavTabButton link="PersonalLoanStockTab001_001"
              >상품안내</NavTabButton
            >
            <NavTabButton link="PersonalLoanStockTab001_002"
              >진행절차</NavTabButton
            >
            <NavTabButton link="PersonalLoanStockTab001_003"
              >유의사항</NavTabButton
            >
          </NavTab>
        </StickyBar>
      ...
      <UiTabPanel name="PersonalLoanStockTab001_001">
        <BasicBox theme="tertiary">
          <KeyValueList align="left" margin="regular">
            ...
            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              ...
              <KeyValueText> 연 10.9%</KeyValueText>
            </KeyValueItem>

            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              <KeyValueTitle>기간</KeyValueTitle>
              <KeyValueText> 12개월(최대 5년)</KeyValueText>
            </KeyValueItem>
          </KeyValueList>
        </BasicBox>
        <KeyValueList
      ...
      <UiTabPanel name="PersonalLoanStockTab001_002">
      ...
      <UiTabPanel name="PersonalLoanStockTab001_003">
    ...
    <ul :class="[$style['basic-list'], $style['margin-top-regular']]">
      ...
      <li :class="$style['basic-list__item']">
        <div :class="$style['basic-list__symbol']"></div>
        <div :class="$style['basic-list__content']">
          여신금융협회 심의필 제2022-L1h-01579호<br />
