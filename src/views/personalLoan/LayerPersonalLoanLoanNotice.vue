...
<template>
  <UiLayer ref="layer" type="toast">
    <ToastPopup>
      ...
      <PopupText>
        <ol :class="[$style['basic-list'], $style['basic-list--regular']]">
          <li
            :class="[
          ...
          >
            ...
            <div :class="$style['basic-list__content']">
              사업자대출은 고객님 명의로 개인사업자를 운영하시고, 대출금을
              사업자 운영자금 목적으로 사용하시는 경우 가능합니다.(대출금액 1억
              이하 시 별도 자금용도 증빙은 하지 않습니다.)
            </div>
          </li>
          <li
            :class="[
...
@import '@/assets/scss/views/personalLoan/LayerPersonalLoanLoanNotice.scss';
</style>
