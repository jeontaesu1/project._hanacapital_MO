  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        <FormListItem
          titleText="대출신청금액"
          target="#layerPersonalLoanBestCustomerInputAmount"
        >
            ...
            <InputBlock :error="state.amountError">
              <InputBlockCell :flexible="true">
                <BasicInput
                  ...
                  pattern="\d*"
                  title="대출신청금액"
                  id="layerPersonalLoanBestCustomerInputAmount"
                />
              </InputBlockCell>
        ...
        <FormListItem
          titleText="대출기간"
          target="#layerPersonalLoanBestCustomerInputPeriodButton"
          :selectOnly="true"
        >
            ...
            <InputBlock :error="state.periodError">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  ...
                  id="layerPersonalLoanBestCustomerInputPeriod"
                  buttonId="layerPersonalLoanBestCustomerInputPeriodButton"
                  defaultValue="3"
                />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem
          titleText="상환방법"
          target="#layerPersonalLoanBestCustomerInputMethod"
          :disabled="true"
        >
          <FormInvalid :error="state.methodError">
            <InputBlock :error="state.methodError" :disabled="true">
              <InputBlockCell :flexible="true">
                <BasicInput
                  title="상환방법"
                  id="layerPersonalLoanBestCustomerInputMethod"
...
@import '@/assets/scss/views/personalLoan/LayerPersonalLoanBestCustomerInput.scss';
</style>
