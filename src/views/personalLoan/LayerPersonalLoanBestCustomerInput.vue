  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        <FormListItem
          titleText="대출신청금액"
          target="#LayerPersonalLoanOneQAutoInputAmount"
        >
            ...
            <InputBlock :error="state.amountError">
              <InputBlockCell :flexible="true">
                <BasicInput
                  :useDelete="false"
                  align="right"
                  id="LayerPersonalLoanOneQAutoInputAmount"
                />
              </InputBlockCell>
        ...
        <FormListItem
          titleText="대출기간"
          target="#LayerPersonalLoanBestCustomerInputPeriod"
        >
            ...
            <InputBlock :error="state.periodError">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  ...
                  buttonId="LayerPersonalLoanBestCustomerInputPeriod"
                />
              </InputBlockCell>
            </InputBlock>
            <FormInvalidMessage>Error Message</FormInvalidMessage>
