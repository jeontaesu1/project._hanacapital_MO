...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      store.ui.header.setTitle(() => '내구소비재할부');
    ...
    >
      <StickyBar>
        <NavTab :useUiTab="true" :auto="true">
          <NavTabButton link="personalLoanConsumerDurablesTab001"
            >상품안내</NavTabButton
          >
          <NavTabButton link="personalLoanConsumerDurablesTab002"
            >진행절차</NavTabButton
          >
          <NavTabButton link="personalLoanConsumerDurablesTab003"
            >유의사항</NavTabButton
          >
        </NavTab>
      </StickyBar>
      ...
      <!-- 상품안내 -->
      <UiTabPanel name="personalLoanConsumerDurablesTab001">
        <BasicBox theme="tertiary">
          <KeyValue align="left" margin="regular">
            ...
            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              ...
              <KeyValueText>품목별 구매금액 범위 이내</KeyValueText>
            </KeyValueItem>

            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              <KeyValueTitle>금리</KeyValueTitle>
              <KeyValueText>0.0 ~ 16.0%</KeyValueText>
            </KeyValueItem>

            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              <KeyValueTitle>기간</KeyValueTitle>
              <KeyValueText>3개월 ~ 36개월</KeyValueText>
            </KeyValueItem>
          </KeyValue>
        </BasicBox>
              ...
              <ul :class="[$style['basic-list'], 'row-margin-item']">
                ...
                >
                  ...
                  <div :class="$style['basic-list__content']">
                    만기 1년 이상<br />
                    : 중도상환원금 X 1.00% + 중도상환원금 X (중도상환수수료율 -
                    1.00%) X 잔존기간/(대출기간 - 30일)
                  </div>
                </li>
                <li
                  :class="[
      ...
      <!-- 진행절차 -->
      <UiTabPanel name="personalLoanConsumerDurablesTab002">
            ...
            <li :class="$style['step__item']">
              <div :class="$style['step__inner']">
                <div :class="$style['step__contents']">
                  ...
                  <div :class="$style['step__text']">
                    물품 구입대금에 대한
                    <strong>할부금융 약정서를 작성</strong>하고, 물품을
                    인수받습니다.
                  </div>
                </div>
                <div :class="$style['step__icon']">
            ...
            <li :class="$style['step__item']">
              <div :class="$style['step__inner']">
                <div :class="$style['step__contents']">
                  ...
                  <div :class="$style['step__text']">
                    물품 구입대금을 <strong>손님 대신 일시에 지급</strong>하고,
                    손님 명의로 <strong>할부금융이 시작</strong>됩니다.
                  </div>
                </div>
                <div :class="$style['step__icon']">
                  <IconDeposit />
      ...
      <!-- 유의사항 -->
      <UiTabPanel name="personalLoanConsumerDurablesTab003">
      ...
      <ul :class="[$style['basic-list'], 'row-margin-contents']">
        ...
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            여심금융협회 심의필 제2023-C1h-11442호<br />
            (2023.10.16 ~ 2024.10.15)
          </div>
        </li>
      </ul>
...
@import '@/assets/scss/views/personalLoan/PersonalLoanConsumerDurables.scss';
</style>
