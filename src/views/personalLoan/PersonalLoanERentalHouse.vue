          ...
          <ul :class="$style['product-detail__list']">
            ...
            <li :class="$style['product-detail__item']">
              ...
              <div :class="$style['product-detail__block']">
                ...
                <div :class="$style['product-detail__desc']">연 8.2 ~ 9.3%</div>
              </div>
            </li>
            <li :class="$style['product-detail__item']">
              <div :class="$style['product-detail__icon']">
    ...
    <UiTab>
      <div :class="$style['tab__inner']">
        <StickyBar>
          <NavTab :useUiTab="true" :auto="true">
            <NavTabButton link="PersonalLoanERentalHouseTab001_001"
              >상품안내</NavTabButton
            >
            <NavTabButton link="PersonalLoanERentalHouseTab001_002"
              >진행절차</NavTabButton
            >
            <NavTabButton link="PersonalLoanERentalHouseTab001_003"
              >유의사항</NavTabButton
            >
          </NavTab>
        </StickyBar>
      ...
      <UiTabPanel name="PersonalLoanERentalHouseTab001_001">
        <BasicBox theme="tertiary">
          <KeyValueList align="left" margin="regular">
            ...
            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              ...
              <KeyValueText> 연 8.2% ~ 9.3%</KeyValueText>
            </KeyValueItem>
        ...
        >
          ...
          <KeyValueItem>
            <KeyValueTitle>제출서류</KeyValueTitle>
            <KeyValueText>
              <ul
                :class="[
                  $style['contents-list'],
              ...
              >
                ...
                <li :class="$style['contents-list__item']">
                  ...
                  >
                    금융거래확인서
                    <div :class="$style['sub']">대환대출 시</div>
                  </div>
                </li>
                <li :class="$style['contents-list__item']">
                  <div
      ...
      <UiTabPanel name="PersonalLoanERentalHouseTab001_003">
        <ul
          :class="[
            $style['basic-list'],
