  ...
  <PageContents>
    <div :class="$style['bg']">
      <PageTextGroup>
        <PageMainText>
          병/의원 및 의료법인대상<br />
          <strong>의료기기, 의료소모품 구입자금 대출</strong>
        </PageMainText>
      </PageTextGroup>
    ...
    >
      <StickyBar>
        <NavTab :useUiTab="true" :auto="true">
          <NavTabButton link="personalLoanMedicalAppliancesTab001"
            >상품안내</NavTabButton
          >
          <NavTabButton link="personalLoanMedicalAppliancesTab002"
            >진행절차</NavTabButton
          >
          <NavTabButton link="personalLoanMedicalAppliancesTab003"
            >유의사항</NavTabButton
          >
        </NavTab>
      </StickyBar>
      ...
      <UiTabPanel name="personalLoanMedicalAppliancesTab001">
        <BasicBox theme="tertiary">
          <KeyValue align="left" margin="regular">
            ...
            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              ...
              <KeyValueText>연 0.00% ~ 최고 8.50%</KeyValueText>
            </KeyValueItem>
        ...
        >
          <KeyValueItem>
            <KeyValueTitle>할부금</KeyValueTitle>
            <KeyValueText>구매금액</KeyValueText>
          </KeyValueItem>
      ...
      <!-- 진행절차 -->
      <UiTabPanel name="personalLoanMedicalAppliancesTab002">
              ...
              <div :class="$style['step__inner']">
                <div :class="$style['step__contents']">
                  ...
                  <div :class="$style['step__text']">
                    하나캐피탈 의료기할부 <strong>상담을 신청</strong>합니다.
                  </div>
                </div>
      ...
      <!-- 유의사항 -->
      <UiTabPanel name="personalLoanMedicalAppliancesTab003">
      ...
      <ul :class="[$style['basic-list'], 'row-margin-contents']">
        ...
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            여신금융협회 심의필 제2022-C1h-00749호<br />
...
@import '@/assets/scss/views/personalLoan/PersonalLoanMedicalAppliances.scss';
</style>
