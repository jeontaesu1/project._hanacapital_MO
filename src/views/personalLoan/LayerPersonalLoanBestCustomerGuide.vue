  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      <template v-slot:head>
        <FullPopupHead>
          <PopupTitle>우수고객추가대출</PopupTitle>
      ...
      <PageTextGroup>
        <PageMainText>
          <strong>하나캐피탈 우수고객 전용</strong><br />
          추가(신용)대출 금융서비스 입니다
        </PageMainText>
      </PageTextGroup>
      ...
      <UiTab>
        <StickyBar>
          <NavTab :useUiTab="true">
            <NavTabButton link="layerPersonalLoanBestCustomerGuideTab001">
              상품안내
            </NavTabButton>
            <NavTabButton link="layerPersonalLoanBestCustomerGuideTab002">
              유의사항
            </NavTabButton>
          </NavTab>
        </StickyBar>

        <UiTabPanel name="layerPersonalLoanBestCustomerGuideTab001">
        ...
        <UiTabPanel name="layerPersonalLoanBestCustomerGuideTab002">
          <ul
            :class="[
              $style['basic-list'],
...
@import '@/assets/scss/views/personalLoan/LayerPersonalLoanBestCustomerGuide.scss';
</style>
