  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList :classNames="{ wrap: 'row-margin-contents-group' }">
        ...
        <FormListItem
          titleText="대출기간"
          target="#layerPersonalLoanOneQAutoInputPeriodButton"
          :selectOnly="true"
        >
            ...
            <InputBlock :error="state.periodError">
              <InputBlockCell :flexible="true">
                <BasicSelect
                  ...
                  id="layerPersonalLoanOneQAutoInputPeriod"
                  buttonId="layerPersonalLoanOneQAutoInputPeriodButton"
                  defaultValue="3"
                />
              </InputBlockCell>
            </InputBlock>
        ...
        <FormListItem
          titleText="상환방법"
          target="#layerPersonalLoanOneQAutoInputMethod"
          :disabled="true"
        >
...
@import '@/assets/scss/views/personalLoan/LayerPersonalLoanOneQAutoInput.scss';
</style>
