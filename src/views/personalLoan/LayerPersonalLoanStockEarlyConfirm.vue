    ...
    <FullPopup>
      ...
      <BasicBox>
        <KeyValueList margin="regular">
          ...
          >
            <KeyValueTitle>이자금액</KeyValueTitle>
            <KeyValueText>18,870 원</KeyValueText>
          </KeyValueItem>
          ...
          >
            <KeyValueTitle>상환 후 잔액</KeyValueTitle>
            <KeyValueText>4,700,000 원</KeyValueText>
          </KeyValueItem>
      ...
      <ul :class="[$style['basic-list'], 'row-margin-contents']">
        <li :class="$style['basic-list__item']">
          ...
          <div :class="$style['basic-list__content']">
            환급금액 : 2016.3.3기준 금융위원회 대부업법 시행령 개정안을 기준으로
            모든 금융사가 수취할 수 있는 최고이자율 연 20%를 초과한 경우
            고객에게 돌려주어야 하는 금액
          </div>
        </li>
        <li :class="$style['basic-list__item']">
