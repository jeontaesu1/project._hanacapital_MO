          ...
          <div class="row-margin-item-medium">
            <FormList>
              <FormListItem
                ...
                target="#layerPersonalLoanETCApartmentCertifiedConfirmAmount"
              >
                <FormInvalid :error="state.amountError">
                  <InputBlock :error="state.amountError">
                    <InputBlockCell :flexible="true">
                      <BasicInput
                        id="layerPersonalLoanETCApartmentCertifiedConfirmAmount"
                        pattern="\d*"
                        title="부동산 설정금액 (선택)"
                        :useDelete="false"
                        align="right"
...
@import '@/assets/scss/views/personalLoan/LayerPersonalLoanETCApartmentCertifiedConfirm.scss';
</style>
