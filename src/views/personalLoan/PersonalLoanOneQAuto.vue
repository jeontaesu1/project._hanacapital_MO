...
import ImgOneQCarloan from '@/assets/images/contents/img-oneQ-carloan.svg?component';
    ...
    >
      <StickyBar>
        <NavTab :useUiTab="true" :auto="true">
          <NavTabButton link="personalLoanOneQAutoTab001"
            >상품안내</NavTabButton
          >
          <NavTabButton link="personalLoanOneQAutoTab002"
            >진행절차</NavTabButton
          >
          <NavTabButton link="personalLoanOneQAutoTab003"
            >유의사항</NavTabButton
          >
        </NavTab>
      </StickyBar>
      ...
      <!-- 상품안내 -->
      <UiTabPanel name="personalLoanOneQAutoTab001">
        <BasicBox theme="tertiary">
          <KeyValue align="left" margin="regular">
            ...
            <KeyValueItem :classNames="{ item: 'text-body-3' }">
              ...
              <KeyValueText>연 4.9% ~ 16.9%</KeyValueText>
            </KeyValueItem>
      ...
      <!-- 진행절차 -->
      <UiTabPanel name="personalLoanOneQAutoTab002">
      ...
      <!-- 유의사항 -->
      <UiTabPanel name="personalLoanOneQAutoTab003">
...
@import '@/assets/scss/views/personalLoan/PersonalLoanOneQAuto.scss';
</style>
