  ...
  <UiTab>
    <PageContents>
        ...
        <div>
            ...
            <section class="row-margin-contents">
              ...
              <ul :class="[$style['basic-list'], 'row-margin-item']">
                ...
                >
                  <div :class="$style['basic-list__symbol']">※</div>
                  <div :class="$style['basic-list__content']">
                    2021년 8월 11일 이 후 "최초 가입한"멤버십 회원에 한해 최초
                    1회 제공 (탈퇴 및 중복가입 시 제공 불가)
                  </div>
                </li>
                <li
                  :class="[
          ...
          <section class="row-margin-contents-group">
            ...
            >
              ...
              >
                <div :class="$style['basic-list__content']">
                  상기 서비스는 하나손해보험㈜ 제휴를 통해 제공해 드리는
                  무료보험 서비스로 보험약관 변경에 따라 서비스 내용이 변경 또는
                  종료될 수 있습니다.
                </div>
              </li>
            </ul>
        ...
        <div>
          <section class="row-margin-contents-group">
            ...
            <section class="row-margin-contents">
              ...
              <p class="text-body-2 font-weight-regular">
                매주 업데이트로 원하는 아파트/오피스텔 의 매매 또는 전세 시세
                확인 가능
              </p>
            </section>
          </section>
      ...
      <UiTabPanel name="MyInfoJoinMembershipTab006">
        <div :class="$style['row-margin-top-minus']">
          <section class="row-margin-contents-group">
            <div :class="$style['qna']">
              <UiAccordion :classNames="{ wrap: $style['qna__list'] }">
                <UiAccordionItem :classNames="{ item: $style['qna__item'] }">
                  ...
                  <UiAccordionLayer
                    :classNames="{ layer: $style['qna__layer'] }"
                  >
                    <div :class="$style['qna__contents']">
                      ...
                      <div :class="$style['qna__text']">
                        ...
                        홈페이지 및 모바일에서 멤버십 가입하기를 통해 가입하실
                        수 있습니다.
                      </div>
                    </div>
                  </UiAccordionLayer>
                ...
                <UiAccordionItem :classNames="{ item: $style['qna__item'] }">
                  ...
                  >
                    <div :class="$style['qna__contents']">
                      <div :class="$style['qna__symbol']">A</div>
                      <div :class="$style['qna__text']">
                        하나캐피탈 멤버십은 손님들께 전액 무료로 제공되는
                        서비스로 추가비용이 발생하지 않습니다.
                      </div>
                    </div>
                  </UiAccordionLayer>
                </UiAccordionItem>
