    ...
    <FullPopup>
      ...
      <PageTextGroup>
        <PageMainText>
          ...
          <strong>신용조회동의를 기다리는 중입니다</strong>
        </PageMainText>
      </PageTextGroup>
      ...
      <section class="row-margin-container-medium">
        ...
        <BasicBox :className="$style['box__link']">
          <BasicBoxHead>
            <BasicBoxHeadLeft>
              <h4 class="text-body-1 font-weight-medium">운용리스</h4>
            </BasicBoxHeadLeft>
            <BasicBoxHeadRight>
              <button type="button" :class="$style['detail__link']">
                <IconArrow />
              </button>
            </BasicBoxHeadRight>
          </BasicBoxHead>
...
@import '@/assets/scss/views/auto/LayerAutoSuccessionAssigneeWait.scss';
</style>
