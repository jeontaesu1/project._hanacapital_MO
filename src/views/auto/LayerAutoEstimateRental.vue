  ...
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <div :class="$style['contents']">
        <UiAccordion tagName="div" :classNames="{ wrap: $style['header'] }">
          ...
          <UiAccordionItem
            tagName="div"
            :classNames="{
              item: 'row-margin-item',
            }"
          >
            <div :class="$style['inner']">
              <div class="flex-box">
                <div class="flex-box__cell flex-1">
                  <UnitText rightUnit="원">30,324,230</UnitText>
                </div>
                <div class="flex-box__cell">
                  <div class="color-gray-secondary text-body-5">내역보기</div>
                </div>
                <div class="flex-box__cell flex-box__cell--mini">
                  <UiAccordionOpener
                    :classNames="{
                      button: $style['header__opener'],
                    }"
                  />
                </div>
              </div>
        ...
        <div>
          ...
          <div class="row-margin-contents">
            <h4
              class="text-body-5 color-gray-secondary font-weight-medium row-margin-item"
            >
              정비상품
            </h4>
