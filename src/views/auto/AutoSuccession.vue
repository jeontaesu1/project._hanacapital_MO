  ...
  <UiTab>
    <PageContents>
      <div :class="$style['bg']">
        <StickyBar>
          <NavTab>
            <NavTabButton link="companyHistoryTab001" :active="true"
              >리스승계</NavTabButton
            >
            <NavTabButton link="companyHistoryTab002">렌트승계</NavTabButton>
          </NavTab>
        </StickyBar>
        <PageTextGroup>
          <PageMainText>
          ...
          <ul class="reset-list row-margin-contents">
            <li class="row-margin-item-group">
              <BasicBox theme="duodenary">
                <div class="flex-box">
                  <div :class="[$style['icon-box'], 'flex-box__cell']">
                    <IconAssignment />
                  </div>
      ...
      <UiTabPanel name="personalLoanEHanaTab001">
              ...
              <ul :class="[$style['basic-list'], 'row-margin-item-group']">
                ...
                >
                  ...
                  <div :class="$style['basic-list__content']">
                    ...
                    <span class="color-green">자동차를 반환하고자</span> 할 때
        ...
        >
          ...
          <KeyValueItem :classNames="{ item: 'text-body-3' }">
            ...
            <KeyValueText>
              <div>[초과운행km-유예주행거리]Xkm당<br />초과운행부담금 부과</div>
              <div
                class="text-body-4 font-weight-light color-gray-tertiary row-margin-mini"
              >
                (국산차 100원/수입차 300원)
                ...
                <div :class="$style['step__contents']">
                  ...
                  <div :class="$style['step__text']">
                    <div class="row-margin-item-small">
                      승계 수수료 등 <strong>승계 비용을 입금</strong> 합니다.
                    </div>
                    <ul
                      :class="[
                        $style['basic-list'],
