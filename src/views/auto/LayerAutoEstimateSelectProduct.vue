          ...
          <BasicBox theme="senary">
            <KeyValue margin="regular">
              <KeyValueItem :classNames="{ item: 'text-body-3' }">
                ...
                <KeyValueText>
                  <div class="align-left color-black">
                    개인(사업자) 및 법인사업자
                  </div>
                </KeyValueText>
              </KeyValueItem>
              <KeyValueItem :classNames="{ item: 'text-body-3' }">
                ...
                <KeyValueText>
                  <div
                    class="text-body-3 font-weight-bold align-left underline"
                  >
                    금융리스 연 6.1% ~ 9.0%
                  </div>
                  <div
                    class="text-body-5 font-weight-bold color-gray-tertiary align-left underline"
                  >
              ...
              <KeyValueItem :classNames="{ item: 'text-body-3' }">
                ...
                <KeyValueText>
                  <div class="align-left color-black">12개월 ~ 60개월</div>
                </KeyValueText>
              </KeyValueItem>
            </KeyValue>
          </BasicBox>
                ...
                >
                  ...
                  >
                    ...
                    <div :class="$style['basic-list__content']">
                      ...
                      이유로
                      <strong class="font-weight-regular">자동차를 반환</strong
                  ...
                  >
                    ...
                    <div :class="$style['basic-list__content']">
                      ...
                      <strong class="font-weight-regular">자동차를 매입</strong
              ...
              <KeyValueText>
                ...
                >
                  ...
                  >
                    <div :class="$style['basic-list__symbol']"></div>
                    <div :class="$style['basic-list__content']">
                      금융소비자는 해당상품에 대하여 설명을 받을 권리가 있으며,
                      그 설명을 듣고 내용을 충분히 이해한 후 거래하시기
                      바랍니다.
                    </div>
                  </li>
                  <li
