...
import ImgIdShoot from '@/assets/images/id-shoot/img-imcard-sample.svg?component';
      ...
      <ul :class="[$style['basic-list'], 'row-margin-contents']">
        <li :class="$style['basic-list__item']">
          ...
          <div :class="$style['basic-list__content']">
            면허증에 빛이 반사되지 않도록 해주세요.
          </div>
        </li>
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            면허증보다 짙은 배경에서 촬영해주세요.
          </div>
        </li>
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            면허증의 모서리가 카메라 영역에 모두 들어오도록 촬영해 주세요.
          </div>
        </li>
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
          <div :class="$style['basic-list__content']">
            면허증 안에 표시된 글자에 초점을 맞추어 촬영해주세요.
          </div>
        </li>
        <li :class="$style['basic-list__item']">
          <div :class="$style['basic-list__symbol']"></div>
