...
<template>
  <UiLayer ref="layer" type="full" v-slot="layerSlotProps">
    <FullPopup>
      ...
      <FormList>
        <FormListItem titleText="이름" target="#layerIdShootDrivingConfirmName">
        ...
        <FormListItem
          titleText="주민등록번호"
          target="#layerIdShootDrivingConfirmIdNumber01"
        >
        ...
        <FormListItem
          titleText="면허발급번호"
          target="#layerIdShootDrivingConfirmLicense"
        >
...
@import '@/assets/scss/views/idShoot/LayerIdShootDrivingConfirm.scss';
</style>
